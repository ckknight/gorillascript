      ...
      if node.is-call
        ...
        if func.is-internal
          if func.is-break or func.is-continue
            ...
            return node.args[2]
          else if func.is-try-catch
            return node.args[3]
    else if node instanceofsome [BlockNode, IfNode, SwitchNode, ForNode, ForInNode]
      return node.label
    null
