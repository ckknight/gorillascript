...
function sequential(array, mutator, dontCache) {
  ...
  return (function () {
    ...
    return named(_rule != null ? _rule.parserName : void 0, function (o) {
      var index, result;
      index = o.index;
      result = _rule(o);
      if (!result) {
...
WhiteSpace = cache(named("WhiteSpace", (function () {
  ...
  return (function () {
    var _rule2;
    _rule2 = named(__strnum((_rule != null ? _rule.parserName : void 0) || "<nothing>") + "*", function (o) {
      var clone, result;
      clone = o.clone();
      result = [];
      (function () {
    ...
    return named(_rule2 != null ? _rule2.parserName : void 0, function (o) {
      var index, result;
      index = o.index;
      result = _rule2(o);
      if (!result) {
...
_Space = cache(named("_Space", (function () {
  var _rule;
  _rule = named(__strnum((SpaceChar != null ? SpaceChar.parserName : void 0) || "<nothing>") + "*", function (o) {
    var clone, result;
    clone = o.clone();
    result = [];
    (function () {
...
Newline = cache(named("Newline", (function () {
  ...
  _rule = (function () {
    ...
    return named(__strnum((_rule2 != null ? _rule2.parserName : void 0) || "<unknown>") + "?", function (o) {
  ...
  return (function () {
    ...
    return named(_rule3 != null ? _rule3.parserName : void 0, function (o) {
      var index, result;
      index = o.index;
      result = _rule3(o);
      if (!result) {
...
SomeSpace = cache(named("SomeSpace", (function () {
  ...
  _rule = (function () {
    var _rule2;
    _rule2 = named(__strnum((SpaceChar != null ? SpaceChar.parserName : void 0) || "<nothing>") + "+", function (o) {
      var clone, result;
      clone = o.clone();
      result = [];
      (function () {
...
EmptyLines = cache(named("EmptyLines", (function () {
  var _rule;
  _rule = named(__strnum((EmptyLine != null ? EmptyLine.parserName : void 0) || "<nothing>") + "*", function (o) {
    var clone, result;
    clone = o.clone();
    result = [];
    (function () {
...
Shebang = cache(named("Shebang", (function () {
  ...
  _rule3 = (function () {
    ...
    _rule4 = (function () {
      var _rule5;
      _rule5 = named("!" + __strnum((Newline != null ? Newline.parserName : void 0) || "<unknown>"), function (o) {
    ...
    return named(__strnum((_rule4 != null ? _rule4.parserName : void 0) || "<nothing>") + "*", function (o) {
      var clone, result;
      clone = o.clone();
      result = [];
      (function () {
  ...
  return (function () {
    ...
    return named(_rule4 != null ? _rule4.parserName : void 0, function (o) {
      var index, result;
      index = o.index;
      result = _rule4(o);
      if (!result) {
...
TripleDoubleQuote = cache(named("TripleDoubleQuote", (function () {
  var _rule;
  _rule = named(__strnum((DoubleQuote != null ? DoubleQuote.parserName : void 0) || "<nothing>") + "{3}", function (o) {
    var clone, result;
    clone = o.clone();
    result = [];
    (function () {
...
TripleSingleQuote = cache(named("TripleSingleQuote", (function () {
  var _rule;
  _rule = named(__strnum((SingleQuote != null ? SingleQuote.parserName : void 0) || "<nothing>") + "{3}", function (o) {
    var clone, result;
    clone = o.clone();
    result = [];
    (function () {
...
CommaOrNewlineWithCheckIndent = cache(named("CommaOrNewlineWithCheckIndent", (function () {
  ...
  _rule = (function () {
    var _rule2;
    _rule2 = named(__strnum((SomeEmptyLinesWithCheckIndent != null ? SomeEmptyLinesWithCheckIndent.parserName : void 0) || "<unknown>") + "?", function (o) {
      var clone, index, result;
      index = o.index;
      clone = o.clone();
...
NamePart = cache(named("NamePart", (function () {
  var _rule;
  _rule = named(__strnum((NameChar != null ? NameChar.parserName : void 0) || "<nothing>") + "*", function (o) {
    var clone, result;
    clone = o.clone();
    result = [];
    (function () {
...
_Name = cache(named("_Name", (function () {
  ...
  _rule = (function () {
    ...
    return named(__strnum((_rule2 != null ? _rule2.parserName : void 0) || "<nothing>") + "*", function (o) {
      var clone, result;
      clone = o.clone();
      result = [];
      (function () {
...
_Symbol = cache(named("_Symbol", (function () {
  var _rule;
  _rule = named(__strnum((SymbolChar != null ? SymbolChar.parserName : void 0) || "<nothing>") + "+", function (o) {
    var clone, result;
    clone = o.clone();
    result = [];
    (function () {
...
ThisOrShorthandLiteralPeriod = cache(named("ThisOrShorthandLiteralPeriod", (function () {
  ...
  _rule2 = (function () {
    var _rule3;
    _rule3 = named(__strnum((Period != null ? Period.parserName : void 0) || "<unknown>") + "?", function (o) {
      var clone, index, result;
      index = o.index;
      clone = o.clone();
      result = Period(clone);
...
DecimalDigits = cache(named("DecimalDigits", (function () {
  ...
  _rule = (function () {
    ...
    _rule2 = (function () {
      var _rule3;
      _rule3 = named(__strnum((Underscore != null ? Underscore.parserName : void 0) || "<nothing>") + "+", function (o) {
        var clone, result;
        clone = o.clone();
        result = [];
        (function () {
...
DecimalNumber = cache(named("DecimalNumber", (function () {
  ...
  _rule2 = (function () {
    ...
    _rule3 = (function () {
      var _rule4;
      _rule4 = named(__strnum((PlusOrMinus != null ? PlusOrMinus.parserName : void 0) || "<unknown>") + "?", function (o) {
        var clone, index, result;
        index = o.index;
        clone = o.clone();
      ...
      return (function () {
        ...
        return named(_rule5 != null ? _rule5.parserName : void 0, function (o) {
          var index, result;
          index = o.index;
          result = _rule5(o);
          if (!result) {
    ...
    return named(__strnum((_rule3 != null ? _rule3.parserName : void 0) || "<unknown>") + "?", function (o) {
      var clone, index, result;
      index = o.index;
      clone = o.clone();
      result = _rule3(clone);
  ...
  _rule3 = (function () {
    ...
    return named(__strnum((_rule4 != null ? _rule4.parserName : void 0) || "<unknown>") + "?", function (o) {
      var clone, index, result;
      index = o.index;
      clone = o.clone();
      result = _rule4(clone);
...
function makeRadixInteger(radix, separator, digit) {
  ...
  digits = (function () {
    var _rule, _rule2;
    _rule = named(__strnum((digit != null ? digit.parserName : void 0) || "<nothing>") + "+", function (o) {
      var clone, result;
      clone = o.clone();
      result = [];
      (function () {
    ...
    _rule2 = (function () {
      ...
      _rule3 = (function () {
        var _rule4, _rule5;
        _rule4 = named(__strnum((Underscore != null ? Underscore.parserName : void 0) || "<nothing>") + "+", function (o) {
          var clone, result;
          clone = o.clone();
          result = [];
          (function () {
        ...
        _rule5 = named(__strnum((digit != null ? digit.parserName : void 0) || "<nothing>") + "+", function (o) {
          var clone, result;
          clone = o.clone();
          result = [];
          (function () {
      ...
      return named(__strnum((_rule3 != null ? _rule3.parserName : void 0) || "<nothing>") + "*", function (o) {
        var clone, result;
        clone = o.clone();
        result = [];
        (function () {
...
RadixInteger = cache(named("RadixInteger", (function () {
  ...
  GetDigits = (function () {
    ...
    return function (radix) {
      var _ref;
      return (_ref = digitCache[radix]) != null ? _ref : (digitCache[radix] = (function () {
        var digit;
...
HexEscapeSequence = cache(named("HexEscapeSequence", (function () {
  ...
  _backend = (function () {
    var _rule;
    _rule = named(__strnum((HexDigit != null ? HexDigit.parserName : void 0) || "<nothing>") + "{2}", function (o) {
      var clone, result;
      clone = o.clone();
      result = [];
      (function () {
  ...
  return named(_backend != null ? _backend.parserName : void 0, function (o) {
    var result;
    if (!LowerX(o.clone())) {
      return false;
    } else {
...
UnicodeEscapeSequence = cache(named("UnicodeEscapeSequence", (function () {
  ...
  _backend = (function () {
    var _rule;
    _rule = named(__strnum((HexDigit != null ? HexDigit.parserName : void 0) || "<nothing>") + "{4}", function (o) {
      var clone, result;
      clone = o.clone();
      result = [];
      (function () {
      ...
      _rule2 = (function () {
        ...
        _rule3 = (function () {
          ...
          _rule4 = (function () {
            ...
            return named("!" + __strnum((_rule5 != null ? _rule5.parserName : void 0) || "<unknown>"), function (o) {
      ...
      _rule2 = (function () {
        ...
        _rule4 = (function () {
          ...
          _rule5 = (function () {
            ...
            return named("!" + __strnum((_rule6 != null ? _rule6.parserName : void 0) || "<unknown>"), function (o) {
          ...
          _rule4 = (function () {
            ...
            _rule5 = (function () {
              ...
              _rule6 = (function () {
                ...
                return named(__strnum((_rule7 != null ? _rule7.parserName : void 0) || "<nothing>") + "*", function (o) {
                  var clone, result;
                  clone = o.clone();
                  result = [];
                  (function () {
              ...
              return (function () {
                ...
                return named(_rule7 != null ? _rule7.parserName : void 0, function (o) {
                  var index, result;
                  index = o.index;
                  result = _rule7(o);
                  if (!result) {
...
RegexLiteral = cache(named("RegexLiteral", (function () {
      ...
      _rule2 = (function () {
        ...
        _rule3 = (function () {
          ...
          _rule5 = (function () {
            ...
            _mutator = 36;
            return named(_rule6 != null ? _rule6.parserName : void 0, function (o) {
              var index, result;
              index = o.index;
              result = _rule6(o);
              if (!result) {
          ...
          _rule6 = (function () {
            ...
            _rule7 = (function () {
              ...
              return named("!" + __strnum((_rule8 != null ? _rule8.parserName : void 0) || "<unknown>"), function (o) {
  ...
  return (function () {
    ...
    function _mutator(x, o, i) {
      ...
      text = stringParts.length === 0 ? o["const"](i, "") : stringParts.length === 1 && typeof stringParts[0] === "string" ? o["const"](i, stringParts[0]) : o.string(i, stringParts);
...
Operator = cache(named("Operator", (function () {
  ...
  _rule59 = (function () {
    ...
    return named(_rule60 != null ? _rule60.parserName : void 0, function (o) {
      var index, result;
      index = o.index;
      result = _rule60(o);
      if (!result) {
  ...
  _rule62 = (function () {
    ...
    _rule64 = (function () {
      ...
      return named(__strnum((_rule65 != null ? _rule65.parserName : void 0) || "<unknown>") + "?", function (o) {
        var clone, index, result;
        index = o.index;
        clone = o.clone();
    ...
    return (function () {
      ...
      return named(_rule65 != null ? _rule65.parserName : void 0, function (o) {
        var index, result;
        index = o.index;
        result = _rule65(o);
        if (!result) {
  ...
  _rule63 = (function () {
    ...
    return (function () {
      ...
      return named(_rule66 != null ? _rule66.parserName : void 0, function (o) {
        var index, result;
        index = o.index;
        result = _rule66(o);
        if (!result) {
  ...
  _rule65 = (function () {
    ...
    return (function () {
      ...
      return named(_rule67 != null ? _rule67.parserName : void 0, function (o) {
        var index, result;
        index = o.index;
        result = _rule67(o);
        if (!result) {
...
ObjectKeyColon = cache(named("ObjectKeyColon", (function () {
  var _rule;
  _rule = named("!" + __strnum((Colon != null ? Colon.parserName : void 0) || "<unknown>"), function (o) {
...
IdentifierOrSimpleAccessStart = cache(named("IdentifierOrSimpleAccessStart", (function () {
  ...
  _rule2 = (function () {
    ...
    function _mutator(x, o, i) {
      return o.access(i, o.access(i, x.parent, o["const"](i, "prototype")), x.child);
    }
    return named(_rule3 != null ? _rule3.parserName : void 0, function (o) {
      var index, result;
      index = o.index;
  ...
  _rule3 = (function () {
    var _rule4;
    _rule4 = named(__strnum((DoubleColon != null ? DoubleColon.parserName : void 0) || "<unknown>") + "?", function (o) {
      var clone, index, result;
      index = o.index;
      clone = o.clone();
...
IdentifierOrSimpleAccessPart = cache(named("IdentifierOrSimpleAccessPart", (function () {
    ...
    return (function () {
      ...
      function _mutator(x, o, i) {
        ...
        return function (parent) {
          return o.access(i, isProto ? o.access(i, parent, o["const"](i, "prototype")) : parent, child);
        };
      }
      return named(_rule3 != null ? _rule3.parserName : void 0, function (o) {
        var index, result;
  ...
  _rule2 = (function () {
    var _rule3;
    _rule3 = named(__strnum((DoubleColon != null ? DoubleColon.parserName : void 0) || "<unknown>") + "?", function (o) {
      var clone, index, result;
      index = o.index;
      clone = o.clone();
      result = DoubleColon(clone);
...
IdentifierOrSimpleAccess = cache(named("IdentifierOrSimpleAccess", (function () {
  var _rule;
  _rule = named(__strnum((IdentifierOrSimpleAccessPart != null ? IdentifierOrSimpleAccessPart.parserName : void 0) || "<nothing>") + "*", function (o) {
    var clone, result;
    clone = o.clone();
    result = [];
    (function () {
...
SingularObjectKey = cache(named("SingularObjectKey", (function () {
  ...
  _rule = (function () {
    function _mutator(ident, o, i) {
      var key;
      key = ident.type === "access" ? ident.child : ident.type === "ident" ? o["const"](i, ident.name) : o.error("Unknown ident type: " + __strnum(ident.type));
  ...
  _rule3 = (function () {
    function _mutator(node, o, i) {
      return { key: o["const"](i, "this"), value: node };
    }
  ...
  _rule4 = (function () {
    function _mutator(node, o, i) {
      return { key: o["const"](i, "arguments"), value: node };
    }
  ...
  _rule5 = (function () {
    ...
    return (function () {
      ...
      function _mutator(x, o, i) {
        return { key: o["const"](i, String(-__num(x.value))), value: o.unary(i, "-", x) };
      }
      return named(_rule8 != null ? _rule8.parserName : void 0, function (o) {
        var index, result;
        index = o.index;
        result = _rule8(o);
        if (!result) {
...
IdentifierParameter = cache(named("IdentifierParameter", (function () {
  var _rule, _rule2;
  _rule = named(__strnum((ThisOrShorthandLiteralPeriod != null ? ThisOrShorthandLiteralPeriod.parserName : void 0) || "<unknown>") + "?", function (o) {
    var clone, index, result;
    index = o.index;
    clone = o.clone();
  ...
  return (function () {
    ...
    function _mutator(x, o, i) {
      var name;
      name = x.parent !== NOTHING ? o.access(i, x.parent, o["const"](i, x.ident.name)) : x.ident;
...
ParamSingularObjectKey = cache(named("ParamSingularObjectKey", (function () {
  function _mutator(param, o, i) {
    ...
    key = ident.type === "ident" ? o["const"](i, ident.name) : ident.type === "access" ? ident.child : (function () {
...
FunctionDeclaration = cache(named("FunctionDeclaration", (function () {
  ...
  _rule3 = named(__strnum((AtSign != null ? AtSign.parserName : void 0) || "<unknown>") + "?", function (o) {
    var clone, index, result;
    index = o.index;
    clone = o.clone();
    result = AtSign(clone);
...
MacroName = cache(named("MacroName", (function () {
  ...
  _rule = (function () {
    ...
    return (function () {
      var _rule3;
      _rule3 = named(__strnum((_rule2 != null ? _rule2.parserName : void 0) || "<nothing>") + "+", function (o) {
        var clone, result;
        clone = o.clone();
        result = [];
        (function () {
...
IdentifierOrAccess = cache(named("IdentifierOrAccess", (function () {
  var _rule;
  _rule = named(__strnum((IdentifierOrAccessPart != null ? IdentifierOrAccessPart.parserName : void 0) || "<nothing>") + "*", function (o) {
    var clone, result;
    clone = o.clone();
    result = [];
    (function () {
...
BasicInvocationOrAccess = cache(named("BasicInvocationOrAccess", (function () {
  ...
  _rule3 = (function () {
    ...
    _rule4 = (function () {
      ...
      _rule6 = (function () {
        var _rule7;
        _rule7 = named(__strnum((DoubleColon != null ? DoubleColon.parserName : void 0) || "<unknown>") + "?", function (o) {
          var clone, index, result;
          index = o.index;
          clone = o.clone();
          result = DoubleColon(clone);
      ...
      _rule8 = (function () {
        ...
        return named(_rule9 != null ? _rule9.parserName : void 0, function (o) {
          var index, result;
          index = o.index;
          result = _rule9(o);
          if (!result) {
    ...
    function _mutator(x, o, i) {
      ...
      for (_i = 0, _len = __num(tail.length); _i < _len; ++_i) {
        ...
        if ((_ref = part.type) === "protoAccess" || _ref === "protoIndex") {
          links.push({ type: "access", child: o["const"](i, "prototype"), existential: part.existential });
          clone = copy(part);
    ...
    _rule2 = (function () {
      ...
      _rule6 = (function () {
        ...
        _rule8 = (function () {
          ...
          return named(__strnum((_rule9 != null ? _rule9.parserName : void 0) || "<unknown>") + "?", function (o) {
            var clone, index, result;
            index = o.index;
            clone = o.clone();
            result = _rule9(clone);
      ...
      _rule7 = (function () {
        ...
        return (function () {
          ...
          return named(_rule10 != null ? _rule10.parserName : void 0, function (o) {
            var index, result;
            index = o.index;
            result = _rule10(o);
            if (!result) {
      ...
      _rule9 = (function () {
        ...
        return (function () {
          ...
          return named(_rule11 != null ? _rule11.parserName : void 0, function (o) {
            var index, result;
            index = o.index;
            result = _rule11(o);
            if (!result) {
...
Yield = cache(named("Yield", (function () {
  ...
  _backend = (function () {
    var _rule;
    _rule = named(__strnum((Asterix != null ? Asterix.parserName : void 0) || "<unknown>") + "?", function (o) {
      var clone, index, result;
      index = o.index;
      clone = o.clone();
...
Root = cache(named("Root", (function () {
  var _rule;
  _rule = named(__strnum((Shebang != null ? Shebang.parserName : void 0) || "<unknown>") + "?", function (o) {
    var clone, index, result;
    index = o.index;
    clone = o.clone();
...
MacroHelper = (function () {
    ...
    if (node != null && node.type === "callChain") {
      ...
      if (links[__num(links.length) - 1].type === "call") {
        if (links.length === 1) {
          ...
          return ParserNode(node.type, node.startIndex, node.endIndex, { head: node.head, links: __slice(links, void 0, __num(links.length) - 1) });
        }
      }
    }
  };
  ...
  MacroHelper.prototype.call = function (func, args, isNew) {
    ...
    if (func.type === "callChain") {
      return ParserNode("callChain", func.startIndex, func.endIndex, {
        head: func.head,
        links: __toArray(func.links).concat([
        ...
        links: [
          {
            type: "call",
            args: [
              ParserNode("ident", obj.startIndex, obj.endIndex, { name: obj.name.substring(1) })
            ],
            existential: false,
            isNew: false
          }
  ...
  function walk(node, func) {
    ...
    if (__owns(NEW_STYLE_NODES, node.type)) {
    ...
    block: function (x, func) {
      ...
      if (len !== 0) {
        ...
        if (lastNode !== nodes[__num(len) - 1]) {
          return ParserNode(x.type, x.startIndex, x.endIndex, {
            nodes: __toArray(__slice(nodes, void 0, __num(len) - 1)).concat([lastNode])
          });
        }
      }
      return x;
...
State = (function () {
  ...
  State.prototype.node = function (type, index, value) {
    return ParserNode(type, index, this.index, { value: value });
  };
      ...
      function handleParams(params, sequence) {
        ...
        for (_i = 0, _len = __num(params.length); _i < _len; ++_i) {
          ...
          if (type === "const") {
            ...
            ident = param.ident;
            key = ident.type === "ident" ? ident.name : ident.type === "this" ? "this" : (function () {
...
ParserNode = exports.ParserNode = (function () {
