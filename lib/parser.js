(function () {
  ...
  CustomOperator = cache(named("CustomOperator", (function () {
    ...
    return function (o) {
      ...
      for (_arr = o.macros.prefixUnaryOperators, _i = 0, _len = __num(_arr.length); _i < _len; ++_i) {
        operator = _arr[_i];
        if ((_ref = handleUnaryOperator(operator, o, i)) != void 0) {
          return _ref;
        }
      }
  ...
  Return = cache(named("Return", (function () {
    ...
    _backend = (function () {
      ...
      function _mutator(x, o, i) {
        ...
        return o["return"](i, x.node.doWrap(), x.existential === "?");
      }
      return named(
        (_rule != null ? _rule.parserName : void 0) || "<unknown>",
        function (o) {
  ...
  Statement = cache(named("Statement", (function () {
    ...
    _rule = inStatement(function (o) {
      return Return(o) || Yield(o) || Break(o) || Continue(o) || Macro(o) || DefineHelper(o) || DefineOperator(o) || DefineSyntax(o) || Assignment(o) || ExpressionAsStatement(o);
    });
    return function (o) {
      var clone, result;
      clone = o.clone();
  ...
  MacroHelper = (function () {
      ...
      if (this.isComplex(node)) {
        ...
        return func(
          this.state.block(this.index, [
            ...
            this.state.assign(this.index, tmp, "=", node)
          ]),
          tmp,
          true
        );
    ...
    function walk(node, func) {
      ...
      if (!(node instanceof BlockNode) && (_ref = func(node)) != void 0) {
        return _ref;
      }
    ...
    _proto._reduce = (function () {
      ...
      return function () {
        ...
        if (left.isConst()) {
          ...
          if ((_ref = __owns(leftConstOps, op) ? leftConstOps[op].call(this, left, right) : void 0) != void 0) {
            return _ref;
          }
        }
        if (right.isConst() && (_ref = __owns(rightConstOps, op) ? rightConstOps[op].call(this, left, right) : void 0) != void 0) {
          return _ref;
        }
        if (left !== this.left || right !== this.right) {
          return BinaryNode(
        ...
        if ((_ref = this._type) == null) {
          return this._type = (function () {
            ...
            if (func instanceof IdentNode) {
              ...
              parent = func.parent;
              child = func.child;
              if (child instanceof ConstNode && parent instanceof IdentNode && (_ref = __owns(PRIMORDIAL_SUBFUNCTIONS, _ref = parent.name) && __owns(_ref2 = PRIMORDIAL_SUBFUNCTIONS[_ref], _ref3 = child.value) ? _ref2[_ref3] : void 0) != void 0) {
                return _ref;
              }
            }
            return Type.any;
