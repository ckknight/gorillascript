(function () {
  ...
  Statement = cache(named("Statement", (function () {
    ...
    _rule = inStatement(function (o) {
      return Def(o) || Return(o) || Yield(o) || Break(o) || Continue(o) || Macro(o) || DefineHelper(o) || DefineOperator(o) || DefineSyntax(o) || Assignment(o) || ExpressionAsStatement(o);
    });
    return function (o) {
      var clone, result;
      clone = o.clone();
