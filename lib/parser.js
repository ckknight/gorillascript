(function () {
  ...
  State = (function () {
    var _proto, ASSIGN_OPERATOR, BINARY_OPERATOR, macroSyntaxTypes, UNARY_OPERATOR;
    ...
    _proto.startMacro = function (name) {
