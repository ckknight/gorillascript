(function (GLOBAL) {
  ...
  var __bind, __cmp, __compose, __create, __curry, __defer,
      ...
      ConstantLiteral, ConstantLiteralAccessPart, ConstObjectKey, ContinueNode,
      ...
      LicenseComment, Line, LispyNode, Literal, Logic, LSymbol, MacroAccessNode,
      MacroBody, MacroConstNode, MacroContext, MacroError, MacroHolder,
