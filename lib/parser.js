(function () {
  ...
  EmptyLines = cache(named("EmptyLines", (function () {
    var _rule;
    _rule = named(__strnum(EmptyLine != null && EmptyLine.parserName || "EmptyLine") + "*", function (o) {
      var clone, item, result;
      clone = o.clone();
      result = [];
      item = void 0;
      while (item = EmptyLine(clone)) {
        result.push(item);
      }
      o.update(clone);
      return result;
  ...
  TripleDoubleQuote = cache(named("TripleDoubleQuote", (function () {
    var _rule;
    _rule = named(__strnum(DoubleQuote != null && DoubleQuote.parserName || "DoubleQuote") + "{3}", function (o) {
      var clone, item, result;
      clone = o.clone();
      result = [];
      item = void 0;
      while (result.length < 3 && (item = DoubleQuote(clone))) {
        result.push(item);
      }
      if (result.length < 3) {
        return false;
  ...
  TripleSingleQuote = cache(named("TripleSingleQuote", (function () {
    var _rule;
    _rule = named(__strnum(SingleQuote != null && SingleQuote.parserName || "SingleQuote") + "{3}", function (o) {
      var clone, item, result;
      clone = o.clone();
      result = [];
      item = void 0;
      while (result.length < 3 && (item = SingleQuote(clone))) {
        result.push(item);
      }
      if (result.length < 3) {
        return false;
  ...
  UnclosedArguments = named("UnclosedArguments", (function () {
    ...
    _rule = (function () {
      ...
      _rule4 = (function () {
        ...
        _rule5 = (function () {
          var _rule6;
          _rule6 = named(__strnum(SpaceChar != null && SpaceChar.parserName || "SpaceChar") + "+", function (o) {
            var clone, item, result;
            clone = o.clone();
            result = [];
            item = void 0;
