  ...
  function sequential(array, mutator, dontCache) {
    ...
    for (i = 0, _len = array.length; i < _len; ++i) {
      ...
      if (__isArray(item)) {
        ...
        throw TypeError("Found a non-array, non-function in index #" + i + ": " + (typeof item === "undefined" ? "Undefined" : __typeof(item)));
      }
      rules.push(rule);
      mapping.push(key);
        ...
        if (x.length === 0) {
          ...
          for (_arr = __toArray(x), _i = 0, _len = _arr.length; _i < _len; ++_i) {
            ...
            if (!(key instanceof ConstNode)) {
              o.error("Expected a constant key, got " + (typeof key === "undefined" ? "Undefined" : __typeof(key)));
            } else {
        ...
        if (types.length === 1) {
          ...
          for (j = types.length - 1; j <= 0; ++j) {
            ...
            if (type instanceof TypeUnionNode) {
              __splice(types, j, j + 1, type.types);
            }
          }
          if (types.length === 1) {
            return types[0];
  ...
  nodeToType = (function () {
    ...
    return function (node) {
      ...
      if (node instanceof IdentNode) {
        ...
        for (_arr = __slice(node.types, 1, void 0), _i = 0, _len = _arr.length; _i < _len; ++_i) {
          type = _arr[_i];
    ...
    _MacroHelper_prototype.object = function (pairs) {
      ...
      for (i = 0, _len = pairs.length; i < _len; ++i) {
        ...
        if (!pair || typeof pair !== "object") {
          throw Error("Expected an object at index #" + i + ", got " + (typeof pair === "undefined" ? "Undefined" : __typeof(pair)));
    ...
    function handleParams(params) {
      ...
      for (_arr = __toArray(params), _i = 0, _len = _arr.length; _i < _len; ++_i) {
        ...
        if (param.isConst()) {
          ...
          this.error("Unexpected parameter type: " + (typeof param === "undefined" ? "Undefined" : __typeof(param)));
        }
      }
