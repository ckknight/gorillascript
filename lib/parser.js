(function (GLOBAL) {
  ...
  var __bind, __cmp, __compose, __create, __curry, __defer,
      ...
      LSymbol, LValue, MacroAccessNode, MacroBody, MacroConstNode, MacroContext,
      MacroError, MacroHolder, MacroName, macroName, MacroNames, MacroOptions,
      MacroSyntax, MacroSyntaxChoiceParameters, MacroSyntaxParameter,
      MacroSyntaxParameters, MacroSyntaxParameterType, makeEmbeddedRule,
      ...
      MethodDeclaration, MinusChar, mutate, Name, NameChar, NameOrSymbol,
      NamePart, NameStart, Node, nodeType, NoNewlineIfNoIndent, NonUnionType,
      NoSpace, NoSpaceNewline, NotColon, NotColonUnlessNoIndentAndNewline,
      NotEmbeddedOpenComment, NotEmbeddedOpenLiteral, NotEmbeddedOpenWrite,
      Nothing, NothingNode, notInFunctionTypeParams, NumberChar, NumberLiteral,
      ObjectKey, ObjectKeyColon, ObjectLiteral, ObjectParameter, ObjectType,
      ...
      RegexLiteral, requireParameterSequence, RootInnerP, RootNode, RootP,
      Scope, Semicolon, SemicolonChar, Semicolons, setImmediate, SetLiteral,
      Shebang, SHORT_CIRCUIT, SingleEscapeCharacter, SingleQuote,
      ...
      StringLiteral, stringRepeat, SuperInvocation, SuperNode, Symbol, symbol,
      SymbolChar, SyntaxChoiceNode, SyntaxManyNode, SyntaxParamNode,
      SyntaxSequenceNode, ThisLiteral, ThisOrShorthandLiteral,
  ...
  function makeObjectNode(parser, index, prototype, pairs) {
    ...
    return LInternalCall.apply(void 0, [
      "object",
      index,
      parser.scope.peek(),
      prototype || NothingNode(index, parser.scope.peek())
    ].concat((function () {
  ...
  ObjectParameter = mutate(function (params, parser, index) {
    return makeObjectNode(parser, index, parser.Nothing(index), (function () {
  ...
  UnclosedObjectLiteral = cache((_ref = separatedList(PropertyOrDualObjectKey, Comma), mutate(function (pairs, parser, index) {
    return makeObjectNode(parser, index, parser.Nothing(index), pairs);
  })(_ref)));
  ...
  MapLiteral = cache((_ref = sequential(
    ...
    return constructMap.func(
      {
        op: "",
        node: makeObjectNode(parser, index, parser.Nothing(index), pairs)
      },
      parser,
      index
    );
  ...
  function _BlockMutator(lines, parser, index) {
    ...
    for (_arr = __toArray(lines), i = 0, _len = _arr.length; i < _len; ++i) {
      ...
      for (_arr2 = __toArray(item), j = 0, _len2 = _arr2.length; j < _len2; ++j) {
        ...
        } else if (part instanceof LispyNode && part.isInternalCall("block") && part.args[0] instanceof NothingNode) {
  ...
  Parser = (function () {
    ...
    function makeMacroRoot(index, params, body) {
      return this.Root(index, void 0, LInternalCall("return", index, this.scope.peek(), this.Function(
        index,
        [
          params,
          this.Param(
    ...
    macroSyntaxTypes = {
      syntax: function (index, params, body, options, stateOptions, translator) {
        ...
        body = LInternalCall.apply(void 0, [
          ...
          this.Assign(index, macroNameIdent, "=", LInternalCall(
            "access",
            index,
            scope,
            macroFullDataIdent,
          ...
          this.Assign(index, macroDataIdent, "=", LInternalCall(
            "access",
            index,
            scope,
            macroFullDataIdent,
            ...
            for (_arr = [], _arr2 = __toArray(params), _i = 0, _len = _arr2.length; _i < _len; ++_i) {
              ...
              if (param instanceof SyntaxParamNode) {
                ...
                _arr.push(LInternalCall(
                  ...
                  _this.Assign(index, param.ident, "=", LInternalCall(
                    "access",
                    index,
                    scope,
                    macroDataIdent,
          ...
          (function () {
            ...
            for (_arr = [], _arr2 = ["left", "op", "right"], _i = 0, _len = _arr2.length; _i < _len; ++_i) {
              ...
              _arr.push(LInternalCall(
                ...
                _this.Assign(index, ident, "=", LInternalCall(
                  "access",
                  index,
                  scope,
                  macroDataIdent,
