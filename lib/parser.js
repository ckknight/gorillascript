        ...
        if (decimal) {
          for (; ; ) {
            ...
            if (isFinite(decimalNum)) {
              value = __num(value) + __num(decimalNum) / __num(Math.pow(
                __num(radix),
                __num(decimal.length)
              ));
              break;
            } else {
    ...
    return (function () {
      ...
      function _mutator(x, o, i) {
        ...
        return function (parent) {
          return o.access(
            i,
            isProto ? o.access(i, parent, o["const"](i, "prototype")) : parent,
            child
          );
        };
      }
...
Parameters = cache(named("Parameters", (function () {
  ...
  return (function () {
    ...
    function _mutator(x, o, i) {
      return validateSpreadParameters(
        [x.head].concat(__toArray(x.tail)),
        o
      );
    }
    return named(_rule2 != null ? _rule2.parserName : void 0, function (o) {
  ...
  return (function () {
    ...
    function _mutator(x) {
      if (!__lte(x.tail.length, 0)) {
        return {
          type: "multi",
          elements: [x.head].concat(__toArray(x.tail))
        };
      } else {
      ...
      if (links[__num(links.length) - 1].type === "call") {
        if (links.length === 1) {
          ...
          return ParserNode(node.type, node.startIndex, node.endIndex, {
            head: node.head,
            links: __slice(links, void 0, __num(links.length) - 1)
          });
        }
      }
    }
  ...
  function constifyObject(obj, startIndex, endIndex) {
    ...
    if (!obj || typeof obj !== "object" || obj instanceof RegExp) {
      ...
      return ParserNode("callChain", obj.startIndex, obj.endIndex, {
        ...
        links: [{
          type: "call",
          args: [ParserNode("ident", obj.startIndex, obj.endIndex, {
            name: obj.name.substring(1)
          })],
          existential: false,
          isNew: false
        }]
