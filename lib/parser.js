  ...
  _rule = (function () {
    ...
    function _mutator(ident, o, i) {
      ...
      key = ident instanceof AccessNode ? ident.child
        ...
        : o.error("Unknown ident type: " + __strnum(__typeof(ident)));
...
ParamSingularObjectKey = cache(named("ParamSingularObjectKey", (function () {
  ...
  function _mutator(param, o, i) {
    ...
    key = ident instanceof IdentNode ? o["const"](i, ident.name)
      ...
      : (function () {
        throw Error("Unknown object key type: " + __strnum(__typeof(ident)));
      }());
  ...
  _backend = (function () {
    ...
    return (function () {
      function _rule2(o) {
        ...
        clone = o.clone();
        result = void 0;
        if (_rule(clone) && AstToken(clone) && (result = BodyOrStatement(clone))) {
          o.update(clone);
          return result;
        } else {
          return false;
      ...
      function _mutator(x, o, i) {
        return MacroHelper.fixAsts(o.ast(i, x));
      }
      return named(
        _rule2 != null ? _rule2.parserName : void 0,
        function (o) {
...
MacroHelper = (function () {
  var getTmpId, KNOWN_HELPERS, mutators;
    ...
    if (node instanceof CallChainNode) {
      ...
      if (links[__num(links.length) - 1].type === "call") {
        if (links.length === 1) {
          ...
          return CallChainNode(node.startIndex, node.endIndex, node.head, __slice(
            links,
            void 0,
  ...
  MacroHelper.prototype.call = function (func, args, isNew) {
    ...
    if (func instanceof CallChainNode) {
      return this.state.callChain(func.startIndex, func.head, __toArray(func.links).concat([{ type: "call", args: args, isNew: isNew }]));
    } else {
      return this.state.callChain(func.startIndex, func, [{ type: "call", args: args, isNew: isNew }]);
    }
  };
  ...
  MacroHelper.prototype.object = function (pairs) {
    ...
    for (i = 0, _len = __num(pairs.length); i < _len; ++i) {
      ...
      if (!pair || typeof pair !== "object") {
        ...
        throw Error("Expected an object with Node 'key' at index #" + __strnum(i) + ", got " + __strnum(__typeof(pair.key)));
      } else if (!(pair.value instanceof Node)) {
        throw Error("Expected an object with Node 'value' at index #" + __strnum(i) + ", got " + __strnum(__typeof(pair.value)));
      }
    }
    return this.state.object(0, pairs);
  };
  MacroHelper.prototype.isComplex = function (node) {
    return node != null && !(node instanceof ConstNode) && !(node instanceof IdentNode) && !(node instanceof TmpNode) && (!(node instanceof BlockNode) || node.nodes.length !== 0);
  };
  ...
  function constifyObject(obj, startIndex, endIndex) {
    ...
    } else if (obj instanceof IdentNode && __in(obj.name, KNOWN_HELPERS)) {
  ...
  function walk(node, func) {
    ...
    if (!(node instanceof Node)) {
      throw Error("Unexpected type to walk through: " + __strnum(__typeof(node)));
    }
    return (_ref = func(node)) != null ? _ref
      : node.walk(function (x) {
        return walk(x, func);
      });
  }
  MacroHelper.fixAsts = function (result) {
    return walk(result, function (node) {
      if (node instanceof AstNode) {
        return constifyObject(node.node, node.startIndex, node.endIndex);
      }
    });
  };
    ...
    Block: function (x, func) {
      ...
      if (len !== 0) {
        ...
        if (lastNode !== nodes[__num(len) - 1]) {
          return BlockNode(x.startIndex, x.endIndex, __toArray(__slice(
            nodes,
            void 0,
            __num(len) - 1
          )).concat([lastNode]));
  ...
  MacroHelper.prototype.mutateLast = function (node, func) {
    ...
    if (!(node instanceof Node)) {
      throw Error("Unexpected type to mutate-last through: " + __strnum(__typeof(node)));
    }
...
State = (function () {
    ...
    syntax: function (index, params, body) {
      ...
      function calcParam(param) {
        ...
        if (param instanceof IdentNode) {
          ...
          return _this.error("Unexpected type: " + __strnum(__typeof(param)));
        }
      }
        ...
        for (_i = 0, _len = __num(params.length); _i < _len; ++_i) {
          ...
          if (param instanceof ConstNode) {
            ...
            key = ident instanceof IdentNode ? ident.name
              ...
              : (function () {
                throw Error("Don't know how to handle ident type: " + __strnum(__typeof(ident)));
              }());
            type = (_ref = param.asType) != null ? _ref : IdentNode(0, 0, "Expression");
            sequence.push([key, calcParam(type)]);
          } else {
            _this.error("Unexpected parameter type: " + __strnum(__typeof(param)));
          }
        }
  ...
  State.addNodeFactory = function (name, type) {
    State.prototype[name] = function (index) {
      return type.apply(void 0, [index, this.index].concat(__toArray(__slice(arguments, 1, void 0))));
    };
  };
  return State;
}());
AccessNode = Node.Access = (function () {
  ...
  AccessNode.prototype.walk = function (f) {
    ...
    if (parent !== this.parent || child !== this.child) {
      return AccessNode.apply(void 0, [this.startIndex, this.endIndex].concat([parent, child]));
    } else {
      return this;
    }
  };
...
ArrayNode = Node.Array = (function () {
  ...
  ArrayNode.prototype.walk = function (f) {
    ...
    if (elements !== this.elements) {
      return ArrayNode.apply(void 0, [this.startIndex, this.endIndex].concat([elements]));
    } else {
      return this;
    }
  };
...
AssignNode = Node.Assign = (function () {
  ...
  AssignNode.prototype.walk = function (f) {
    ...
    if (left !== this.left || right !== this.right) {
      return AssignNode.apply(void 0, [this.startIndex, this.endIndex].concat([left, this.op, right]));
    } else {
      return this;
    }
  };
...
AstNode = Node.Ast = (function () {
  function AstNode(startIndex, endIndex, node) {
    var self;
    if (!(node instanceof Node)) {
      throw TypeError("Expected node to be a Node, got " + __typeof(node));
    }
    self = __create(AstNode.prototype);
    self.type = "ast";
    self.startIndex = startIndex;
    self.endIndex = endIndex;
    self.node = node;
  ...
  AstNode.prototype = __create(Node.prototype);
  AstNode.prototype.constructor = AstNode;
  AstNode.cappedName = "Ast";
  AstNode.argNames = ["node"];
  State.addNodeFactory("ast", AstNode);
  AstNode.prototype.walk = function () {
    throw Error("Walking over AstNode is not supported, should have been handled through fix-asts");
  };
  return AstNode;
}());
BinaryNode = Node.Binary = (function () {
  ...
  BinaryNode.prototype.walk = function (f) {
    ...
    right = f(this.right);
    if (left !== this.left || right !== this.right) {
      return BinaryNode.apply(void 0, [this.startIndex, this.endIndex].concat([left, this.op, right]));
    } else {
      return this;
    }
  };
...
BlockNode = Node.Block = (function () {
  ...
  BlockNode.prototype.walk = function (f) {
    ...
    if (nodes !== this.nodes) {
      return BlockNode.apply(void 0, [this.startIndex, this.endIndex].concat([nodes]));
    } else {
      return this;
    }
  };
...
DeclarableNode = Node.Declarable = (function () {
  ...
  DeclarableNode.prototype.walk = function (f) {
    ...
    ident = f(this.ident);
    if (ident !== this.ident) {
      return DeclarableNode.apply(void 0, [this.startIndex, this.endIndex].concat([ident, this.isMutable]));
    } else {
      return this;
    }
  };
...
DefineHelperNode = Node.DefineHelper = (function () {
  ...
  DefineHelperNode.prototype.walk = function (f) {
    ...
    if (name !== this.name || value !== this.value) {
      return DefineHelperNode.apply(void 0, [this.startIndex, this.endIndex].concat([name, value]));
    } else {
      return this;
    }
  };
...
EvalNode = Node.Eval = (function () {
  ...
  EvalNode.prototype.walk = function (f) {
    ...
    code = f(this.code);
    if (code !== this.code) {
      return EvalNode.apply(void 0, [this.startIndex, this.endIndex].concat([code]));
    } else {
      return this;
    }
  };
...
ForNode = Node.For = (function () {
  ...
  ForNode.prototype.walk = function (f) {
    ...
    if (init !== this.init || test !== this.test || step !== this.step || body !== this.body) {
      return ForNode.apply(void 0, [this.startIndex, this.endIndex].concat([init, test, step, body]));
    } else {
      return this;
    }
  };
...
ForInNode = Node.ForIn = (function () {
  ...
  ForInNode.prototype.walk = function (f) {
    ...
    if (key !== this.key || object !== this.object || body !== this.body) {
      return ForInNode.apply(void 0, [this.startIndex, this.endIndex].concat([key, object, body]));
    } else {
      return this;
    }
  };
...
FunctionNode = Node.Function = (function () {
  ...
  FunctionNode.prototype.walk = function (f) {
    ...
    if (params !== this.params || body !== this.body) {
      return FunctionNode.apply(void 0, [this.startIndex, this.endIndex].concat([params, body, this.autoReturn, this.bound]));
    } else {
      return this;
    }
  };
...
IfNode = Node.If = (function () {
  ...
  IfNode.prototype.walk = function (f) {
    ...
    if (test !== this.test || whenTrue !== this.whenTrue || whenFalse !== this.whenFalse) {
      return IfNode.apply(void 0, [this.startIndex, this.endIndex].concat([test, whenTrue, whenFalse]));
    } else {
      return this;
    }
  };
...
LetNode = Node.Let = (function () {
  ...
  LetNode.prototype.walk = function (f) {
    ...
    right = f(this.right);
    if (left !== this.left || right !== this.right) {
      return LetNode.apply(void 0, [this.startIndex, this.endIndex].concat([left, right]));
    } else {
      return this;
    }
  };
...
ParamNode = Node.Param = (function () {
  ...
  ParamNode.prototype.walk = function (func) {
    ...
    asType = this.asType != null ? func(this.asType) : this.defaultValue;
...
RegexpNode = Node.Regexp = (function () {
  ...
  RegexpNode.prototype.walk = function (f) {
    ...
    text = f(this.text);
    if (text !== this.text) {
      return RegexpNode.apply(void 0, [this.startIndex, this.endIndex].concat([text, this.flags]));
    } else {
      return this;
    }
  };
...
ReturnNode = Node.Return = (function () {
  ...
  ReturnNode.prototype.walk = function (f) {
    ...
    node = f(this.node);
    if (node !== this.node) {
      return ReturnNode.apply(void 0, [this.startIndex, this.endIndex].concat([node, this.existential]));
    } else {
      return this;
    }
  };
...
RootNode = Node.Root = (function () {
  ...
  RootNode.prototype.walk = function (f) {
    ...
    body = f(this.body);
    if (body !== this.body) {
      return RootNode.apply(void 0, [this.startIndex, this.endIndex].concat([body]));
    } else {
      return this;
    }
  };
...
SpreadNode = Node.Spread = (function () {
  ...
  SpreadNode.prototype.walk = function (f) {
    ...
    node = f(this.node);
    if (node !== this.node) {
      return SpreadNode.apply(void 0, [this.startIndex, this.endIndex].concat([node]));
    } else {
      return this;
    }
  };
...
StringNode = Node.String = (function () {
  ...
  StringNode.prototype.walk = function (f) {
    ...
    if (parts !== this.parts) {
      return StringNode.apply(void 0, [this.startIndex, this.endIndex].concat([parts]));
    } else {
      return this;
    }
  };
...
SyntaxChoiceNode = Node.SyntaxChoice = (function () {
  ...
  SyntaxChoiceNode.prototype.walk = function (f) {
    ...
    if (choices !== this.choices) {
      return SyntaxChoiceNode.apply(void 0, [this.startIndex, this.endIndex].concat([choices]));
    } else {
      return this;
    }
  };
...
SyntaxManyNode = Node.SyntaxMany = (function () {
  ...
  SyntaxManyNode.prototype.walk = function (f) {
    ...
    inner = f(this.inner);
    if (inner !== this.inner) {
      return SyntaxManyNode.apply(void 0, [this.startIndex, this.endIndex].concat([inner, this.multiplier]));
    } else {
      return this;
    }
  };
...
SyntaxSequenceNode = Node.SyntaxSequence = (function () {
  ...
  SyntaxSequenceNode.prototype.walk = function (f) {
    ...
    if (params !== this.params) {
      return SyntaxSequenceNode.apply(void 0, [this.startIndex, this.endIndex].concat([params]));
    } else {
      return this;
    }
  };
...
TryCatchNode = Node.TryCatch = (function () {
  ...
  TryCatchNode.prototype.walk = function (f) {
    ...
    if (tryBody !== this.tryBody || catchIdent !== this.catchIdent || catchBody !== this.catchBody) {
      return TryCatchNode.apply(void 0, [this.startIndex, this.endIndex].concat([tryBody, catchIdent, catchBody]));
    } else {
      return this;
    }
  };
...
TryFinallyNode = Node.TryFinally = (function () {
  ...
  TryFinallyNode.prototype.walk = function (f) {
    ...
    if (tryBody !== this.tryBody || finallyBody !== this.finallyBody) {
      return TryFinallyNode.apply(void 0, [this.startIndex, this.endIndex].concat([tryBody, finallyBody]));
    } else {
      return this;
    }
  };
...
TypeArrayNode = Node.TypeArray = (function () {
  ...
  TypeArrayNode.prototype.walk = function (f) {
    ...
    if (subtype !== this.subtype) {
      return TypeArrayNode.apply(void 0, [this.startIndex, this.endIndex].concat([subtype]));
    } else {
      return this;
    }
  };
...
TypeUnionNode = Node.TypeUnion = (function () {
  ...
  TypeUnionNode.prototype.walk = function (f) {
    ...
    if (types !== this.types) {
      return TypeUnionNode.apply(void 0, [this.startIndex, this.endIndex].concat([types]));
    } else {
      return this;
    }
  };
...
UnaryNode = Node.Unary = (function () {
  ...
  UnaryNode.prototype.walk = function (f) {
    ...
    node = f(this.node);
    if (node !== this.node) {
      return UnaryNode.apply(void 0, [this.startIndex, this.endIndex].concat([this.op, node]));
    } else {
      return this;
    }
  };
...
UseMacroNode = Node.UseMacro = (function () {
  ...
  UseMacroNode.prototype.walk = function (f) {
    ...
    node = f(this.node);
    if (node !== this.node) {
      return UseMacroNode.apply(void 0, [this.startIndex, this.endIndex].concat([node, this.tmps, this.macroHelpers]));
    } else {
      return this;
    }
  };
...
YieldNode = Node.Yield = (function () {
  ...
  YieldNode.prototype.walk = function (f) {
    ...
    node = f(this.node);
    if (node !== this.node) {
      return YieldNode.apply(void 0, [this.startIndex, this.endIndex].concat([node, this.multiple]));
    } else {
      return this;
    }
  };
