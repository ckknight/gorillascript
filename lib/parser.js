...
break;
  ...
  Node.DefineHelper = DefineHelperNode = (function (_super) {
    ...
    function DefineHelperNode(startIndex, endIndex, name, value) {
      ...
      _this = this instanceof DefineHelperNode ? this : __create(_proto);
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.name = name;
      _this.value = value;
    ...
    _proto.inspect = function (depth) {
      return "DefineHelperNode(" + inspect(this.name, null, depth != null ? depth - 1 : null) + ", " + inspect(this.value, null, depth != null ? depth - 1 : null) + ")";
    };
