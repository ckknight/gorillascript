(function () {
            ...
            if (radix === 2) {
              ...
              digit = (function () {
                ...
                for (i = 0, _end = __num(!__lte(radix, 10) ? radix : 10); i < _end; ++i) {
                  chars[__num(i) - -__num(48)] = true;
                }
                for (i = 10, _end = __num(!__lte(radix, 36) ? radix : 36); i < _end; ++i) {
                  chars[__num(i) - 10 - -__num(97)] = true;
                  chars[__num(i) - 10 - -__num(65)] = true;
                }
                return function (o) {
                  var c;
                  c = o.data.charCodeAt(o.index);
            ...
            _rule4 = (function () {
              ...
              _rule6 = (function () {
                ...
                _rule7 = (function () {
                  ...
                  return named(
                    __strnum((_rule8 != null ? _rule8.parserName : void 0) || "<nothing>") + "*",
                    function (o) {
                      var clone, result;
                      clone = o.clone();
                      result = [];
    ...
    _rule = (function () {
      ...
      _rule3 = (function () {
        ...
        _rule4 = (function () {
          ...
          return named(
            __strnum((_rule5 != null ? _rule5.parserName : void 0) || "<nothing>") + "*",
            function (o) {
              var clone, result;
              clone = o.clone();
              result = [];
        ...
        _rule5 = (function () {
          ...
          return (function () {
            function _rule10(o) {
              ...
              clone = o.clone();
              result = {};
              if ((result.existential = MaybeExistentialSymbolNoSpace(clone)) && EmptyLines(clone) && Space(clone) && (result.type = _rule9(clone)) && (result.child = IdentifierNameConstOrNumberLiteral(clone))) {
                o.update(clone);
                return result;
              } else {
                return false;
        ...
        _rule6 = (function () {
          ...
          return (function () {
            function _rule10(o) {
              ...
              clone = o.clone();
              result = {};
              if ((result.existential = MaybeExistentialSymbolNoSpace(clone)) && (result.type = _rule9(clone)) && OpenSquareBracketChar(clone) && (result.child = Index(clone)) && CloseSquareBracket(clone)) {
                o.update(clone);
                return result;
              } else {
                return false;
        ...
        _rule7 = (function () {
          ...
          return (function () {
            function _rule10(o) {
              ...
              clone = o.clone();
              result = {};
              if ((result.existential = MaybeExistentialSymbolNoSpace(clone)) && (result.isApply = _rule9(clone)) && (result.args = InvocationArguments(clone))) {
                o.update(clone);
                return result;
              } else {
                return false;
  ...
  MacroHelper = (function () {
    ...
    MacroHelper.prototype.assign = function (left, op, right) {
      ...
      return this.state.assign(this.index, left, op, right);
    };
    MacroHelper.prototype.binary = function (left, op, right) {
      if (!(left instanceof Object)) {
        throw TypeError("Expected left to be a Object, got " + __typeof(left));
      }
      if (typeof op !== "string") {
      ...
      return this.state.binary(this.index, left, op, right);
    };
    MacroHelper.prototype.unary = function (op, node) {
      if (typeof op !== "string") {
        throw TypeError("Expected op to be a String, got " + __typeof(op));
      }
      ...
      return this.state.unary(this.index, op, node);
    };
    MacroHelper.prototype["throw"] = function (node) {
      if (!(node instanceof Node)) {
        throw TypeError("Expected node to be a Node, got " + __typeof(node));
      }
      return this.state["throw"](this.index, node);
    };
    getTmpId = (function () {
      var id;
      id = -1;
    ...
    MacroHelper.prototype.maybeCache = function (node, func, name, save) {
      var tmp;
      if (name == null) {
        name = "ref";
      } else if (typeof name !== "string") {
    ...
    MacroHelper.prototype.maybeCacheAccess = function (node, func) {
      var _this;
      _this = this;
      if (this.isAccess(node)) {
        return this.maybeCache(this.parent(node), function (setParent, parent, parentCached) {
          return _this.maybeCache(_this.child(node), function (setChild, child, childCached) {
    ...
    MacroHelper.prototype.isAccess = function (node) {
      ...
      if (node instanceof AccessNode) {
        ...
        links = node.links;
        lastLink = links[__num(links.length) - 1];
        return lastLink.type === "access" || lastLink.type === "index";
      } else {
        return false;
      }
    };
    MacroHelper.prototype.parent = function (node) {
      ...
      if (node instanceof AccessNode) {
        ...
        links = node.links;
        if (links[__num(links.length) - 1].type === "access") {
          if (links.length === 1) {
            return node.head;
          } else {
            return CallChainNode(node.startIndex, node.endIndex, node.head, __slice(links, void 0, __num(links.length) - 1));
    ...
    MacroHelper.prototype.child = function (node) {
      ...
      if (node instanceof AccessNode) {
        ...
        links = node.links;
        if (links[__num(links.length) - 1].type === "access") {
          return links[__num(links.length) - 1].child;
        }
      }
    };
    ...
    MacroHelper.prototype.isType = function (node, name) {
      var type;
      if (typeof name !== "string") {
        throw TypeError("Expected name to be a String, got " + __typeof(name));
      }
    ...
    MacroHelper.prototype.hasType = function (node, name) {
      var type;
      if (typeof name !== "string") {
        throw TypeError("Expected name to be a String, got " + __typeof(name));
      }
  ...
  MacroHolder = (function () {
    ...
    MacroHolder.prototype.addBinaryOperator = function (operators, m, options) {
      var _ref, _ref2, _this, binaryOperators, precedence;
      _this = this;
    ...
    MacroHolder.prototype.addAssignOperator = function (operators, m, options) {
      var _this;
      _this = this;
    ...
    MacroHolder.prototype.addUnaryOperator = function (operators, m, options) {
      var _this, data;
      _this = this;
      if (options.postfix) {
  ...
  State = (function () {
    var ASSIGN_OPERATOR, BINARY_OPERATOR, macroSyntaxTypes, UNARY_OPERATOR;
    ...
    macroSyntaxTypes = {
      syntax: function (index, params, body) {
        ...
        translated = require("./translator")(rawFunc, { "return": true });
      ...
      binaryOperator: function (index, operators, body, options) {
        ...
        rawFunc = this.root(index, this["return"](index, this["function"](
          ...
          [
            ...
            ].concat(options.invertible
              ? [
                {
                  key: this["const"](index, "inverted"),
                  value: this.param(
                    index,
                    this.ident(index, "inverted"),
                    void 0,
                    false,
                    true,
                    void 0
        ...
        return { handler: handler, rule: void 0, macroHelpers: translated.macroHelpers };
      },
    ...
    State.prototype.macroSyntax = function (index, type, params, body, options) {
      var _this, data, handler, m, macroHelpers, macroId, macros, rule;
      _this = this;
      if (options == null) {
        options = {};
      }
      ...
      data = macroSyntaxTypes[type].call(
        this,
        index,
        params,
        body,
      ...
      function mutator(x, o, i) {
        ...
        if (_inAst.peek()) {
          ...
          if (tmps.unsaved.length || macroHelpers.length) {
      ...
      if (this.currentMacro === BINARY_OPERATOR) {
        macroId = macros.addBinaryOperator(params, mutator, options);
      } else if (this.currentMacro === ASSIGN_OPERATOR) {
        macroId = macros.addAssignOperator(params, mutator, options);
      } else if (this.currentMacro === UNARY_OPERATOR) {
        macroId = macros.addUnaryOperator(params, mutator, options);
      } else {
    ...
    State.prototype.defineBinaryOperator = function (index, operators, options, body) {
      this.startMacro(BINARY_OPERATOR);
      try {
        this.macroSyntax(
          index,
          "binaryOperator",
      ...
      return this.nothing(index);
    };
    ASSIGN_OPERATOR = freeze({});
    State.prototype.defineAssignOperator = function (index, operators, options, body) {
      this.startMacro(ASSIGN_OPERATOR);
      try {
        this.macroSyntax(
          index,
          "assignOperator",
    ...
    State.prototype.defineUnaryOperator = function (index, operators, options, body) {
      this.startMacro(UNARY_OPERATOR);
      try {
        this.macroSyntax(
          index,
          "unaryOperator",
  ...
  ArgsNode = Node.Args = (function () {
    ...
    ArgsNode.prototype.type = function () {
      return types.args;
    };
  ...
  ArrayNode = Node.Array = (function () {
    ...
    ArrayNode.prototype.type = function () {
      return types.array;
    };
  ...
  AssignNode = Node.Assign = (function () {
    ...
    AssignNode.prototype.type = (function () {
      var ops;
      ops = {
        "=": function (left, right) {
          return right;
  ...
  BinaryNode = Node.Binary = (function () {
    ...
    BinaryNode.prototype.type = (function () {
      var ops;
      ops = {
        "*": types.number,
        "/": types.number,
  ...
  BlockNode = Node.Block = (function () {
    ...
    BlockNode.prototype.type = function () {
      var nodes;
      nodes = this.nodes;
      if (nodes.length === 0) {
      ...
      linkTypes = {
        ...
        accessIndex: (function () {
          ...
          return function (link, func) {
            ...
            if (child !== link.child) {
              return { type: "accessIndex", child: child, existential: link.existential };
            } else {
              return link;
            }
          };
  ...
  ConstNode = Node.Const = (function () {
    ...
    ConstNode.prototype.type = function () {
      var type;
      if (this.value === null) {
        return types["null"];
      } else {
        ...
        if (type === "number") {
          ...
          throw Error("Unknown type for " + __strnum(String(this.value)));
        }
      }
    };
  ...
  FunctionNode = Node.Function = (function () {
    ...
    FunctionNode.prototype.type = function () {
  ...
  IfNode = Node.If = (function () {
    ...
    IfNode.prototype.type = function () {
      var _ref;
      if ((_ref = this._type) != null) {
        return _ref;
      } else {
  ...
  LetNode = Node.Let = (function () {
    ...
    LetNode.prototype.type = function () {
  ...
  NothingNode = Node.Nothing = (function () {
    ...
    NothingNode.prototype.type = function () {
      return types["undefined"];
    };
  ...
  ObjectNode = Node.Object = (function () {
    ...
    ObjectNode.prototype.type = function () {
      return types.object;
    };
  ...
  RegexpNode = Node.Regexp = (function () {
    ...
    RegexpNode.prototype.type = function () {
      return types.regexp;
    };
  ...
  ReturnNode = Node.Return = (function () {
    ...
    ReturnNode.prototype.type = function () {
  ...
  StringNode = Node.String = (function () {
    ...
    StringNode.prototype.type = function () {
      return types.string;
    };
  ...
  ThrowNode = Node.Throw = (function () {
    function ThrowNode(startIndex, endIndex, node) {
      var self;
      if (!(node instanceof Node)) {
        throw TypeError("Expected node to be a Node, got " + __typeof(node));
      }
      self = __create(ThrowNode.prototype);
      self.startIndex = startIndex;
      self.endIndex = endIndex;
      self.node = node;
      return self;
    }
    ThrowNode.prototype = __create(Node.prototype);
    ...
    ThrowNode.prototype.type = function () {
      return types.none;
    };
    ThrowNode.prototype.walk = function (f) {
      var node;
      node = f(this.node);
      if (node !== this.node) {
  ...
  TryCatchNode = Node.TryCatch = (function () {
    ...
    TryCatchNode.prototype.type = function () {
      var _ref;
      if ((_ref = this._type) != null) {
        return _ref;
      } else {
  ...
  TryFinallyNode = Node.TryFinally = (function () {
    ...
    TryFinallyNode.prototype.type = function () {
  ...
  UnaryNode = Node.Unary = (function () {
    ...
    UnaryNode.prototype.type = (function () {
      var ops;
      ops = {
        "-": types.number,
        "+": types.number,
  ...
  UseMacroNode = Node.UseMacro = (function () {
    ...
    UseMacroNode.prototype.type = function () {
      return this.node.type();
    };
