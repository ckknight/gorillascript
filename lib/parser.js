(function (GLOBAL) {
  ...
  var __bind, __cmp, __compose, __create, __curry, __defer,
      ...
      TripleSingleStringLiteral, Type, TypeFunctionNode, TypeGenericNode,
      TypeObjectNode, TypeReference, TypeUnionNode, UnclosedArguments,
  ...
  parse.getReservedWords = function (macros, options) {
    ...
    return unique(__toArray(getReservedIdents(options)).concat(__toArray(macros != null && typeof macros.getMacroAndOperatorNames === "function" && void 0 || [])));
  };
