(function (GLOBAL) {
  ...
  var __bind, __cmp, __compose, __create, __curry, __defer,
      ...
      LSymbol, LValue, MacroBody, MacroContext, MacroError, MacroHolder,
  ...
  function validateSpreadParameters(params, parser) {
    ...
    for (_arr = __toArray(params), _i = 0, _len = _arr.length; _i < _len; ++_i) {
      param = _arr[_i];
      if (param instanceof LispyNode && param.isInternalCall("param") && param.args[2].constValue()) {
        ++spreadCount;
        if (spreadCount > 1) {
  ...
  ParameterSequence = mutate((function () {
    function checkParam(param, parser, names) {
      ...
      if (param instanceof LispyNode && param.isInternalCall()) {
  ...
  _FunctionDeclaration = (function () {
    ...
    return allowSpaceBeforeAccess(function (parser, index) {
      ...
      func = LInternalCall(
        ...
        index,
        parser.scope.peek(),
        LInternalCall.apply(void 0, ["array", index, parser.scope.peek()].concat(__toArray(params.value))),
    ...
    function handleBinaryOperator(operator, parser, index) {
      ...
      result = mutateFunction(
        LInternalCall(
          ...
          index,
          parser.scope.peek(),
          LInternalCall.apply(void 0, ["array", index, parser.scope.peek()].concat((function () {
            var _arr, _arr2, _i, _len, ident;
            for (_arr = [], _arr2 = [left, right], _i = 0, _len = _arr2.length; _i < _len; ++_i) {
              ident = _arr2[_i];
  ...
  Parser = (function () {
    ...
    function makeMacroRoot(index, params, body) {
      ...
      return LInternalCall(
        ...
        LInternalCall("return", index, scope, LInternalCall(
          ...
          index,
          scope,
          LInternalCall.apply(void 0, ["array", index, scope, params].concat((function () {
    ...
    function removeNoops(obj) {
      ...
      if (__isArray(obj)) {
        ...
        return _arr;
      } else if (obj instanceof Node || obj instanceof Type) {
        return obj;
  ...
  for (_arr = ["Function", "MacroAccess"], _i = 0, _len = _arr.length; _i < _len; ++_i) {
    nodeType = _arr[_i];
