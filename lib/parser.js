...
break;
        ...
        return (function () {
          ...
          function _mutator(x, o, i) {
            ...
            for (j = __num(stringParts.length) - 2; j >= 0; --j) {
  ...
  FunctionDeclaration = cache(named("FunctionDeclaration", (function () {
    ...
    return (function () {
      ...
      function _mutator(x, o, i) {
        var _o, autoReturn, body, generator;
        _o = x.generatorBody;
        body = _o.body;
        generator = _o.generator;
        ...
        function _mutator(x, o, i) {
          ...
          if (x.options !== NOTHING) {
            for (_arr = x.options.pairs, _i = 0, _len = __num(_arr.length); _i < _len; ++_i) {
              ...
              if (!pair.value.isConst()) {
                o.error("Cannot have non-const value in the options");
              }
              options[pair.key.constValue()] = pair.value.constValue();
            }
          }
          ...
          access: (function () {
            ...
            indexTypes = {
              ...
              multi: function (o, i, child) {
                return function (parent) {
                  ...
                  tmpIds = [];
                  if (parent.cacheable) {
                    tmp = o.tmp(i, getTmpId(), "ref", parent.type());
                    tmpIds.push(tmp.id);
            ...
            return function (o, i, head, link, j, links) {
              ...
              if (link.owns) {
                ...
                setHead = head;
                if (head.cacheable) {
                  tmp = o.tmp(i, getTmpId(), "ref", head.type());
                  tmpIds.push(tmp.id);
                ...
                setChild = child;
                if (child.cacheable) {
                  tmp = o.tmp(i, getTmpId(), "ref", child.type());
                  tmpIds.push(tmp.id);
                  setChild = o.assign(i, tmp, "=", child);
                  child = tmp;
                }
                test = o.call(
                  i,
  ...
  ArrayDeclarableElement = cache(named("ArrayDeclarableElement", function (o) {
  ...
  DeclarableKeyValuePair = cache(named("DeclarableKeyValuePair", function (o) {
  ...
  Declarable = cache(named("Declarable", function (o) {
  ...
  Statement = cache(named("Statement", (function () {
    ...
    _rule = inStatement(function (o) {
      return Let(o) || Def(o) || Return(o) || Yield(o) || Break(o) || Continue(o) || Macro(o) || DefineHelper(o) || DefineOperator(o) || DefineSyntax(o) || Assignment(o) || ExpressionAsStatement(o);
    });
    return function (o) {
      var clone, result;
      clone = o.clone();
  ...
  MacroHelper = (function () {
    ...
    _proto.maybeCache = function (node, func, name, save) {
      ...
      if (this.isComplex(node)) {
        tmp = this.tmp(name, save, node.type());
        return func(
          this.state["let"](
            this.index,
  ...
  State = (function () {
    var _proto, ASSIGN_OPERATOR, BINARY_OPERATOR, DEFINE_SYNTAX, macroSyntaxConstLiterals, macroSyntaxIdents, macroSyntaxTypes, UNARY_OPERATOR;
    function State(data, macros, index, line, failures, cache, indent, currentMacro, preventFailures) {
      var _this;
      if (macros == null) {
        macros = MacroHolder();
      }
    ...
    _proto.defineHelper = function (i, name, value) {
      ...
      translator.defineHelper(name, value);
    ...
    function calcParam(param) {
      ...
      if (param instanceof IdentNode) {
        if (!__owns(macroSyntaxIdents, param.name)) {
          State.error("Unexpected type ident: " + __strnum(ident));
        }
        ...
        if (typeof string !== "string") {
          State.error("Expected a constant string parameter, got " + __typeof(string));
        }
        ...
        return State.error("Unexpected type: " + __typeof(param));
      }
    }
    function handleParams(params) {
      var _i, _len, _ref, ident, key, param, sequence, string, type;
      sequence = [];
      for (_i = 0, _len = __num(params.length); _i < _len; ++_i) {
        param = params[_i];
        if (param.isConst()) {
          ...
          State.error("Unexpected parameter type: " + __typeof(param));
        }
      }
      ...
      syntax: function (index, params, body) {
        ...
        return {
          handler: function (args) {
            ...
            return handler.apply(this, [reduceObject(args)].concat(__toArray(rest))).reduce();
          },
          rule: handleParams(params)
        };
      },
      defineSyntax: function (index, params, body, options) {
        var _this, funcParams, handler;
        _this = this;
        funcParams = (function () {
          var _arr, _i, _len, param;
          for (_arr = [], _i = 0, _len = __num(params.length); _i < _len; ++_i) {
        ...
        handler = body != null
          ? (function () {
            ...
            return function (args) {
              var rest;
              rest = __slice(arguments, 1);
              return reduceObject(handler.apply(this, [reduceObject(args)].concat(__toArray(rest))));
            };
          }())
          : function (args) {
            var rest;
            rest = __slice(arguments, 1);
            return reduceObject(args);
          };
        return { handler: handler, rule: handleParams(params) };
      },
      call: function (index, params, body) {
        ...
        handler = (function (inner) {
          return function (args) {
            var rest;
            rest = __slice(arguments, 1);
            return inner.apply(this, [reduceObject(args)].concat(__toArray(rest))).reduce();
          };
        }(handler));
        ...
        if (options.invertible) {
          handler = (function (inner) {
            return function (args) {
              var rest, result;
              rest = __slice(arguments, 1);
              result = inner.apply(this, [reduceObject(args)].concat(__toArray(rest)));
              if (args.inverted) {
                return UnaryNode(result.startIndex, result.endIndex, "!", result).reduce();
              } else {
    ...
    _proto.macroSyntax = function (index, type, params, body, options) {
      ...
      macroId = (function () {
        ...
        case DEFINE_SYNTAX:
          return macroSyntaxIdents[options.name] = named(
  ...
  Node.Access = AccessNode = (function (_super) {
    ...
    _proto._reduce = function () {
      ...
      parent = this.parent.reduce();
      child = this.child.reduce();
  ...
  Node.ArrayDeclarable = ArrayDeclarableNode = (function (_super) {
    ...
    function ArrayDeclarableNode(startIndex, endIndex, elements) {
      ...
      _this = this instanceof ArrayDeclarableNode ? this : __create(_proto);
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.elements = elements;
      return _this;
    ...
    _proto.inspect = function (depth) {
      return "ArrayDeclarableNode(" + inspect(this.elements, null, depth != null ? depth - 1 : null) + ")";
    };
  ...
  Node.Binary = BinaryNode = (function (_super) {
    ...
    _proto._reduce = (function () {
      ...
      leftConstOps = {
        ...
        "+": function (x, y) {
          if (x.constValue() === 0 && y.type().isSubsetOf(Type.number)) {
            return UnaryNode(this.startIndex, this.endIndex, "+", y);
          } else if (x.constValue() === "" && y.type().isSubsetOf(Type.string)) {
            return y;
          }
        },
        "-": function (x, y) {
      ...
      rightConstOps = {
        ...
        "+": function (x, y) {
          if (y.constValue() === 0 && x.type().isSubsetOf(Type.number)) {
            return UnaryNode(this.startIndex, this.endIndex, "+", x);
          } else if (typeof y.constValue() === "number" && __num(y.value) < 0 && x.type().isSubsetOf(Type.number)) {
            return BinaryNode(
              this.startIndex,
              this.endIndex,
              x,
          ...
          } else if (y.constValue() === "" && x.type().isSubsetOf(Type.string)) {
            return x;
          }
        },
        "-": function (x, y) {
          if (y.constValue() === 0) {
            return UnaryNode(this.startIndex, this.endIndex, "+", x);
          } else if (typeof y.constValue() === "number" && __num(y.constValue()) < 0 && x.type().isSubsetOf(Type.number)) {
            return BinaryNode(
              this.startIndex,
              this.endIndex,
              x,
      ...
      return function () {
        ...
        if (left.isConst()) {
          ...
          if ((_ref = __owns(leftConstOps, op) ? leftConstOps[op].call(this, left, right) : void 0) != null) {
            return _ref;
          }
        }
        if (right.isConst() && (_ref = __owns(rightConstOps, op) ? rightConstOps[op].call(this, left, right) : void 0) != null) {
          return _ref;
        }
        if (left !== this.left || right !== this.right) {
          return BinaryNode(
    ...
    _proto.type = (function () {
      ...
      return function () {
        ...
        if ((_ref = this._type) != null) {
          ...
          return this._type = (function () {
            var _ref, _ref2, _ref3, child, func, helpers, name, parent;
            func = _this.func;
            if (func instanceof IdentNode) {
              ...
              parent = func.parent;
              child = func.child;
              if (child instanceof ConstNode && parent instanceof IdentNode && (_ref = __owns(PRIMORDIAL_SUBFUNCTIONS, _ref = parent.name) && __owns(_ref2 = PRIMORDIAL_SUBFUNCTIONS[_ref], _ref3 = child.value) ? _ref2[_ref3] : void 0) != null) {
                return _ref;
              }
            }
            return Type.any;
  ...
  Node.Declarable = DeclarableNode = (function (_super) {
    ...
    function DeclarableNode(startIndex, endIndex, ident, isMutable, spread, asType) {
      ...
      _this = this instanceof DeclarableNode ? this : __create(_proto);
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.ident = ident;
    ...
    _proto._reduce = function () {
      var asType, ident;
      ident = this.ident.reduce();
      if (ident instanceof DeclarableNode) {
        return ident;
      } else {
        asType = this.asType != null ? this.asType.reduce() : this.asType;
        if (ident !== this.ident || asType !== this.asType) {
          return DeclarableNode(ident, this.isMutable, this.spread, asType);
        } else {
          return this;
        }
      }
    ...
    _proto.inspect = function (depth) {
      return "DeclarableNode(" + inspect(this.ident, null, depth != null ? depth - 1 : null) + ", " + inspect(this.isMutable, null, depth != null ? depth - 1 : null) + ", " + inspect(this.spread, null, depth != null ? depth - 1 : null) + ", " + inspect(this.asType, null, depth != null ? depth - 1 : null) + ")";
    };
    return DeclarableNode;
  }(Node));
  ...
  Node.Let = LetNode = (function (_super) {
    ...
    function LetNode(startIndex, endIndex, left, right) {
      ...
      _this = this instanceof LetNode ? this : __create(_proto);
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.left = left;
      _this.right = right;
    ...
    _proto.inspect = function (depth) {
      return "LetNode(" + inspect(this.left, null, depth != null ? depth - 1 : null) + ", " + inspect(this.right, null, depth != null ? depth - 1 : null) + ")";
    };
    return LetNode;
  }(Node));
  Node.MacroAccess = MacroAccessNode = (function (_super) {
    ...
    _proto.inspect = function (depth) {
      return "MacroAccessNode(" + inspect(this.id, null, depth != null ? depth - 1 : null) + ", " + inspect(this.data, null, depth != null ? depth - 1 : null) + ")";
    };
  ...
  Node.Object = ObjectNode = (function (_super) {
    ...
    _proto.inspect = function (depth) {
      return "ObjectNode(" + inspect(this.pairs, null, depth != null ? depth - 1 : null) + ")";
    };
    return ObjectNode;
  }(Node));
  ...
  Node.ObjectDeclarable = ObjectDeclarableNode = (function (_super) {
    ...
    function ObjectDeclarableNode(startIndex, endIndex, pairs) {
      ...
      _this = this instanceof ObjectDeclarableNode ? this : __create(_proto);
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.pairs = pairs;
      return _this;
    ...
    _proto.inspect = function (depth) {
      return "ObjectDeclarableNode(" + inspect(this.pairs, null, depth != null ? depth - 1 : null) + ")";
    };
  ...
  Node.Return = ReturnNode = (function (_super) {
    ...
    _proto.inspect = function (depth) {
      return "ReturnNode(" + inspect(this.node, null, depth != null ? depth - 1 : null) + ", " + inspect(this.existential, null, depth != null ? depth - 1 : null) + ")";
    };
    return ReturnNode;
  }(Node));
  ...
  Node.String = StringNode = (function (_super) {
    ...
    function StringNode(startIndex, endIndex, parts) {
      ...
      _this = this instanceof StringNode ? this : __create(_proto);
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.parts = parts;
      return _this;
    ...
    _proto._reduce = function () {
      ...
      for (_arr = this.parts, _i = 0, _len = __num(_arr.length); _i < _len; ++_i) {
        ...
        reduced = part.reduce();
        if (reduced.isConst()) {
          if (typeof reduced.constValue() !== "string") {
            segments.push(ConstNode(reduced.startIndex, reduced.endIndex, String(reduced.constValue())));
          } else {
            segments.push(reduced);
          }
        } else if (!reduced.type().isSubsetOf(Type.stringOrNumber)) {
      ...
      for (i = __num(segments.length) - 1; i > 0; --i) {
        ...
        if (left.isConst() && right.isConst()) {
          segments.splice(__num(i) - 1, 2, ConstNode(left.startIndex, right.endIndex, __strnum(left.constValue()) + __strnum(right.constValue())));
        } else if (right.isConst() && right.constValue() === "") {
          segments.splice(i, 1);
        }
      }
      if (__num(segments.length) > 1 && segments[0].isConst() && segments[0].constValue() === "" && (segments[1].type().isSubsetOf(Type.string) || __num(segments.length) > 2 && segments[2].type().isSubsetOf(Type.string))) {
        segments.shift();
      }
      result = segments[0];
    ...
    _proto.inspect = function (depth) {
      return "StringNode(" + inspect(this.parts, null, depth != null ? depth - 1 : null) + ")";
    };
    return StringNode;
  }(Node));
  ...
  Node.Unary = UnaryNode = (function (_super) {
    ...
    _proto._reduce = (function () {
      ...
      nonconstOps = {
        "+": function (node) {
          if (node.type().isSubsetOf(Type.number)) {
            return node;
          }
        },
        "-": function (node) {
        ...
        "!": (function () {
          ...
          return function (node) {
            var invert;
            if (node instanceof UnaryNode) {
              if (node.op === "!" && node.node.type().isSubsetOf(Type.boolean)) {
                return node.node;
              }
      ...
      return function () {
        ...
        result = __owns(nonconstOps, op) ? nonconstOps[op].call(this, node) : void 0;
        if (result != null) {
          return result.reduce();
        }
        if (node !== this.node) {
  ...
  Node.Yield = YieldNode = (function (_super) {
    ...
    _proto.inspect = function (depth) {
      return "YieldNode(" + inspect(this.node, null, depth != null ? depth - 1 : null) + ", " + inspect(this.multiple, null, depth != null ? depth - 1 : null) + ")";
    };
    return YieldNode;
  }(Node));
  ...
  function parse(text, macros, options) {
    var _o, index, lastToken, line, messages, o, result;
    if (options == null) {
      options = {};
    }
