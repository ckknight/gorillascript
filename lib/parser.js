(function (GLOBAL) {
  ...
  var __bind, __cmp, __compose, __create, __curry, __defer,
      ...
      IdentifierParameter, IdentNode, Imports, inAst, inCascade,
      ...
      ThisOrShorthandLiteralPeriod, ThisShorthandLiteral, TmpNode, trimRight,
  ...
  ThisLiteral = cache((_ref = word("this"), mutate(function (_p, parser, index) {
    return LSymbol.ident(index, parser.scope, "this");
  })(_ref)));
  ...
  ArgumentsLiteral = cache((_ref = word("arguments"), mutate(function (_p, parser, index) {
    return LSymbol.ident(index, parser.scope, "arguments");
  })(_ref)));
  ...
  DoubleStringArrayLiteral = cache((_ref = sequential(
    ...
    return LInternalCall.apply(void 0, ["array", index, parser.scope.peek()].concat(__toArray(stringParts)));
  })(_ref)));
  ...
  IdentifierOrAccess = cache(function (parser, index) {
    ...
    if (result) {
      value = result.value;
      if (value instanceof IdentNode || value instanceof LispyNode && value.isInternalCall("access")) {
        return result;
      }
    }
  });
      ...
      while (true) {
        ...
        case 6:
          ...
          return {
            ...
            value: Box(currentIndex, LInternalCall.apply(void 0, ["block", index, parser.scope.peek()].concat(__toArray(nodes), [
              LInternalCall("return", index, parser.scope.peek(), parser.Ident(index, "write"))
            ])))
          };
        case 7:
          return { done: true, value: void 0 };
  ...
  Parser = (function () {
    ...
    function makeMacroRoot(index, params, body) {
      return LInternalCall(
        ...
        this.scope.peek(),
        LValue(index, null),
        LInternalCall("return", index, this.scope.peek(), this.Function(
          index,
          [
            params,
            this.Param(
    ...
    function serializeParamType(asType) {
      if (asType instanceof IdentNode) {
        ...
        return ["many", asType.args[1].constValue()].concat(__toArray(serializeParamType(asType.args[0])));
      } else {
      ...
      return simplifyArray((function () {
        ...
        for (_arr = [], _arr2 = __toArray(params), _i = 0, _len = _arr2.length; _i < _len; ++_i) {
          ...
          if (param.isConst()) {
            ...
            } else if (ident instanceof LSymbol && ident.isIdent && ident.name === "this") {
              value = ["this"];
            } else {
              throw Error();
            }
            if (!isNothing(asType)) {
              value.push.apply(value, __toArray(serializeParamType(asType)));
            }
            _arr.push(value);
          } else {
            throw Error();
    ...
    function handleParams(params) {
      var _arr, _i, _len, _ref, asType, ident, key, param, sequence, string,
          type;
      sequence = [];
      for (_arr = __toArray(params), _i = 0, _len = _arr.length; _i < _len; ++_i) {
        param = _arr[_i];
