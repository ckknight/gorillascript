...
break;
  ...
  Node.Binary = BinaryNode = (function (_super) {
    ...
    _proto._reduce = (function () {
      ...
      return function () {
        ...
        if (right.isConst() && __owns(rightConstOps, op) && (_ref = rightConstOps[op].call(this, left, right)) != null) {
          return _ref;
        }
        if (left !== this.left || right !== this.right) {
          return BinaryNode(
  ...
  Node.Call = CallNode = (function (_super) {
    ...
    _proto.type = (function () {
      ...
      return function () {
        ...
        if ((_ref = this._type) != null) {
          ...
          return this._type = (function () {
            var child, func, helpers, name, parent, subfuncs;
            func = _this.func;
            if (func instanceof IdentNode) {
              ...
              parent = func.parent;
              child = func.child;
              if (child instanceof ConstNode && parent instanceof IdentNode && __owns(PRIMORDIAL_SUBFUNCTIONS, parent.name)) {
                subfuncs = PRIMORDIAL_SUBFUNCTIONS[parent.name];
                if (__owns(subfuncs, child.value)) {
    ...
    _proto._reduce = (function () {
      ...
      return function () {
        var _i, _len, _ref, allConst, arg, args, child, constArgs, cValue, func, parent, pValue, value;
    ...
    _proto._reduce = (function () {
      ...
      return function () {
        ...
        if (__owns(nonconstOps, op)) {
          result = nonconstOps[op].call(this, node);
          if (result != null) {
            return result.reduce();
          }
        }
