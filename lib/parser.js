(function () {
  ...
  Parenthetical = named("Parenthetical", (function () {
    ...
    _rule = (function () {
      ...
      _rule3 = (function () {
        ...
        return (function () {
          function _rule6(o) {
            ...
            clone = o.clone();
            result = {};
            if ((result.left = Expression(clone)) && (result.operator = _rule5(clone)) && CloseParenthesis(clone)) {
              o.update(clone);
              return result;
            } else {
              return false;
      ...
      return function (o) {
        return _rule2(o) || _rule3(o) || CustomOperatorCloseParenthesis(o) || _rule4(o);
      };
    }());
    return (function () {
      function _rule2(o) {
