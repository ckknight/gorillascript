(function () {
  ...
  Node.AccessMulti = AccessMultiNode = (function (Node) {
    ...
    function AccessMultiNode(startIndex, endIndex, scopeId, parent, elements) {
      ...
      if (this instanceof AccessMultiNode) {
        _this = this;
      } else {
        _this = __create(_AccessMultiNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
    ...
    _AccessMultiNode_prototype.walk = (function () {
      var indexTypes;
      indexTypes = {
        multi: function (x, f) {
          var elements;
    ...
    _AccessMultiNode_prototype.inspect = function (depth) {
      return "AccessMultiNode(" + inspect(this.parent, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.elements, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return AccessMultiNode;
  }(Node));
  ...
  Node.Binary = BinaryNode = (function (Node) {
    ...
    _BinaryNode_prototype._reduce = (function () {
      ...
      return function (o) {
        ...
        if ((_ref = __owns(nonConstOps, op) ? nonConstOps[op].call(this, left, right, o) : void 0) != null) {
          return _ref;
        }
        if (left !== this.left || right !== this.right) {
          return BinaryNode(
    ...
    _IfNode_prototype._reduce = function (o) {
      ...
      if (test.isConst()) {
        ...
        if (testType.isSubsetOf(Type.alwaysTruthy)) {
          return BlockNode(this.startIndex, this.endIndex, this.scopeId, [test, whenTrue]);
        } else if (testType.isSubsetOf(Type.alwaysFalsy)) {
          return BlockNode(this.startIndex, this.endIndex, this.scopeId, [test, whenFalse]);
        } else {
          return IfNode(
            this.startIndex,
            this.endIndex,
