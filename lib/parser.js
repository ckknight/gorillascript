(function () {
  ...
  MacroError = (function (_super) {
    ...
    function MacroError(inner, text, index, line) {
      ...
      _this.message = __strnum(innerType === "Error" ? "" : __strnum(innerType) + ": ") + String(inner != null ? inner.message : void 0) + " at line #" + __strnum(line);
      _this.text = text;
      _this.index = index;
      _this.line = line;
      return _this;
  ...
  MacroHelper = (function () {
    ...
    _proto.isType = function (node, name) {
      ...
      return this.macroExpand1(node).type().isSubsetOf(type);
    };
    _proto.hasType = function (node, name) {
      ...
      return this.macroExpand1(node).type().overlaps(type);
    };
    mutators = {
  ...
  State = (function () {
    ...
    _proto.defineHelper = function (i, name, value) {
      ...
      translator = require("./translator");
      helper = translator.defineHelper(name, this.macroExpandAll(value).reduce());
    ...
    macroSyntaxTypes = {
      syntax: function (index, params, body, options, stateOptions) {
        ...
        translated = require("./translator")(this.macroExpandAll(rawFunc).reduce(), { "return": true });
      ...
      defineSyntax: function (index, params, body, options, stateOptions) {
        ...
        handler = body != null
          ? (function () {
            ...
            translated = require("./translator")(_this.macroExpandAll(rawFunc).reduce(), { "return": true });
            compilation = translated.node.toString();
  ...
  Node.Access = AccessNode = (function (_super) {
    ...
    _proto._reduce = function () {
      ...
      parent = this.parent.reduce().doWrap();
      child = this.child.reduce().doWrap();
  ...
  Node.Call = CallNode = (function (_super) {
    ...
    _proto._reduce = (function () {
      ...
      return function () {
        ...
        func = this.func.reduce().doWrap();
        args = map(this.args, function (node) {
          return node.reduce().doWrap();
        });
  ...
  Node.Object = ObjectNode = (function (_super) {
    ...
    _proto._reduce = (function () {
      function reducePair(pair) {
        var key, value;
        key = pair.key.reduce();
        value = pair.value.reduce().doWrap();
        if (key !== pair.key || value !== pair.value) {
          return { key: key, value: value };
        } else {
          return pair;
  ...
  Node.String = StringNode = (function (_super) {
    ...
    _proto._reduce = function () {
      ...
      for (i = __num(segments.length) - 1, -1; i > 0; i -= 1) {
  ...
  Node.Super = SuperNode = (function (_super) {
    ...
    _proto._reduce = function () {
      var args, child;
      child = this.child != null ? this.child.reduce().doWrap() : this.child;
      args = map(this.args, function (node) {
        return node.reduce().doWrap();
      });
      if (child !== this.child || args !== this.args) {
  ...
  function parse(text, macros, options) {
    ...
    if (!result || __lt(o.index, o.data.length)) {
      ...
      return { result: o.macroExpandAll(result).reduce(), macros: o.macros };
    }
  }
