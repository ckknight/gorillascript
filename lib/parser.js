(function (GLOBAL) {
  ...
  var __bind, __cmp, __compose, __create, __curry, __defer,
      ...
      TripleSingleStringLiteral, Type, TypeGenericNode, TypeObjectNode,
      TypeReference, UnclosedArguments, UnclosedArrayLiteralElement,
      UnclosedObjectLiteral, UnclosedObjectLiteralsAllowed, Underscore,
      UnicodeEscapeSequence, unique, unusedCaches, UseMacro, word, wordOrSymbol,
      Zero;
  _this = this;
