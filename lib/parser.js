(function () {
  ...
  State = (function () {
    ...
    _proto.defineHelper = function (i, name, value) {
      ...
      translator = require("./translator");
      helper = translator.defineHelper(name, this.macroExpand(value));
    ...
    macroSyntaxTypes = {
      syntax: function (index, params, body, options, stateOptions) {
        ...
        translated = require("./translator")(this.macroExpand(rawFunc).reduce(), { "return": true });
      ...
      defineSyntax: function (index, params, body, options, stateOptions) {
        ...
        handler = body != null
          ? (function () {
            ...
            translated = require("./translator")(_this.macroExpand(rawFunc).reduce(), { "return": true });
            compilation = translated.node.toString();
    ...
    _proto.macroExpand = function (node) {
      var _this;
      _this = this;
      function walker(node) {
        var result, walked;
        if (node._macroExpanded) {
          return node;
        } else {
          walked = node.walk(walker);
          if (node instanceof MacroAccessNode) {
            _position.push(walked.position);
            _inGenerator.push(walked.inGenerator);
            try {
              result = _this.macros.getById(walked.id)(walked.data, _this, walked.startIndex, walked.line);
              if (result instanceof Node) {
            ...
            walked._macroExpanded = true;
            return walked;
          }
        }
      }
      if (this.expandingMacros) {
  ...
  function parse(text, macros, options) {
    ...
    if (!result || __lt(o.index, o.data.length)) {
      ...
      return { result: o.macroExpand(result).reduce(), macros: o.macros };
    }
  }
