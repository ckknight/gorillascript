...
DefineOperatorBinary = cache(named("DefineOperatorBinary", (function () {
  var _rule, _rule2, _rule3;
  _rule = word("binary");
  _rule2 = (function () {
    function _rule3(o) {
  ...
  return (function () {
    function _rule4(o) {
      ...
      clone = o.clone();
      result = {};
      if (DefineOperatorStart(clone) && _rule(clone) && (result.head = NameOrSymbol(clone)) && (result.tail = _rule2(clone)) && (result.options = _rule3(clone)) && (result.body = FunctionBody(clone))) {
        o.update(clone);
        return result;
      } else {
        return false;
    ...
    function _mutator(x, o, i) {
      ...
      return o.defineBinaryOperator(i, [x.head].concat(__toArray(x.tail)), options, x.body);
    }
    return named(
      _rule4 != null ? _rule4.parserName : void 0,
      function (o) {
...
DefineOperator = cache(named("DefineOperator", (function () {
  ...
  _backend = inMacro((function () {
    ...
    return function (o) {
      return DefineOperatorBinary(o) || _rule(o);
    };
  }()));
  return named(
    _backend != null ? _backend.parserName : void 0,
...
getUseCustomBinaryOperator = (function () {
  ...
  return function (precedence) {
    var _ref;
    return (_ref = precedenceCache[precedence]) != null ? _ref
      : (precedenceCache[precedence] = cache(function (o) {
...
MacroHolder = (function () {
  ...
  MacroHolder.prototype.addBinaryOperator = function (operators, m, options) {
    ...
    binaryOperators = (_ref2 = (_ref = this.binaryOperators)[precedence]) != null ? _ref2 : (_ref[precedence] = []);
...
State = (function () {
  var BINARY_OPERATOR, macroSyntaxTypes;
