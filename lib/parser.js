(function () {
  ...
  CustomOperatorCloseParenthesis = cache(named("CustomOperatorCloseParenthesis", (function () {
    ...
    return function (o) {
      var _arr, _i, _i2, _len, _len2, _ref, clone, i, inverted, left, op, operator, operators, right;
      i = o.index;
  ...
  ObjectKey = cache(named("ObjectKey", (function () {
    ...
    return function (o) {
      return _rule(o) || StringLiteral(o) || _rule2(o) || IdentifierNameConst(o);
    };
  }())));
