(function () {
  "use strict";
  var __bind, __cmp, __create, __in, __isArray, __lt, __lte, __num, __owns, __slice, __splice, __str, __strnum, __toArray, __typeof, _FunctionBody, _inAst, _indexSlice, _inFunctionTypeParams, _inGenerator, _inMacro, _Name, _NameOrSymbol, _position, _preventUnclosedObjectLiteral, _Space, _Symbol, AccessIndexNode, AccessNode, Advance, AnyArrayLiteral, AnyChar, AnyObjectLiteral, ArgsNode, ArgumentsLiteral, ArrayLiteral, ArrayNode, ArrayParameter, ArrayType, Assignment, AssignmentAsExpression, AssignNode, Ast, Asterix, AstExpression, AstExpressionToken, AsToken, AstStatement, AstToken, AsType, AtSign, Backslash, BackslashEscapeSequence, BackslashStringLiteral, BasicInvocationOrAccess, BinaryDigit, BinaryInteger, BinaryNode, Block, BlockNode, Body, BodyOrStatementOrNothing, BracketedObjectKey, BreakNode, CallNode, CheckIndent, CheckStop, CloseCurlyBrace, ClosedArguments, CloseParenthesis, CloseSquareBracket, Colon, ColonChar, ColonEqual, Comma, CommaOrNewline, CommaOrNewlineWithCheckIndent, Comment, ComplexAssignable, ConstantLiteral, ConstNode, ContinueNode, CountIndent, CustomAssignment, CustomBinaryOperator, CustomOperatorCloseParenthesis, CustomPostfixUnary, CustomPrefixUnary, DebuggerNode, DecimalDigit, DecimalDigits, DecimalNumber, DeclareEqualSymbol, DedentedBody, DefineHelper, DefineHelperStart, DefineOperator, DefineOperatorStart, DefineSyntax, DefineSyntaxStart, DefNode, DirectAssignment, DollarSign, DoubleColon, DoubleQuote, DoubleStringArrayLiteral, DoubleStringLiteral, DoubleStringLiteralInner, DualObjectKey, eE, EmptyLine, EmptyLines, Eof, EscapeSequence, Eval, EvalNode, EvalToken, ExistentialSymbol, ExistentialSymbolNoSpace, Expression, ExpressionAsStatement, ExpressionOrAssignment, ExpressionOrNothing, ExtendsToken, FailureManager, FalseLiteral, ForInNode, ForNode, freeze, fromCharCode, FunctionBody, FunctionDeclaration, FunctionLiteral, FunctionNode, FunctionType, generateCacheKey, GeneratorFunctionBody, getTmpId, getUseCustomBinaryOperator, GLOBAL, HashSign, HexDigit, HexEscapeSequence, HexInteger, Identifier, IdentifierNameConst, IdentifierNameConstOrNumberLiteral, IdentifierOrAccess, IdentifierOrAccessPart, IdentifierOrAccessStart, IdentifierOrSimpleAccess, IdentifierOrSimpleAccessPart, IdentifierOrSimpleAccessStart, IdentifierParameter, IdentNode, IfNode, inAst, InBlock, IndentedUnclosedArrayLiteral, IndentedUnclosedArrayLiteralInner, IndentedUnclosedObjectLiteral, IndentedUnclosedObjectLiteralInner, INDENTS, Index, IndexMultiple, IndexSlice, inExpression, InfinityLiteral, inFunctionTypeParams, inIndexSlice, inMacro, inspect, inStatement, InvocationArguments, InvocationOrAccess, KeyValuePair, KvpParameter, Letter, Line, Literal, Logic, LowerR, LowerU, LowerX, Macro, MacroAccessNode, MacroBody, MacroError, MacroHelper, MacroHolder, MacroName, MacroNames, MacroOptions, MacroSyntax, MacroSyntaxChoiceParameters, MacroSyntaxParameter, MacroSyntaxParameters, MacroSyntaxParameterType, MacroToken, MaybeAdvance, MaybeAsType, MaybeComma, MaybeCommaOrNewline, MaybeComment, MaybeExclamationPointNoSpace, MaybeExistentialSymbol, MaybeExistentialSymbolNoSpace, MaybeMutableToken, MaybeNotToken, MaybeSpreadToken, Minus, MultiLineComment, MutableToken, Name, NameChar, NamePart, NamePartWithNumbers, NameStart, NaNLiteral, Newline, NewlineWithCheckIndent, Node, NonUnionType, NoSpace, NotColon, Nothing, NOTHING, NothingNode, notInFunctionTypeParams, NotToken, NullLiteral, NumberChar, NumberLiteral, ObjectKey, ObjectKeyColon, ObjectLiteral, ObjectNode, ObjectParameter, OctalDigit, OctalInteger, OpenCurlyBrace, OpenParenthesis, OpenParenthesisChar, OpenSquareBracket, OpenSquareBracketChar, ParamDualObjectKey, Parameter, Parameters, ParameterSequence, ParamNode, ParamSingularObjectKey, Parenthetical, ParserError, PercentSign, PercentSignDoubleQuote, PercentSignTripleDoubleQuote, Period, Pipe, PipeChar, Plus, PlusOrMinus, PopIndent, preventUnclosedObjectLiteral, PrimaryExpression, PushFakeIndent, PushIndent, RadixInteger, RawDecimalDigits, RegexComment, RegexDoubleToken, RegexFlags, RegexLiteral, RegexpNode, RegexSingleToken, RegexTripleDoubleToken, RegexTripleSingleToken, RESERVED_IDENTS, ReturnNode, Root, RootNode, Scope, Semicolon, SemicolonChar, Shebang, SHORT_CIRCUIT, SimpleAssignable, SimpleConstantLiteral, SimpleType, SingleEscapeCharacter, SingleLineComment, SingleQuote, SingleStringLiteral, SingularObjectKey, SomeEmptyLines, SomeEmptyLinesWithCheckIndent, SomeSpace, Space, SpaceChar, SpaceNewline, SpreadNode, SpreadOrExpression, SpreadToken, Stack, State, Statement, Stop, StringIndent, StringInterpolation, StringLiteral, SuperInvocation, SuperNode, SuperToken, SwitchNode, Symbol, SymbolChar, SyntaxChoiceNode, SyntaxManyNode, SyntaxParamNode, SyntaxSequenceNode, SyntaxToken, ThisLiteral, ThisNode, ThisOrShorthandLiteral, ThisOrShorthandLiteralPeriod, ThisShorthandLiteral, ThrowNode, TmpNode, TmpWrapperNode, TripleDoubleQuote, TripleDoubleStringArrayLiteral, TripleDoubleStringLine, TripleDoubleStringLiteral, TripleSingleQuote, TripleSingleStringLine, TripleSingleStringLiteral, TrueLiteral, TryCatchNode, TryFinallyNode, Type, TypeArrayNode, TypeFunctionNode, TypeReference, TypeUnionNode, UnaryNode, UnclosedArguments, UnclosedArrayLiteralElement, UnclosedObjectLiteral, Underscore, UnicodeEscapeSequence, UseMacro, VarNode, VoidLiteral, YieldNode, Zero;
  ...
  function sequential(array, mutator, dontCache) {
    var _arr, _len, i, item, key, mapping, name, rule, ruleName, rules, shouldWrapName;
    if (!__isArray(array)) {
    ...
    return (function () {
      ...
      _rule = named(name, function (o) {
        var _arr, _len, clone, i, item, key, result, rule;
        clone = o.clone();
        result = {};
        for (_arr = __toArray(rules), i = 0, _len = _arr.length; i < _len; ++i) {
          rule = _arr[i];
          item = rule(clone);
          if (!item) {
            return false;
      ...
      return named(
        (typeof _rule !== "undefined" && _rule !== null ? _rule.parserName : void 0) || "<unknown>",
        function (o) {
  ...
  function ruleEqual(rule, text, mutator) {
    ...
    return (function () {
      ...
      _rule = (function () {
        ...
        return named(
          (typeof _rule2 !== "undefined" && _rule2 !== null ? _rule2.parserName : void 0) || "<unknown>",
          function (o) {
            var index, line, result;
            index = o.index;
            line = o.line;
  ...
  _Name = cache(named("_Name", (function () {
    ...
    _rule = (function () {
      ...
      return named(
        __strnum((typeof _rule2 !== "undefined" && _rule2 !== null ? _rule2.parserName : void 0) || "<unknown>") + "*",
        function (o) {
          var clone, item, result;
          clone = o.clone();
          result = [];
  ...
  _NameOrSymbol = (function () {
    ...
    return (function () {
      var _rule2;
      _rule2 = named(
        __strnum((typeof _rule !== "undefined" && _rule !== null ? _rule.parserName : void 0) || "<unknown>") + "+",
        function (o) {
          var clone, item, result;
          clone = o.clone();
          result = [];
  ...
  DecimalNumber = cache(named("DecimalNumber", (function () {
    ...
    _rule = (function () {
      ...
      _rule4 = (function () {
        ...
        return named(
          (typeof _rule5 !== "undefined" && _rule5 !== null ? _rule5.parserName : void 0) || "<unknown>",
          function (o) {
            var index, line, result;
            index = o.index;
            line = o.line;
      ...
      return named(
        __strnum((typeof _rule4 !== "undefined" && _rule4 !== null ? _rule4.parserName : void 0) || "<unknown>") + "?",
        function (o) {
          var clone, index, line, result;
          index = o.index;
          line = o.line;
    ...
    _rule2 = (function () {
      ...
      _rule4 = (function () {
        ...
        return (function () {
          ...
          return named(
            (typeof _rule6 !== "undefined" && _rule6 !== null ? _rule6.parserName : void 0) || "<unknown>",
            function (o) {
              var index, line, result;
              index = o.index;
              line = o.line;
    ...
    return (function () {
      ...
      return named(
        (typeof _rule4 !== "undefined" && _rule4 !== null ? _rule4.parserName : void 0) || "<unknown>",
        function (o) {
          var index, line, result;
          index = o.index;
          line = o.line;
  ...
  function makeRadixInteger(radix, separator, digit) {
    ...
    digits = (function () {
      ...
      _rule2 = (function () {
        ...
        return named(
          __strnum((typeof _rule3 !== "undefined" && _rule3 !== null ? _rule3.parserName : void 0) || "<unknown>") + "*",
          function (o) {
            var clone, item, result;
            clone = o.clone();
            result = [];
      ...
      return (function () {
        ...
        return named(
          (typeof _rule3 !== "undefined" && _rule3 !== null ? _rule3.parserName : void 0) || "<unknown>",
          function (o) {
            var index, line, result;
            index = o.index;
            line = o.line;
  ...
  HexEscapeSequence = cache(named("HexEscapeSequence", (function () {
    ...
    return named(
      (typeof _backend !== "undefined" && _backend !== null ? _backend.parserName : void 0) || "<unknown>",
      function (o) {
        var result;
        if (!LowerX(o.clone())) {
          return false;
        ...
        _rule2 = (function () {
          ...
          _rule3 = (function () {
            ...
            _rule4 = (function () {
              ...
              return named(
                "!" + __strnum((typeof _rule5 !== "undefined" && _rule5 !== null ? _rule5.parserName : void 0) || "<unknown>"),
                function (o) {
  ...
  DoubleStringLiteralInner = cache(named("DoubleStringLiteralInner", (function () {
    var _rule;
    _rule = (function () {
      var _rule2;
      _rule2 = (function () {
  ...
  DoubleStringArrayLiteral = cache(named("DoubleStringArrayLiteral", (function () {
    var _backend;
    _backend = (function () {
      function _rule(o) {
        var clone, result;
  ...
  function tripleStringHandler(x, o, i) {
    var _arr, _end, _len, j, len, line, lines, part, stringParts;
    lines = [x.first];
    ...
    stringParts = [];
    for (_arr = __toArray(lines), j = 0, _len = _arr.length; j < _len; ++j) {
      line = _arr[j];
      if (__num(j) > 0) {
        stringParts.push("\n");
      }
    ...
    for (_arr = __toArray(stringParts), j = 0, _len = _arr.length; j < _len; ++j) {
      part = _arr[j];
            ...
            _rule4 = (function () {
              ...
              _rule6 = (function () {
                ...
                _rule7 = (function () {
                  ...
                  return named(
                    __strnum((typeof _rule8 !== "undefined" && _rule8 !== null ? _rule8.parserName : void 0) || "<unknown>") + "*",
                    function (o) {
                      var clone, item, result;
                      clone = o.clone();
                      result = [];
                ...
                return (function () {
                  ...
                  return named(
                    (typeof _rule8 !== "undefined" && _rule8 !== null ? _rule8.parserName : void 0) || "<unknown>",
                    function (o) {
                      var index, line, result;
                      index = o.index;
                      line = o.line;
              ...
              return named(
                __strnum((typeof _rule6 !== "undefined" && _rule6 !== null ? _rule6.parserName : void 0) || "<unknown>") + "?",
                function (o) {
                  var clone, index, line, result;
                  index = o.index;
                  line = o.line;
  ...
  TripleDoubleStringArrayLiteral = cache(named("TripleDoubleStringArrayLiteral", (function () {
    var _backend;
    _backend = (function () {
      var _rule, _rule2;
      _rule = (function () {
        ...
        _rule5 = (function () {
          ...
          _rule6 = (function () {
            ...
            _rule7 = (function () {
              ...
              return named(
                (typeof _rule11 !== "undefined" && _rule11 !== null ? _rule11.parserName : void 0) || "<unknown>",
                function (o) {
                  var index, line, result;
                  index = o.index;
                  line = o.line;
        ...
        _rule5 = (function () {
          ...
          _rule6 = (function () {
            ...
            _rule7 = (function () {
              ...
              return named(
                (typeof _rule10 !== "undefined" && _rule10 !== null ? _rule10.parserName : void 0) || "<unknown>",
                function (o) {
                  var index, line, result;
                  index = o.index;
                  line = o.line;
            ...
            _rule9 = (function () {
              ...
              _rule10 = (function () {
                ...
                return named(
                  "!" + __strnum((typeof _rule11 !== "undefined" && _rule11 !== null ? _rule11.parserName : void 0) || "<unknown>"),
                  function (o) {
        ...
        _rule5 = (function () {
          ...
          _rule6 = (function () {
            ...
            _rule7 = (function () {
              ...
              return named(
                (typeof _rule9 !== "undefined" && _rule9 !== null ? _rule9.parserName : void 0) || "<unknown>",
                function (o) {
                  var index, line, result;
                  index = o.index;
                  line = o.line;
            ...
            _rule8 = (function () {
              ...
              _rule9 = (function () {
                ...
                return named(
                  "!" + __strnum((typeof _rule10 !== "undefined" && _rule10 !== null ? _rule10.parserName : void 0) || "<unknown>"),
                  function (o) {
  ...
  StringLiteral = cache(named("StringLiteral", (function () {
    function _rule(o) {
      return BackslashStringLiteral(o) || TripleSingleStringLiteral(o) || TripleDoubleStringLiteral(o) || TripleDoubleStringArrayLiteral(o) || SingleStringLiteral(o) || DoubleStringLiteral(o) || DoubleStringArrayLiteral(o) || RegexLiteral(o);
    }
    return function (o) {
      var clone, result;
      clone = o.clone();
  ...
  CustomOperatorCloseParenthesis = cache(named("CustomOperatorCloseParenthesis", (function () {
    ...
    return function (o) {
      var _arr, _arr2, _i, _i2, _len, _len2, _ref, clone, i, inverted, left, line, op, operator, operators, result, right;
      i = o.index;
      line = o.line;
      for (_arr = __toArray(o.macros.binaryOperators), _i = 0, _len = _arr.length; _i < _len; ++_i) {
        operators = _arr[_i];
        if (operators) {
          for (_arr2 = __toArray(operators), _i2 = 0, _len2 = _arr2.length; _i2 < _len2; ++_i2) {
            operator = _arr2[_i2];
            clone = o.clone(o.cloneScope());
            inverted = false;
      ...
      for (_arr = __toArray(o.macros.prefixUnaryOperators), _i = 0, _len = _arr.length; _i < _len; ++_i) {
        operator = _arr[_i];
        if ((_ref = handleUnaryOperator(operator, o, i, line)) != null) {
          return _ref;
        }
      }
      for (_arr = __toArray(o.macros.postfixUnaryOperators), _i = 0, _len = _arr.length; _i < _len; ++_i) {
        operator = _arr[_i];
        if ((_ref = handleUnaryOperator(operator, o, i, line)) != null) {
          return _ref;
        }
  ...
  CustomBinaryOperator = cache(named("CustomBinaryOperator", function (o) {
    var _arr, _arr2, _i, _i2, _len, _len2, clone, i, inverted, op, operator, operators;
    i = o.index;
    for (_arr = __toArray(o.macros.binaryOperators), _i = 0, _len = _arr.length; _i < _len; ++_i) {
      operators = _arr[_i];
      if (operators) {
  ...
  ArrayLiteral = cache(named("ArrayLiteral", preventUnclosedObjectLiteral((function () {
    var _rule, _rule2;
    _rule = (function () {
      var _rule3;
      _rule3 = (function () {
        ...
        _rule4 = (function () {
          ...
          _rule5 = (function () {
            ...
            _rule6 = (function () {
              ...
              return named(
                __strnum((typeof _rule7 !== "undefined" && _rule7 !== null ? _rule7.parserName : void 0) || "<unknown>") + "*",
                function (o) {
                  var clone, item, result;
                  clone = o.clone();
                  result = [];
            ...
            return (function () {
              ...
              return named(
                (typeof _rule7 !== "undefined" && _rule7 !== null ? _rule7.parserName : void 0) || "<unknown>",
                function (o) {
                  var index, line, result;
                  index = o.index;
                  line = o.line;
  ...
  ObjectLiteral = cache(named("ObjectLiteral", (function () {
    ...
    _rule = (function () {
      ...
      _rule4 = (function () {
        var _rule5, _rule6;
        _rule5 = preventUnclosedObjectLiteral(function (o) {
          return Logic(o);
        });
        _rule6 = (function () {
          function _rule7(o) {
          ...
          return function (o) {
            return Comma(o) || _rule7(o) || _rule8(o);
          };
        }());
        return function (o) {
          var clone, result;
          clone = o.clone();
          result = void 0;
          if (ExtendsToken(clone) && (result = _rule5(clone)) && Space(clone) && _rule6(clone)) {
            o.update(clone);
            return result;
          } else {
            return false;
  ...
  NonUnionType = cache(named("NonUnionType", (function () {
    ...
    return function (o) {
      return FunctionType(o) || _rule(o) || ArrayType(o) || IdentifierOrSimpleAccess(o) || VoidLiteral(o) || NullLiteral(o);
    };
  }())));
    ...
    return (function () {
      ...
      function _mutator(x, o, i) {
        ...
        if (types.length === 1) {
          ...
          for (j = __num(types.length) - 1; j <= 0; ++j) {
            type = types[j];
            if (type instanceof TypeUnionNode) {
              __splice(types, j, __num(j) + 1, type.types);
            }
          }
          if (types.length === 1) {
            return types[0];
  ...
  function addParamToScope(o, param) {
    var _arr, _i, _len, _ref, element, pair;
    if (param instanceof ParamNode) {
      if ((_ref = param.ident) instanceof IdentNode || _ref instanceof TmpNode) {
        o.scope.add(param.ident, param.isMutable, param.asType || (param.spread ? o.ident(param.startIndex, "Array") : void 0));
        ...
        o.scope.add(
          ...
          param.isMutable,
          param.asType || (param.spread ? o.ident(param.startIndex, "Array") : void 0)
        );
      } else {
        throw Error("Unknown param ident: " + __typeof(param.ident));
      }
  ...
  FunctionDeclaration = cache(named("FunctionDeclaration", (function () {
    ...
    return function (o) {
      var _arr, _i, _len, _ref, asType, autoReturn, body, bound, clone, generator, index, param, params, rest;
      index = o.index;
      clone = o.clone(o.cloneScope());
  ...
  CustomAssignment = cache(named("CustomAssignment", function (o) {
    ...
    if (left) {
      for (_arr = __toArray(o.macros.assignOperators), _i = 0, _len = _arr.length; _i < _len; ++_i) {
        operator = _arr[_i];
        subClone = clone.clone();
        rule = operator.rule;
        op = rule(subClone);
  ...
  IndentedUnclosedObjectLiteralInner = cache(named("IndentedUnclosedObjectLiteralInner", (function () {
    var _rule;
    _rule = (function () {
      function _rule2(o) {
        var clone, result;
        clone = o.clone();
        result = void 0;
        if (CommaOrNewlineWithCheckIndent(clone) && (result = DualObjectKey(clone))) {
          o.update(clone);
          return result;
        } else {
          return false;
    ...
    return (function () {
      function _rule2(o) {
        ...
        clone = o.clone();
        result = {};
        if ((result.head = DualObjectKey(clone)) && (result.tail = _rule(clone))) {
          o.update(clone);
          return result;
        } else {
          return false;
  ...
  IndentedUnclosedObjectLiteral = cache(named("IndentedUnclosedObjectLiteral", (function () {
    function _rule(o) {
  ...
  UnclosedArrayLiteralElement = cache(named("UnclosedArrayLiteralElement", (function () {
    var _rule;
    _rule = (function () {
      var _rule2;
      _rule2 = (function () {
  ...
  IndentedUnclosedArrayLiteralInner = cache(named("IndentedUnclosedArrayLiteralInner", (function () {
    var _rule;
    _rule = (function () {
      function _rule2(o) {
        var clone, result;
  ...
  IndentedUnclosedArrayLiteral = cache(named("IndentedUnclosedArrayLiteral", (function () {
    function _rule(o) {
      return !_preventUnclosedObjectLiteral.peek();
    }
    return function (o) {
  ...
  UnclosedArguments = cache(named("UnclosedArguments", (function () {
    var _rule2, _rule3;
    function _rule(o) {
      return SomeSpace(o) || CheckStop(o);
    }
    _rule2 = (function () {
      var _rule4;
      _rule4 = (function () {
  ...
  BasicInvocationOrAccess = cache(named("BasicInvocationOrAccess", (function () {
        ...
        _rule5 = (function () {
          ...
          return (function () {
            function _rule10(o) {
              ...
              clone = o.clone();
              result = {};
              if ((result.existential = MaybeExistentialSymbolNoSpace(clone)) && (result.owns = MaybeExclamationPointNoSpace(clone)) && (result.bind = _rule8(clone)) && EmptyLines(clone) && Space(clone) && (result.type = _rule9(clone)) && (result.child = IdentifierNameConstOrNumberLiteral(clone))) {
                o.update(clone);
                return result;
              } else {
                return false;
        ...
        _rule6 = (function () {
          ...
          return (function () {
            function _rule10(o) {
              ...
              clone = o.clone();
              result = {};
              if ((result.existential = MaybeExistentialSymbolNoSpace(clone)) && (result.owns = MaybeExclamationPointNoSpace(clone)) && (result.bind = _rule8(clone)) && (result.type = _rule9(clone)) && OpenSquareBracketChar(clone) && (result.child = Index(clone)) && CloseSquareBracket(clone)) {
                o.update(clone);
                return result;
              } else {
                return false;
    ...
    return (function () {
      ...
      _mutator = (function () {
        ...
        linkTypes = {
          access: (function () {
            ...
            return function (o, i, head, link, j, links) {
              var bindAccess, child, existentialOp, makeAccess, result, setChild, setHead, test, tmp, tmpIds;
              bindAccess = link.bind
        ...
        return function (x, o, i) {
          var _arr, _i, _len, clone, head, isNew, links, part, tail;
    ...
    return function (precedence) {
      ...
      if ((_ref = precedenceCache[precedence]) == null) {
        return precedenceCache[precedence] = cache(function (o) {
          var _arr, _arr2, _i, _i2, _len, _len2, binaryOperators, clone, current, head, inverted, j, line, nextRule, node, op, operator, operators, part, rule, startIndex, tail;
          startIndex = o.index;
          line = o.line;
          ...
          if (__lt(binaryOperators.length, precedence)) {
            ...
            if (!head) {
              ...
              if (operators) {
                for (_arr = __toArray(operators), _i = 0, _len = _arr.length; _i < _len; ++_i) {
                  operator = _arr[_i];
                  rule = operator.rule;
                  tail = [];
                  for (; ; ) {
                  ...
                  if (tail.length) {
                    if (!operator.rightToLeft) {
                      current = head;
                      for (_arr2 = __toArray(tail), _i2 = 0, _len2 = _arr2.length; _i2 < _len2; ++_i2) {
                        part = _arr2[_i2];
    ...
    _rule3 = (function () {
      ...
      return (function () {
        function _rule5(o) {
          ...
          clone = o.clone();
          result = {};
          if ((result.head = Line(clone)) && (result.tail = _rule4(clone))) {
            o.update(clone);
            return result;
          } else {
            return false;
        ...
        function _mutator(x, o, i) {
          ...
          nodes = [];
          for (_arr = [x.head].concat(__toArray(x.tail)), _i = 0, _len = _arr.length; _i < _len; ++_i) {
            item = _arr[_i];
  ...
  ParserError = (function (Error) {
    ...
    function ParserError(message, text, index, line) {
      ...
      err = Error.call(_this, __strnum(message) + " at line #" + __strnum(line));
  ...
  MacroError = (function (Error) {
    ...
    function MacroError(inner, text, index, line) {
      ...
      if (!(inner instanceof Error)) {
        throw TypeError("Expected inner to be a Error, got " + __typeof(inner));
      }
      if (typeof text !== "string") {
        throw TypeError("Expected text to be a String, got " + __typeof(text));
      }
      ...
      err = Error.call(_this, (innerType === "Error" ? "" : __strnum(innerType) + ": ") + String(inner != null ? inner.message : void 0) + " at line #" + __strnum(line));
      _this.message = err.message;
  ...
  MacroHelper = (function () {
    ...
    _MacroHelper_prototype["let"] = function (ident, isMutable) {
      ...
      return this.state.scope.add(ident, isMutable);
    };
    ...
    _MacroHelper_prototype["var"] = function (ident, isMutable, asType) {
    ...
    _MacroHelper_prototype.block = function (nodes) {
      var _i, _len;
      if (!__isArray(nodes)) {
    ...
    _MacroHelper_prototype["if"] = function (test, whenTrue, whenFalse) {
      if (test == null) {
      ...
      return this.state["if"](this.index, this.doWrap(test), whenTrue, whenFalse).reduce(this.state);
    };
    _MacroHelper_prototype["switch"] = function (node, cases, defaultCase) {
      var _this;
      _this = this;
      if (node == null) {
      ...
      return this.state["switch"](
        ...
        (function () {
          ...
          for (_arr = [], _arr2 = __toArray(cases), _i = 0, _len = _arr2.length; _i < _len; ++_i) {
            case_ = _arr2[_i];
    ...
    _MacroHelper_prototype["for"] = function (init, test, step, body) {
      if (init == null) {
        init = null;
    ...
    _MacroHelper_prototype.forIn = function (key, object, body) {
      ...
      return this.state.forIn(this.index, key, this.doWrap(object), body).reduce(this.state);
    };
    _MacroHelper_prototype.tryCatch = function (tryBody, catchIdent, catchBody) {
      if (tryBody == null) {
    ...
    _MacroHelper_prototype.tryFinally = function (tryBody, finallyBody) {
      if (tryBody == null) {
        tryBody = NothingNode(0, 0, this.state.scope.id);
      } else if (!(tryBody instanceof Node)) {
        throw TypeError("Expected tryBody to be a Node, got " + __typeof(tryBody));
    ...
    _MacroHelper_prototype["break"] = function () {
      return this.state["break"](this.index);
    };
    _MacroHelper_prototype["continue"] = function () {
    ...
    _MacroHelper_prototype.object = function (pairs) {
      ...
      return this.state.object(0, (function () {
        var _arr, _arr2, _i, _len, _ref, key, value;
        for (_arr = [], _arr2 = __toArray(pairs), _i = 0, _len = _arr2.length; _i < _len; ++_i) {
          key = (_ref = _arr2[_i]).key;
          value = _ref.value;
          _arr.push({ key: _this.doWrap(key), value: _this.doWrap(value) });
        }
        return _arr;
      }())).reduce(this.state);
    };
      ...
      Block: function (x, func) {
        ...
        if (len !== 0) {
          ...
          if (lastNode !== nodes[__num(len) - 1]) {
            return BlockNode(x.startIndex, x.endIndex, x.scopeId, __slice(nodes, void 0, __num(len) - 1).concat([lastNode]));
          }
        }
        return x;
      },
    ...
    _MacroHelper_prototype.mutateLast = function (node, func) {
      var _ref;
      if (!node || typeof node !== "object" || node instanceof RegExp) {
        return node;
      }
  ...
  function oneOf(rules) {
    ...
    return named(name.join(""), function (o) {
      var _arr, _i, _len, result, rule;
      for (_arr = __toArray(rules), _i = 0, _len = _arr.length; _i < _len; ++_i) {
        rule = _arr[_i];
        result = rule(o);
        if (result) {
          return result;
  ...
  AnyObjectLiteral = cache(named("AnyObjectLiteral", function (o) {
    return UnclosedObjectLiteral(o) || ObjectLiteral(o) || IndentedUnclosedObjectLiteral(o);
  }));
  AnyArrayLiteral = cache(named("AnyArrayLiteral", function (o) {
  ...
  MacroHolder = (function () {
    ...
    _MacroHolder_prototype.getOrAddByNames = function (names) {
      ...
      return (function () {
        ...
        for (_arr = [], _arr2 = __toArray(names), _i = 0, _len = _arr2.length; _i < _len; ++_i) {
          name = _arr2[_i];
    ...
    _MacroHolder_prototype.addBinaryOperator = function (operators, m, options, macroId) {
      var _arr, _i, _len, _ref, _ref2, _this, binaryOperators, data, op, precedence;
      _this = this;
      for (_arr = __toArray(operators), _i = 0, _len = _arr.length; _i < _len; ++_i) {
        op = _arr[_i];
    ...
    _MacroHolder_prototype.getByLabel = function (label) {
      var _ref;
      if (__owns(_ref = this.byLabel, label)) {
        return _ref[label];
      }
    };
    ...
    _MacroHolder_prototype.addAssignOperator = function (operators, m, options, macroId) {
      var _arr, _i, _len, _ref, _this, data, op;
      _this = this;
      for (_arr = __toArray(operators), _i = 0, _len = _arr.length; _i < _len; ++_i) {
        op = _arr[_i];
        this.operatorNames[op] = true;
    ...
    _MacroHolder_prototype.addUnaryOperator = function (operators, m, options, macroId) {
      var _arr, _i, _len, _ref, _this, data, op, store;
      _this = this;
      for (_arr = __toArray(operators), _i = 0, _len = _arr.length; _i < _len; ++_i) {
        op = _arr[_i];
        this.operatorNames[op] = true;
      }
      store = options.postfix ? this.postfixUnaryOperators : this.prefixUnaryOperators;
      data = {
        rule: oneOf((function () {
    ...
    _MacroHolder_prototype.addSerializedHelper = function (name, helper, dependencies) {
      var _ref, _ref2, helpers;
      if (typeof name !== "string") {
        throw TypeError("Expected name to be a String, got " + __typeof(name));
      }
      helpers = (_ref = (_ref2 = this.serialization).helpers) != null ? _ref : (_ref2.helpers = {});
      helpers[name] = { helper: helper, dependencies: dependencies };
    };
    ...
    _MacroHolder_prototype.deserialize = function (data) {
      var _obj, _ref, ast, dependencies, helper, name, translator;
      ...
      for (name in _obj) {
        if (__owns(_obj, name)) {
          ...
          translator.defineHelper(name, ast.fromJSON(helper), dependencies);
        }
      }
  ...
  Scope = (function () {
    ...
    _Scope_prototype.add = function (ident, isMutable) {
      if (!(ident instanceof IdentNode) && !(ident instanceof TmpNode)) {
        throw TypeError("Expected ident to be a IdentNode or TmpNode, got " + __typeof(ident));
      }
      if (isMutable == null) {
      ...
      if (ident instanceof TmpNode) {
        this.tmps[ident.id] = { ident: ident, isMutable: isMutable };
      } else {
        this.variables[ident.name] = isMutable;
      }
    };
    _Scope_prototype.owns = function (ident) {
      ...
      if (ident instanceof TmpNode) {
        return __owns(this.tmps, ident.id);
      } else {
        return __owns(this.variables, ident.name);
      }
    };
  ...
  State = (function () {
    ...
    _State_prototype.getScope = function (id) {
      ...
      return this.knownScopes[id] || (function () {
        throw Error("Unknown scope: " + __strnum(id));
      }());
    };
    ...
    _State_prototype.defineHelper = function (i, name, value) {
      var _ref, dependencies, helper, translator;
      ...
      translator = require("./translator");
      helper = (_ref = translator.defineHelper(name, this.macroExpandAll(value).reduce(this))).helper;
      dependencies = _ref.dependencies;
      if (this.options.serializeMacros) {
        this.macros.addSerializedHelper(name.name, helper, dependencies);
      }
    ...
    function serializeParams(params) {
      ...
      return (function () {
        ...
        for (_arr = [], _arr2 = __toArray(params), _i = 0, _len = _arr2.length, _f = function (_i) {
    ...
    function deserializeParams(params, scopeId) {
      ...
      return (function () {
        ...
        for (_arr = [], _arr2 = __toArray(params), _i = 0, _len = _arr2.length, _f = function (_i) {
          ...
          param = _arr2[_i];
          if (param.type === "const") {
            return ConstNode(0, 0, scopeId, param.value);
          } else {
            node = param.type === "ident" ? IdentNode(0, 0, scopeId, param.name)
              : param.type === "this" ? ThisNode(0, 0, scopeId)
              : (function () {
    ...
    function handleParams(params) {
      var _arr, _f, _i, _len, sequence;
      sequence = [];
      for (_arr = __toArray(params), _i = 0, _len = _arr.length, _f = function (_i) {
        ...
        if (param.isConst()) {
          ...
          type = (_ref = param.asType) != null ? _ref : IdentNode(0, 0, -1, "Expression");
    ...
    _State_prototype.startMacroSyntax = function (index, params, options) {
      ...
      for (_arr = __toArray(macros.getOrAddByNames(this.currentMacro)), _i = 0, _len = _arr.length, _f = function (_i) {
        var m;
        m = _arr[_i];
    ...
    function handleMacroSyntax(index, type, handler, rule, params, options, macroId) {
      ...
      return macroId = (function () {
        ...
        default:
          assert(rule);
          for (_arr = __toArray(macros.getOrAddByNames(_this.currentMacro)), _i = 0, _len = _arr.length, _f = function (_i) {
            var _this, m;
            _this = this;
            m = _arr[_i];
    ...
    _State_prototype.deserializeMacros = function (data) {
      ...
      for (type in macroDeserializers) {
        if (__owns(macroDeserializers, type)) {
          ...
          for (_arr = __toArray((_ref = __owns(data, type) ? data[type] : void 0) != null ? _ref : []), _i = 0, _len = _arr.length; _i < _len; ++_i) {
            item = _arr[_i];
    ...
    _State_prototype.macroExpandAll = function (node) {
      var _this;
      _this = this;
  ...
  Node.Access = AccessNode = (function (Node) {
    ...
    _AccessNode_prototype.inspect = function (depth) {
      return "AccessNode(" + inspect(this.parent, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.child, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return AccessNode;
  }(Node));
  Node.AccessIndex = AccessIndexNode = (function (Node) {
    var _AccessIndexNode_prototype, _Node_prototype;
    function AccessIndexNode(startIndex, endIndex, scopeId, parent, child) {
      var _this;
      if (typeof startIndex !== "number") {
        throw TypeError("Expected startIndex to be a Number, got " + __typeof(startIndex));
      }
      ...
      _this = this instanceof AccessIndexNode ? this : __create(_AccessIndexNode_prototype);
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
      _this._reduced = void 0;
    ...
    _Node_prototype = Node.prototype;
    _AccessIndexNode_prototype = AccessIndexNode.prototype = __create(_Node_prototype);
    _AccessIndexNode_prototype.constructor = AccessIndexNode;
    ...
    _AccessIndexNode_prototype.walk = (function () {
      var indexTypes;
      indexTypes = {
        multi: function (x, f) {
          var elements;
    ...
    _AccessIndexNode_prototype.inspect = function (depth) {
      return "AccessIndexNode(" + inspect(this.parent, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.child, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return AccessIndexNode;
  }(Node));
  Node.Args = ArgsNode = (function (Node) {
    ...
    _ArgsNode_prototype.walk = retThis;
  ...
  Node.Array = ArrayNode = (function (Node) {
    ...
    _ArrayNode_prototype.inspect = function (depth) {
      return "ArrayNode(" + inspect(this.elements, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return ArrayNode;
  }(Node));
  ...
  Node.Assign = AssignNode = (function (Node) {
    ...
    _AssignNode_prototype.inspect = function (depth) {
      return "AssignNode(" + inspect(this.left, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.op, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.right, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return AssignNode;
  }(Node));
  Node.Binary = BinaryNode = (function (Node) {
    ...
    _BinaryNode_prototype.inspect = function (depth) {
      return "BinaryNode(" + inspect(this.left, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.op, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.right, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return BinaryNode;
  }(Node));
  Node.Block = BlockNode = (function (Node) {
    var _BlockNode_prototype, _Node_prototype;
    function BlockNode(startIndex, endIndex, scopeId, nodes) {
      var _i, _len, _this;
      if (typeof startIndex !== "number") {
        throw TypeError("Expected startIndex to be a Number, got " + __typeof(startIndex));
      }
    ...
    _BlockNode_prototype._reduce = function (o) {
      ...
      default:
        if (changed) {
          return BlockNode(this.startIndex, this.endIndex, this.scopeId, body);
        } else {
          return this;
        }
      }
    ...
    _BlockNode_prototype.isStatement = function () {
      ...
      return (function () {
        ...
        for (_arr = __toArray(_this.nodes), _i = 0, _len = _arr.length; _i < _len; ++_i) {
          node = _arr[_i];
          if (node.isStatement()) {
            return true;
          }
    ...
    _BlockNode_prototype.walk = function (f) {
      ...
      if (nodes !== this.nodes) {
        return BlockNode(this.startIndex, this.endIndex, this.scopeId, nodes);
      } else {
        return this;
      }
    };
    _BlockNode_prototype.inspect = function (depth) {
      return "BlockNode(" + inspect(this.nodes, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return BlockNode;
  }(Node));
  Node.Break = BreakNode = (function (Node) {
    var _BreakNode_prototype, _Node_prototype;
    function BreakNode(startIndex, endIndex, scopeId) {
      var _this;
      if (typeof startIndex !== "number") {
        throw TypeError("Expected startIndex to be a Number, got " + __typeof(startIndex));
      }
    ...
    _BreakNode_prototype.walk = retThis;
  ...
  Node.Call = CallNode = (function (Node) {
            ...
            if (!funcType.isSubsetOf(Type["function"])) {
              if (func instanceof IdentNode) {
                ...
                if (child instanceof ConstNode) {
                  ...
                  } else if (parent instanceof IdentNode && (_ref = __owns(PRIMORDIAL_SUBFUNCTIONS, _ref2 = parent.name) && __owns(_ref3 = PRIMORDIAL_SUBFUNCTIONS[_ref2], _ref4 = child.value) ? _ref3[_ref4] : void 0) != null) {
                    return _ref;
                  }
                }
              }
    ...
    _CallNode_prototype.inspect = function (depth) {
      return "CallNode(" + inspect(this.func, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.args, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.isNew, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.isApply, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return CallNode;
  }(Node));
  Node.Const = ConstNode = (function (Node) {
    ...
    _ConstNode_prototype.inspect = function (depth) {
      return "ConstNode(" + inspect(this.value, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return ConstNode;
  }(Node));
  Node.Continue = ContinueNode = (function (Node) {
    var _ContinueNode_prototype, _Node_prototype;
    function ContinueNode(startIndex, endIndex, scopeId) {
      var _this;
      if (typeof startIndex !== "number") {
        throw TypeError("Expected startIndex to be a Number, got " + __typeof(startIndex));
      }
    ...
    _ContinueNode_prototype.walk = retThis;
  ...
  Node.Debugger = DebuggerNode = (function (Node) {
    ...
    _DebuggerNode_prototype.walk = retThis;
  ...
  Node.Def = DefNode = (function (Node) {
    ...
    _DefNode_prototype.walk = function (func) {
      var left, right;
      left = func(this.left);
    ...
    _DefNode_prototype.inspect = function (depth) {
      return "DefNode(" + inspect(this.left, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.right, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return DefNode;
  }(Node));
  Node.Eval = EvalNode = (function (Node) {
    ...
    _EvalNode_prototype.inspect = function (depth) {
      return "EvalNode(" + inspect(this.code, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return EvalNode;
  }(Node));
  Node.For = ForNode = (function (Node) {
    var _ForNode_prototype, _Node_prototype;
    function ForNode(startIndex, endIndex, scopeId, init, test, step, body) {
      var _this;
      if (typeof startIndex !== "number") {
        throw TypeError("Expected startIndex to be a Number, got " + __typeof(startIndex));
      }
    ...
    _ForNode_prototype.inspect = function (depth) {
      return "ForNode(" + inspect(this.init, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.test, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.step, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.body, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return ForNode;
  }(Node));
  Node.ForIn = ForInNode = (function (Node) {
    var _ForInNode_prototype, _Node_prototype;
    function ForInNode(startIndex, endIndex, scopeId, key, object, body) {
      var _this;
      if (typeof startIndex !== "number") {
        throw TypeError("Expected startIndex to be a Number, got " + __typeof(startIndex));
      }
    ...
    _ForInNode_prototype.inspect = function (depth) {
      return "ForInNode(" + inspect(this.key, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.object, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.body, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return ForInNode;
  }(Node));
  Node.Function = FunctionNode = (function (Node) {
    ...
    _FunctionNode_prototype.type = function (o) {
      return this.body.type(o)["function"]();
    };
    _FunctionNode_prototype.walk = function (func) {
    ...
    _FunctionNode_prototype.inspect = function (depth) {
      return "FunctionNode(" + inspect(this.params, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.body, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.autoReturn, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.bound, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.asType, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.generator, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return FunctionNode;
  }(Node));
  Node.Ident = IdentNode = (function (Node) {
    ...
    _IdentNode_prototype.inspect = function (depth) {
      return "IdentNode(" + inspect(this.name, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return IdentNode;
  }(Node));
  Node.If = IfNode = (function (Node) {
    var _IfNode_prototype, _Node_prototype;
    function IfNode(startIndex, endIndex, scopeId, test, whenTrue, whenFalse) {
      var _this;
      if (typeof startIndex !== "number") {
        throw TypeError("Expected startIndex to be a Number, got " + __typeof(startIndex));
      }
    ...
    _IfNode_prototype.inspect = function (depth) {
      return "IfNode(" + inspect(this.test, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.whenTrue, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.whenFalse, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return IfNode;
  }(Node));
  Node.MacroAccess = MacroAccessNode = (function (Node) {
    ...
    _MacroAccessNode_prototype.inspect = function (depth) {
      return "MacroAccessNode(" + inspect(this.id, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.line, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.data, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.position, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.inGenerator, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return MacroAccessNode;
  }(Node));
  Node.Nothing = NothingNode = (function (Node) {
    ...
    _NothingNode_prototype.walk = retThis;
  ...
  Node.Object = ObjectNode = (function (Node) {
    ...
    _ObjectNode_prototype.type = function () {
      return Type.object;
    };
    ...
    _ObjectNode_prototype.inspect = function (depth) {
      return "ObjectNode(" + inspect(this.pairs, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.prototype, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return ObjectNode;
  }(Node));
  State.prototype.object = function (i, pairs, prototype) {
    var _arr, _i, _len, key, keyValue, knownKeys;
    knownKeys = [];
  ...
  Node.Param = ParamNode = (function (Node) {
    ...
    _ParamNode_prototype.walk = function (func) {
    ...
    _ParamNode_prototype.inspect = function (depth) {
      return "ParamNode(" + inspect(this.ident, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.defaultValue, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.spread, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.isMutable, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.asType, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return ParamNode;
  }(Node));
  Node.Regexp = RegexpNode = (function (Node) {
    ...
    _RegexpNode_prototype.inspect = function (depth) {
      return "RegexpNode(" + inspect(this.text, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.flags, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return RegexpNode;
  }(Node));
  Node.Return = ReturnNode = (function (Node) {
    ...
    _ReturnNode_prototype.inspect = function (depth) {
      return "ReturnNode(" + inspect(this.node, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return ReturnNode;
  }(Node));
  Node.Root = RootNode = (function (Node) {
    ...
    _RootNode_prototype.inspect = function (depth) {
      return "RootNode(" + inspect(this.body, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return RootNode;
  }(Node));
  Node.Spread = SpreadNode = (function (Node) {
    ...
    _SpreadNode_prototype.inspect = function (depth) {
      return "SpreadNode(" + inspect(this.node, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return SpreadNode;
  }(Node));
  State.prototype.string = function (index, parts) {
    ...
    if (parts.length === 0) {
      ...
      current = parts[0];
      for (_arr = __slice(parts, 1, void 0), _i = 0, _len = _arr.length; _i < _len; ++_i) {
        part = _arr[_i];
  ...
  Node.Super = SuperNode = (function (Node) {
    ...
    _SuperNode_prototype.walk = function (func) {
      var args, child;
    ...
    _SuperNode_prototype._reduce = function (o) {
      var args, child;
      child = this.child != null ? this.child.reduce(o).doWrap(o) : this.child;
      args = map(
        this.args,
        function (node, o) {
          return node.reduce(o).doWrap(o);
    ...
    _SuperNode_prototype.inspect = function (depth) {
      return "SuperNode(" + inspect(this.child, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.args, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return SuperNode;
  }(Node));
  Node.Switch = SwitchNode = (function (Node) {
    var _Node_prototype, _SwitchNode_prototype;
    function SwitchNode(startIndex, endIndex, scopeId, node, cases, defaultCase) {
      var _this;
      if (typeof startIndex !== "number") {
        throw TypeError("Expected startIndex to be a Number, got " + __typeof(startIndex));
      }
    ...
    _SwitchNode_prototype.walk = function (func) {
      ...
      defaultCase = this.defaultCase ? func(this.defaultCase) : this.defaultCase;
    ...
    _SwitchNode_prototype.inspect = function (depth) {
      return "SwitchNode(" + inspect(this.node, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.cases, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.defaultCase, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return SwitchNode;
  }(Node));
  Node.SyntaxChoice = SyntaxChoiceNode = (function (Node) {
    ...
    _SyntaxChoiceNode_prototype.inspect = function (depth) {
      return "SyntaxChoiceNode(" + inspect(this.choices, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
  ...
  Node.SyntaxMany = SyntaxManyNode = (function (Node) {
    ...
    _SyntaxManyNode_prototype.inspect = function (depth) {
      return "SyntaxManyNode(" + inspect(this.inner, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.multiplier, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return SyntaxManyNode;
  }(Node));
  Node.SyntaxParam = SyntaxParamNode = (function (Node) {
    ...
    _SyntaxParamNode_prototype.walk = function (func) {
      var asType, ident;
      ident = func(this.ident);
      asType = this.asType != null ? func(this.asType) : this.asType;
    ...
    _SyntaxParamNode_prototype.inspect = function (depth) {
      return "SyntaxParamNode(" + inspect(this.ident, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.asType, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return SyntaxParamNode;
  }(Node));
  Node.SyntaxSequence = SyntaxSequenceNode = (function (Node) {
    ...
    _SyntaxSequenceNode_prototype.inspect = function (depth) {
      return "SyntaxSequenceNode(" + inspect(this.params, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
  ...
  Node.This = ThisNode = (function (Node) {
    ...
    _ThisNode_prototype.walk = retThis;
  ...
  Node.Throw = ThrowNode = (function (Node) {
    ...
    _ThrowNode_prototype.inspect = function (depth) {
      return "ThrowNode(" + inspect(this.node, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return ThrowNode;
  }(Node));
  Node.Tmp = TmpNode = (function (Node) {
    ...
    _TmpNode_prototype.inspect = function (depth) {
      return "TmpNode(" + inspect(this.id, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.name, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this._type, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return TmpNode;
  }(Node));
  Node.TmpWrapper = TmpWrapperNode = (function (Node) {
    ...
    _TmpWrapperNode_prototype.inspect = function (depth) {
      return "TmpWrapperNode(" + inspect(this.node, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.tmps, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return TmpWrapperNode;
  }(Node));
  Node.TryCatch = TryCatchNode = (function (Node) {
    var _Node_prototype, _TryCatchNode_prototype;
    function TryCatchNode(startIndex, endIndex, scopeId, tryBody, catchIdent, catchBody) {
      var _this;
      if (typeof startIndex !== "number") {
        throw TypeError("Expected startIndex to be a Number, got " + __typeof(startIndex));
      }
    ...
    _TryCatchNode_prototype.inspect = function (depth) {
      return "TryCatchNode(" + inspect(this.tryBody, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.catchIdent, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.catchBody, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return TryCatchNode;
  }(Node));
  Node.TryFinally = TryFinallyNode = (function (Node) {
    var _Node_prototype, _TryFinallyNode_prototype;
    function TryFinallyNode(startIndex, endIndex, scopeId, tryBody, finallyBody) {
      var _this;
      if (typeof startIndex !== "number") {
        throw TypeError("Expected startIndex to be a Number, got " + __typeof(startIndex));
      }
    ...
    _TryFinallyNode_prototype.inspect = function (depth) {
      return "TryFinallyNode(" + inspect(this.tryBody, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.finallyBody, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return TryFinallyNode;
  }(Node));
  Node.TypeArray = TypeArrayNode = (function (Node) {
    ...
    _TypeArrayNode_prototype.inspect = function (depth) {
      return "TypeArrayNode(" + inspect(this.subtype, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
  ...
  Node.TypeFunction = TypeFunctionNode = (function (Node) {
    ...
    _TypeFunctionNode_prototype.inspect = function (depth) {
      return "TypeFunctionNode(" + inspect(this.returnType, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
  ...
  Node.TypeUnion = TypeUnionNode = (function (Node) {
    ...
    _TypeUnionNode_prototype.inspect = function (depth) {
      return "TypeUnionNode(" + inspect(this.types, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
  ...
  Node.Unary = UnaryNode = (function (Node) {
    ...
    _UnaryNode_prototype.inspect = function (depth) {
      return "UnaryNode(" + inspect(this.op, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.node, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return UnaryNode;
  }(Node));
  Node.Var = VarNode = (function (Node) {
    var _Node_prototype, _VarNode_prototype;
    function VarNode(startIndex, endIndex, scopeId, ident, isMutable, asType) {
      var _this;
      if (typeof startIndex !== "number") {
        throw TypeError("Expected startIndex to be a Number, got " + __typeof(startIndex));
      }
    ...
    _VarNode_prototype.inspect = function (depth) {
      return "VarNode(" + inspect(this.ident, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.isMutable, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.asType, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return VarNode;
  }(Node));
  Node.Yield = YieldNode = (function (Node) {
    ...
    _YieldNode_prototype.inspect = function (depth) {
      return "YieldNode(" + inspect(this.node, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return YieldNode;
  }(Node));
