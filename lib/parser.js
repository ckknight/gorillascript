(function (GLOBAL) {
  ...
  var __bind, __cmp, __compose, __create, __curry, __defer,
      ...
      InvocationOrAccessParts, KeyValuePair, KvpParameter, LCall, LessThan,
      ...
      RegexLiteral, RegexpNode, requireParameterSequence, RootInnerP, RootNode,
        ...
        case 6:
          ...
          return {
            ...
            value: Box(currentIndex, parser.Block(index, __toArray(nodes).concat([
              LCall(index, parser.scope, LSymbol["return"](index), parser.Ident(index, "write"))
            ])))
          };
        case 7:
          return { done: true, value: void 0 };
  ...
  Parser = (function () {
    ...
    function makeMacroRoot(index, params, body) {
      return this.Root(index, void 0, LCall(index, this.scope, LSymbol["return"](index), this.Function(
        index,
        [
          params,
          this.Param(
