(function () {
  ...
  Node.Block = BlockNode = (function (Node) {
    ...
    _BlockNode_prototype.walkAsync = function (f, callback) {
      ...
      return mapAsync(this.nodes, f, function (_e, nodes) {
        ...
        return callback(null, nodes !== _this.nodes ? BlockNode(_this.startIndex, _this.endIndex, _this.scopeId, nodes) : _this);
      });
    };
        ...
        return f(_this.test, function (_e2, test) {
          ...
          return f(_this.step, function (_e3, step) {
            ...
            return f(_this.body, function (_e4, body) {
              ...
              return callback(null, init !== _this.init || test !== _this.test || step !== _this.step || body !== _this.body
                ? ForNode(
                  _this.startIndex,
                  _this.endIndex,
                  _this.scopeId,
      ...
      return f(this.key, function (_e, key) {
        ...
        return f(_this.object, function (_e2, object) {
          ...
          return f(_this.body, function (_e3, body) {
            ...
            return callback(null, key !== _this.key || object !== _this.object || body !== _this.body
              ? ForInNode(
                _this.startIndex,
                _this.endIndex,
                _this.scopeId,
      ...
      return f(this.test, function (_e, test) {
        ...
        return f(_this.whenTrue, function (_e2, whenTrue) {
          ...
          return f(_this.whenFalse, function (_e3, whenFalse) {
            ...
            return callback(null, test !== _this.test || whenTrue !== _this.whenTrue || whenFalse !== _this.whenFalse
              ? IfNode(
                _this.startIndex,
                _this.endIndex,
                _this.scopeId,
      ...
      function walkPair(pair, func, callback) {
        return func(pair.key, function (_e, key) {
          ...
          return func(pair.value, function (_e2, value) {
            ...
            return callback(null, key !== pair.key || value !== pair.value ? { key: key, value: value } : pair);
          });
        });
      }
      return function (func, callback) {
        ...
        return mapAsync(
          ...
          function (_e2, cases) {
            ...
            function next(defaultCase) {
              return callback(null, node !== _this.node || cases !== _this.cases || defaultCase !== _this.defaultCase
                ? SwitchNode(
                  _this.startIndex,
                  _this.endIndex,
                  _this.scopeId,
      ...
      return f(this.tryBody, function (_e, tryBody) {
        ...
        return f(_this.catchIdent, function (_e2, catchIdent) {
          ...
          return f(_this.catchBody, function (_e3, catchBody) {
            ...
            return callback(null, tryBody !== _this.tryBody || catchIdent !== _this.catchIdent || catchBody !== _this.catchBody
              ? TryCatchNode(
                _this.startIndex,
                _this.endIndex,
                _this.scopeId,
    ...
    _TryFinallyNode_prototype.walkAsync = function (f, callback) {
      ...
      return f(this.tryBody, function (_e, tryBody) {
        ...
        return f(_this.finallyBody, function (_e2, finallyBody) {
          ...
          return callback(null, tryBody !== _this.tryBody || finallyBody !== _this.finallyBody
            ? TryFinallyNode(
              _this.startIndex,
              _this.endIndex,
              _this.scopeId,
  ...
  function parse(text, macros, options, callback) {
    var _ref, err, index, lastToken, line, messages, o, result;
    if (typeof text !== "string") {
      throw TypeError("Expected text to be a String, got " + __typeof(text));
    }
    if (macros == null) {
    ...
    if (!result || __lt(o.index, o.data.length)) {
      ...
      return o.macroExpandAllAsync(result, function (_e, result) {
        if (_e != null) {
          return callback(_e);
        }
        return callback(null, { result: result.reduce(o), macros: o.macros });
      });
    } else {
