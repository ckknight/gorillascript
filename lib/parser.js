(function (GLOBAL) {
  ...
  FunctionDeclaration = named("FunctionDeclaration", (function () {
    ...
    return function (o) {
      var _arr, _i, asType, body, clone, flags, index, param, params, rest;
      index = o.index;
      clone = o.clone(o.cloneScope());
    ...
    _rule = (function () {
      ...
      return (function () {
        function _rule6(o) {
          ...
          clone = o.clone();
          _result = {};
          return (_result.existential = MaybeExistentialSymbolNoSpace(clone)) && (_result.owns = MaybeExclamationPointNoSpace(clone)) && (_result.bind = _rule4(clone)) && EmptyLines(clone) && Space(clone) && (_result.type = _rule5(clone)) && (_result.child = IdentifierNameConstOrNumberLiteral(clone)) && (o.update(clone), _result);
        }
        function _mutator(x) {
          return {
    ...
    _rule2 = (function () {
      ...
      return (function () {
        function _rule6(o) {
          ...
          clone = o.clone();
          _result = {};
          return (_result.existential = MaybeExistentialSymbolNoSpace(clone)) && (_result.owns = MaybeExclamationPointNoSpace(clone)) && (_result.bind = _rule4(clone)) && (_result.type = _rule5(clone)) && OpenSquareBracketChar(clone) && (_result.child = Index(clone)) && CloseSquareBracket(clone) && (o.update(clone), _result);
        }
        function _mutator(x, o, i) {
          if (x.child.type === "single") {
            return {
  ...
  BasicInvocationOrAccess = named("BasicInvocationOrAccess", (function () {
    ...
    return (function () {
      function _rule4(o) {
        ...
        clone = o.clone();
        _result = {};
        return (_result.isNew = _rule(clone)) && (_result.head = _rule2(clone)) && (_result.tail = _rule3(clone)) && (o.update(clone), _result);
      }
  ...
  nodeToType = (function () {
    ...
    return function (node) {
      ...
      if (node instanceof IdentNode) {
        ...
        if (node.basetype instanceof IdentNode && node.basetype === "Array") {
          return nodeToType(node.args[0]).array();
        } else if (node.basetype instanceof IdentNode && node.basetype === "Function") {
          return nodeToType(node.args[0])["function"]();
        } else {
          return nodeToType(node.basetype);
        }
  ...
  MacroHelper = (function () {
    ...
    _MacroHelper_prototype.ident = function (name) {
      ...
      if (require("./jsast").isAcceptableIdent(name, true)) {
    ...
    _MacroHelper_prototype.func = function (params, body, autoReturn, bound, curry) {
      var _this, clone;
      _this = this;
      if (autoReturn == null) {
        autoReturn = true;
    ...
    _MacroHelper_prototype.isTypeGeneric = function (node) {
      return this.macroExpand1(node) instanceof TypeGenericNode;
    };
  ...
  MacroHolder = (function () {
    ...
    _MacroHolder_prototype.addMacro = function (m, macroId, type) {
      ...
      if (type == null) {
        ...
        throw TypeError("Expected type to be a Type or String or undefined, got " + __typeof(type));
      }
      byId = this.byId;
      if (macroId != null) {
      ...
      function mutator(x, o, i, line, scopeId) {
        ...
        if (_inAst.peek() || !o.expandingMacros) {
          ...
          if (type === "assignOperator" && macroHelper.isIdent(x.left)) {
            ...
            } else if (!macroHelper.isVariableMutable(x.left)) {
  ...
  Node.Function = FunctionNode = (function (Node) {
    ...
    function FunctionNode(line, column, scopeId, params, body, autoReturn, bound, curry, asType, generator) {
      var _i, _len, _this;
  ...
  Node.TypeGeneric = TypeGenericNode = (function (Node) {
    ...
    function TypeGenericNode(line, column, scopeId, basetype, args) {
      ...
      if (!(basetype instanceof Node)) {
        throw TypeError("Expected basetype to be a Node, got " + __typeof(basetype));
      }
      if (!__isArray(args)) {
        throw TypeError("Expected args to be an Array, got " + __typeof(args));
      } else {
