(function () {
  ...
  CustomOperatorCloseParenthesis = cache(named("CustomOperatorCloseParenthesis", (function () {
    ...
    return function (o) {
      var _arr, _arr2, _i, _i2, _len, _len2, _ref, clone, i, inverted, left, line, op, operator, operators, right;
      i = o.index;
      line = o.line;
  ...
  FunctionDeclaration = cache(named("FunctionDeclaration", (function () {
    ...
    _rule2 = inFunctionTypeParams(MaybeAsType);
    _rule3 = (function () {
      var _rule6;
      _rule6 = named('"!"', function (o) {
    ...
    return (function () {
      function _rule6(o) {
        ...
        clone = o.clone();
        result = {};
        if ((result.params = _rule(clone)) && (result.asType = _rule2(clone)) && (result.autoReturn = _rule3(clone)) && (result.bound = _rule4(clone)) && (result.generatorBody = _rule5(clone))) {
          o.update(clone);
          return result;
        } else {
          return false;
  ...
  MacroHelper = (function () {
      ...
      if (!obj || typeof obj !== "object" || obj instanceof RegExp) {
        ...
        return CallNode(
          ...
          [
            ...
            IdentNode(obj.startIndex, obj.endIndex, obj.scopeId, "__scopeId")
    ...
    _MacroHelper_prototype.wrap = function (value, scopeId) {
      var _ref;
      if (__isArray(value)) {
        return BlockNode(0, 0, scopeId, value).reduce(this.state);
      } else if (value instanceof Node) {
        return value;
      } else if (value == null) {
        return NothingNode(0, 0, scopeId);
    ...
    _MacroHelper_prototype.node = function (type, startIndex, endIndex, scopeId) {
      var args;
      args = __slice(arguments, 4);
      return Node[type].apply(Node, [startIndex, endIndex, scopeId].concat(__toArray(args))).reduce(this.state);
    };
      ...
      if (oldScopeId === newScopeId) {
        ...
        return this.walk(function (node) {
          ...
          if (node.scopeId === oldScopeId) {
            ...
            if (((_ref = nodeScope.parent) != null ? _ref.id : void 0) === oldScopeId) {
  ...
  Scope = (function () {
    ...
    _Scope_prototype.has = function (ident) {
      ...
      return this.owns(ident) || this.parent != null && this.parent.has(ident);
    };
    return Scope;
  }());
  State = (function () {
    ...
    function handleMacroSyntax(index, type, handler, rule, params, options, macroId) {
      ...
      macros = this.macros;
      function mutator(x, o, i, line) {
        var macroHelper, result, tmps, walker;
        if (_inAst.peek() || !o.expandingMacros) {
          return o.macroAccess(
            i,
            macroId,
  ...
  Node.TypeFunction = TypeFunctionNode = (function (Node) {
    ...
    _TypeFunctionNode_prototype.inspect = function (depth) {
      return "TypeFunctionNode(" + inspect(this.returnType, null, depth != null ? depth - 1 : null) + ")";
    };
  ...
  Node.Var = VarNode = (function (Node) {
    ...
    _VarNode_prototype.inspect = function (depth) {
      return "VarNode(" + inspect(this.ident, null, depth != null ? depth - 1 : null) + ", " + inspect(this.isMutable, null, depth != null ? depth - 1 : null) + ", " + inspect(this.asType, null, depth != null ? depth - 1 : null) + ")";
    };
    return VarNode;
  }(Node));
