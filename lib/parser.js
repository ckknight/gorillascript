(function () {
  ...
  FunctionType = cache(named("FunctionType", (function () {
    ...
    _rule3 = symbol("->");
    _rule4 = named(
      __strnum((TypeReference != null ? TypeReference.parserName : void 0) || "TypeReference") + "?",
      function (o) {
        var clone, index, line, result;
        index = o.index;
        line = o.line;
        ...
        linkTypes = {
          access: (function () {
            ...
            return function (o, i, head, link, j, links) {
              var bindAccess, child, makeAccess, result, setChild, setHead, test, tmp, tmpIds;
  ...
  MacroHolder = (function () {
    ...
    _MacroHolder_prototype.getBinaryOperatorByName = function (op) {
      var _ref;
    ...
    _MacroHolder_prototype.addAssignOperator = function (operators, m, options, macroId) {
      var _arr, _i, _len, _ref, _this, op;
      _this = this;
      for (_arr = __toArray(operators), _i = 0, _len = _arr.length; _i < _len; ++_i) {
        op = _arr[_i];
        this.operatorNames[op] = true;
