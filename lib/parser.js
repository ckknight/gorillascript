(function () {
  ...
  nodeToType = (function () {
    ...
    return function (node) {
      var _arr, _i, _len, _ref, current, type;
  ...
  Scope = (function () {
    ...
    _Scope_prototype.add = function (ident, isMutable, type) {
      ...
      if (ident instanceof TmpNode) {
        this.tmps[ident.id] = { ident: ident, isMutable: isMutable, type: type };
      } else {
      ...
      if ((_ref = this._type) == null) {
        return this._type = (function () {
          ...
          if (_this.asType != null) {
            ...
            returnType = _this.autoReturn ? _this.body.type(o) : Type["undefined"];
            walker = function (node) {
              var _ref;
    ...
    _SwitchNode_prototype.type = function (o) {
      ...
      if ((_ref = this._type) == null) {
        return this._type = (function () {
          ...
          type = _this.defaultCase != null ? _this.defaultCase.type(o) : Type["undefined"];
