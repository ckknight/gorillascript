(function () {
  ...
  ObjectLiteral = cache(named("ObjectLiteral", preventUnclosedObjectLiteral((function () {
    var _rule, _rule2, _rule3;
    _rule = (function () {
      var _rule4;
      _rule4 = (function () {
  ...
  NonUnionType = cache(named("NonUnionType", (function () {
    function _rule(o) {
      ...
      clone = o.clone();
      result = void 0;
      if (OpenParenthesis(clone) && (result = TypeReference(clone)) && CloseParenthesis(clone)) {
        o.update(clone);
        return result;
      } else {
        return false;
  ...
  _FunctionBody = cache(named("_FunctionBody", (function () {
    ...
    return function (o) {
      return _rule(o) || IndentedUnclosedObjectLiteral(o) || IndentedUnclosedArrayLiteral(o) || Body(o);
    };
  }())));
