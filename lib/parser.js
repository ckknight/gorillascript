...
CustomOperator = cache(named("CustomOperator", function (o) {
  var _arr, _i, _i2, _len, _len2, i, left, op, operator, operators, right, rule;
  i = o.index;
...
Operator = cache(named("Operator", (function () {
  var _rule;
  _rule = (function () {
    var _rule2, _rule3, _rule4, _rule5, _rule6, _rule7, _rule8;
    _rule2 = (function () {
      function _rule3(o) {
        var clone, result;
        clone = o.clone();
    ...
    _rule3 = wordOrSymbol("bitnot");
    _rule4 = wordOrSymbol("~bitnot");
    _rule5 = (function () {
      var _rule6, _rule7;
      _rule6 = word("typeof");
      _rule7 = (function () {
        var _rule8;
        _rule8 = named('"!"', function (o) {
          var c;
          c = o.data.charCodeAt(o.index);
          if (c === 33) {
            o.index = __num(o.index) + 1;
    ...
    _rule6 = (function () {
      ...
      _rule7 = (function () {
        ...
        _rule10 = word("strnum");
        return function (o) {
          return _rule8(o) || _rule9(o) || _rule10(o);
        };
      }());
      _rule8 = named('"!"', function (o) {
        var c;
      ...
      return (function () {
        function _rule9(o) {
          ...
          clone = o.clone();
          result = void 0;
          if ((result = _rule7(clone)) && _rule8(clone)) {
            o.update(clone);
            return result;
          } else {
            return false;
    ...
    _rule8 = (function () {
      ...
      return (function () {
        function _rule10(o) {
          ...
          clone = o.clone();
          result = void 0;
          if (_rule9(clone) && (result = MaybeExistentialSymbolNoSpace(clone))) {
            o.update(clone);
            return result;
          } else {
            return false;
    ...
    return (function () {
      function _rule9(o) {
        return _rule2(o) || _rule3(o) || _rule4(o) || _rule5(o) || _rule6(o) || _rule7(o) || _rule8(o);
      }
      function _mutator(x, o, i) {
  ...
  return function (o) {
    return CustomOperator(o) || _rule(o);
  };
}())));
...
DefineOperator = cache(named("DefineOperator", (function () {
  ...
  _backend = inMacro((function () {
    ...
    _rule = (function () {
      ...
      _rule2 = wordOrSymbol("binary");
      _rule3 = wordOrSymbol("assign");
      _rule4 = wordOrSymbol("unary");
      return function (o) {
...
Unary = cache(named("Unary", (function () {
  ...
  return (function () {
    function _rule2(o) {
      ...
      clone = o.clone();
      result = {};
      if ((result.op = _rule(clone)) && (result.node = CustomPrefixUnary(clone))) {
        o.update(clone);
        return result;
      } else {
        return false;
...
MacroHelper = (function () {
  ...
  MacroHelper.prototype.isComplex = function (node) {
    return typeof node !== "undefined" && node !== null && !(node instanceof ConstNode) && !(node instanceof IdentNode) && !(node instanceof TmpNode) && !(node instanceof ThisNode) && !(node instanceof ArgsNode) && (!(node instanceof BlockNode) || node.nodes.length !== 0);
  };
  ...
  AssignNode.prototype.type = (function () {
    ...
    return function () {
      ...
      if (!type) {
        ...
        return type(this.left, this.right);
      } else {
        return type;
      }
    };
...
OperatorNode = Node.Operator = (function () {
  ...
  OperatorNode.prototype.type = function () {
    return types["function"];
  };
