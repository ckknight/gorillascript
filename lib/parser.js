(function () {
  ...
  function parse(text, macros, options, callback) {
    ...
    function next(result) {
      var _ref, err, index, lastToken, line, messages;
