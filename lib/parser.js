(function () {
  ...
  PropertyDualObjectKey = cache(named("PropertyDualObjectKey", (function () {
    var _backend;
    _backend = (function () {
      function _rule(o) {
        var clone, result;
  ...
  PropertyOrDualObjectKey = cache(named("PropertyOrDualObjectKey", function (o) {
