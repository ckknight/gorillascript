(function () {
  ...
  _FunctionBody = cache(named("_FunctionBody", (function () {
    ...
    return function (o) {
      return _rule(o) || IndentedUnclosedObjectLiteral(o) || Body(o);
    };
  }())));
  ...
  PrimaryExpression = cache(named("PrimaryExpression", function (o) {
    return UnclosedObjectLiteral(o) || Literal(o) || ArrayLiteral(o) || ObjectLiteral(o) || Ast(o) || Parenthetical(o) || FunctionLiteral(o) || UseMacro(o) || Identifier(o) || IndentedUnclosedObjectLiteral(o);
  }));
  ...
  IndentedUnclosedObjectLiteral = cache(named("IndentedUnclosedObjectLiteral", (function () {
    ...
    return (function () {
      function _rule3(o) {
        ...
        clone = o.clone();
        result = {};
        if (_rule(clone) && Space(clone) && Newline(clone) && EmptyLines(clone) && Advance(clone) && CheckIndent(clone) && (result.head = DualObjectKey(clone)) && (result.tail = _rule2(clone)) && PopIndent(clone)) {
          o.update(clone);
          return result;
        } else {
          return false;
