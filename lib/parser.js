...
break;
  ...
  State = (function () {
    ...
    _proto.macroSyntax = function (index, type, params, body, options) {
      var _this, data, handler, macroId, macros, rule;
      _this = this;
      if (options == null) {
        options = {};
      }
