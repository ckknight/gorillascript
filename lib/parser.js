(function () {
  ...
  CustomOperator = cache(named("CustomOperator", (function () {
    ...
    return function (o) {
      var _arr, _i, _i2, _len, _len2, _ref, i, left, op, operator, operators, right;
      i = o.index;
  ...
  CustomBinaryOperator = cache(named("CustomBinaryOperator", function (o) {
    var _arr, _i, _i2, _len, _len2, i, op, operator, operators;
    i = o.index;
    for (_arr = o.macros.binaryOperators, _i = 0, _len = __num(_arr.length); _i < _len; ++_i) {
      operators = _arr[_i];
      if (operators) {
        for (_i2 = 0, _len2 = __num(operators.length); _i2 < _len2; ++_i2) {
          ...
          op = operator.rule(o);
          if (op) {
            return { op: op, operator: operator, inverted: false };
          }
        }
      }
    }
  ...
  Parenthetical = cache(named("Parenthetical", (function () {
    ...
    _rule = (function () {
      ...
      function _rule6(o) {
        ...
        clone = o.clone();
        result = void 0;
        if ((result = CustomOperator(clone)) && CloseParenthesis(clone)) {
          o.update(clone);
          return result;
        } else {
          return false;
      ...
      return function (o) {
        return _rule2(o) || _rule3(o) || _rule4(o) || _rule5(o) || _rule6(o);
      };
    }());
    return (function () {
      function _rule2(o) {
  ...
  State = (function () {
    ...
    macroDeserializers = {
      syntax: function (_p) {
        var _this, code, handler, id, names, params;
        _this = this;
        code = _p.code;
        params = _p.params;
        names = _p.names;
      ...
      call: function (_p) {
        var _this, code, handler, id, names;
        _this = this;
        code = _p.code;
        names = _p.names;
        id = _p.id;
    ...
    _proto.startMacroSyntax = function (index, params) {
      var _arr, _f, _i, _len, macroId, macros, rule;
      if (!__isArray(params)) {
  ...
  Node.Object = ObjectNode = (function (_super) {
    ...
    _proto._reduce = (function () {
      ...
      return function () {
        var pairs, prototype;
        pairs = map(this.pairs, reducePair);
        prototype = this.prototype != null ? this.prototype.reduce() : this.prototype;
        if (pairs !== this.pairs || prototype !== this.prototype) {
          return ObjectNode(this.startIndex, this.endIndex, pairs, prototype);
        } else {
          return this;
