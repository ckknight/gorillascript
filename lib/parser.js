(function () {
  ...
  MacroHelper = (function () {
    ...
    _proto.def = function (key, value) {
      ...
      return this.state.def(this.index, key, value);
    };
  ...
  State = (function () {
    ...
    function serializeParams(params) {
      return (function () {
        var _arr, _i, _len, ident, param, value;
    ...
    function deserializeParams(params) {
      return (function () {
        var _arr, _i, _len, node, param;
        for (_arr = [], _i = 0, _len = __num(params.length); _i < _len; ++_i) {
          param = params[_i];
          if (param.type === "const") {
            _arr.push(ConstNode(0, 0, param.value));
          } else {
            ...
            _arr.push(SyntaxParamNode(0, 0, node, deserializeParamType(param.asType)));
          }
        }
        return _arr;
      }());
    ...
    function handleParams(params) {
      var _i, _len, _ref, _this, ident, key, param, sequence, string, type;
      _this = this;
      sequence = [];
      for (_i = 0, _len = __num(params.length); _i < _len; ++_i) {
        param = params[_i];
