(function (GLOBAL) {
  ...
  var __bind, __cmp, __compose, __create, __curry, __defer,
      ...
      ExpressionOrAssignment, ExpressionOrAssignmentOrBody, ForNode,
      ...
      LessThanChar, Letter, LicenseComment, Line, LInternalCall, LispyNode,
      Literal, Logic, LSymbol, LValue, MacroAccessNode, MacroBody,
