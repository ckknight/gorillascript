(function () {
  ...
  ParserError = (function (Error) {
    ...
    function ParserError(message, text, index, line) {
      ...
      err = Error.call(_this, message + " at line #" + __strnum(line));
  ...
  MacroError = (function (Error) {
    ...
    function MacroError(inner, text, index, line) {
      ...
      err = Error.call(_this, (innerType === "Error" ? "" : innerType + ": ") + String(inner != null ? inner.message : void 0) + " at line #" + __strnum(line));
      _this.message = err.message;
