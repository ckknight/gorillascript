    ...
    _BinaryNode_prototype._reduce = (function () {
      ...
      return function (o) {
        ...
        if (left.isConst()) {
          ...
          if (__owns(leftConstOps, op) && (_ref = leftConstOps[op].call(this, left, right, o)) != null) {
            return _ref;
          }
        }
        if (right.isConst() && __owns(rightConstOps, op) && (_ref = rightConstOps[op].call(this, left, right, o)) != null) {
          return _ref;
        }
        if (__owns(nonConstOps, op) && (_ref = nonConstOps[op].call(this, left, right, o)) != null) {
          return _ref;
        }
        if (left !== this.left || right !== this.right) {
          return BinaryNode(
          ...
          return this._type = (function () {
            ...
            if (funcType.isSubsetOf(Type["function"])) {
              ...
              if (child instanceof ConstNode) {
                ...
                } else if (parent instanceof IdentNode && __owns(PRIMORDIAL_SUBFUNCTIONS, _ref = parent.name) && __owns(_ref2 = PRIMORDIAL_SUBFUNCTIONS[_ref], _ref3 = child.value) && (_ref4 = _ref2[_ref3]) != null) {
                  return _ref4;
                }
              }
            }
