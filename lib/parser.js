        ...
        if (!__lt(args.length, f.length)) {
          ...
          ret = function () {
            if (arguments.length === 0) {
              ...
              return currier(args.concat(__slice.call(arguments)));
            }
          };
          return ret;
        }
