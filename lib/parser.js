(function () {
  ...
  ExpressionOrAssignment = cache(named("ExpressionOrAssignment", (function () {
    var _rule;
    _rule = inExpression(function (o) {
      return Assignment(o);
    });
    return function (o) {
      return _rule(o) || Expression(o);
    };
  }())));
  ...
  MacroName = cache(named("MacroName", (function () {
    ...
    _rule = (function () {
      ...
      return function (o) {
        ...
        clone = o.clone();
        result = void 0;
        if ((result = _rule2(clone)) && NotColon(clone)) {
          o.update(clone);
          return result;
        } else {
          return false;
    ...
    _rule = (function () {
      ...
      _backend = (function () {
        function _rule2(o) {
          ...
          o.startMacroSyntax(i, params);
          body = FunctionBody(o);
          if (!body) {
            throw SHORT_CIRCUIT;
          }
          o.macroSyntax(i, "syntax", params, body);
          return true;
        }
        return function (o) {
          var clone, result;
  ...
  Yield = cache(named("Yield", (function () {
    ...
    _backend = (function () {
      ...
      return (function () {
        ...
        function _mutator(x, o, i) {
          return o["yield"](i, x.node.doWrap(), x.multiple !== NOTHING);
        }
        return named(
          (_rule3 != null ? _rule3.parserName : void 0) || "<unknown>",
          function (o) {
  ...
  Statement = cache(named("Statement", (function () {
    ...
    _rule = inStatement(function (o) {
      return Yield(o) || Break(o) || Continue(o) || Macro(o) || DefineHelper(o) || DefineOperator(o) || DefineSyntax(o) || Assignment(o) || ExpressionAsStatement(o);
    });
    return function (o) {
      var clone, result;
      clone = o.clone();
  ...
  MacroHelper = (function () {
    var _proto, mutators;
    function MacroHelper(state, index, position) {
      var _this;
    ...
    _proto["if"] = function (test, whenTrue, whenFalse) {
      ...
      return this.state["if"](this.index, doWrap(test), whenTrue, whenFalse).reduce();
    };
    ...
    _proto.forIn = function (key, object, body) {
      ...
      return this.state.forIn(this.index, key, doWrap(object), body).reduce();
    };
    ...
    _proto.assign = function (left, op, right) {
      ...
      return this.state.assign(this.index, left, op, doWrap(right)).reduce();
    };
    _proto.binary = function (left, op, right) {
      ...
      return this.state.binary(this.index, doWrap(left), op, doWrap(right)).reduce();
    };
    _proto.unary = function (op, node) {
      ...
      return this.state.unary(this.index, op, doWrap(node)).reduce();
    };
    _proto["throw"] = function (node) {
      if (!(node instanceof Node)) {
        throw TypeError("Expected node to be a Node, got " + __typeof(node));
      }
      return this.state["throw"](this.index, doWrap(node)).reduce();
    };
    _proto["return"] = function (node) {
      ...
      return this.state["return"](this.index, doWrap(node)).reduce();
    };
    _proto["yield"] = function (node) {
      if (!(node instanceof Node)) {
        throw TypeError("Expected node to be a Node, got " + __typeof(node));
      }
      return this.state["yield"](this.index, doWrap(node)).reduce();
    };
    ...
    _proto.isTmp = function (node) {
      return node instanceof TmpNode;
    };
  ...
  MacroHolder = (function () {
    ...
    _proto.addMacro = function (m, macroId) {
      var byId;
      byId = this.byId;
      if (macroId != null) {
    ...
    _proto.replaceMacro = function (id, m) {
      var byId;
      byId = this.byId;
      byId[id] = m;
    };
    ...
    _proto.addBinaryOperator = function (operators, m, options, macroId) {
      ...
      return this.addMacro(m, macroId);
    };
  ...
  State = (function () {
    ...
    _proto.defineHelper = function (i, name, value) {
      ...
      translator = require("./translator");
      helper = translator.defineHelper(name, value);
    ...
    macroSyntaxTypes = {
      syntax: function (index, params, body, options, stateOptions) {
        var _this, compilation, funcParams, handler, rawFunc, serialization, translated;
        _this = this;
        funcParams = (function () {
      ...
      defineSyntax: function (index, params, body, options, stateOptions) {
        var _this, funcParams, handler, serialization;
        _this = this;
        funcParams = (function () {
          var _arr, _i, _len, param;
          for (_arr = [], _i = 0, _len = __num(params.length); _i < _len; ++_i) {
      ...
      call: function (index, params, body, options, stateOptions) {
        var _this, compilation, handler, rawFunc, serialization, translated;
        _this = this;
        rawFunc = makeMacroRoot.call(
          this,
          index,
        ...
        return {
          ...
          serialization: serialization != null ? { type: "call", code: serialization, options: options, name: this.currentMacro } : void 0
        };
      },
    ...
    macroDeserializers = {
      syntax: function (_p) {
        var _this, code, handler, id, name, params;
        _this = this;
        code = _p.code;
        params = _p.params;
        name = _p.name;
      ...
      call: function (_p) {
        var _this, code, handler, id, name;
        _this = this;
        code = _p.code;
        name = _p.name;
        id = _p.id;
        ...
        if (code != null) {
          ...
          handler = (function (inner) {
            return function (args) {
              var rest;
              rest = __slice(arguments, 1);
              return reduceObject(inner.apply(this, [reduceObject(args)].concat(__toArray(rest))));
            };
          }(handler));
        } else {
          handler = function (args) {
    ...
    _proto.startMacroSyntax = function (index, params) {
      var _this, m, macroId, macros, rule;
      _this = this;
      if (!__isArray(params)) {
      ...
      function mutator(x, o, i) {
        if (_inAst.peek()) {
          return o.macroAccess(i, macroId, x, _position.peek());
        } else {
    ...
    function handleMacroSyntax(index, type, handler, rule, params, options, macroId) {
      ...
      function mutator(x, o, i) {
        ...
        if (_inAst.peek()) {
          ...
          macroHelper = MacroHelper(o, i, _position.peek());
          result = handler.call(
            macroHelper,
            x,
            MacroHelper.wrap,
            MacroHelper.node,
            function (id, data, position) {
      ...
      return macroId = (function () {
        ...
        case DEFINE_SYNTAX:
          assert(rule);
          _this.macros.addSyntax(options.name, named(
          ...
          return macros.addMacro(mutator, macroId);
        default:
          ...
          if (_this.pendingMacroId != null) {
            ...
            m.data.pop();
            m.data.push(fullRule);
            macros.replaceMacro(id, mutator);
            return id;
          } else {
            m.data.push(fullRule);
            return macros.addMacro(mutator, macroId);
  ...
  Node.Assign = AssignNode = (function (_super) {
    ...
    _proto._reduce = function () {
      ...
      right = this.right.reduce().doWrap();
        ...
        if ((_ref = this._type) == null) {
          return this._type = (function () {
            ...
            if (func instanceof IdentNode) {
              ...
              parent = func.parent;
              child = func.child;
              if (child instanceof ConstNode && parent instanceof IdentNode && (_ref = __owns(PRIMORDIAL_SUBFUNCTIONS, _ref2 = parent.name) && __owns(_ref3 = PRIMORDIAL_SUBFUNCTIONS[_ref2], _ref4 = child.value) ? _ref3[_ref4] : void 0) != null) {
                return _ref;
              }
            }
            return Type.any;
  ...
  Node.MacroAccess = MacroAccessNode = (function (_super) {
    var _proto, _superproto;
    function MacroAccessNode(startIndex, endIndex, id, data, position) {
      var _this;
      if (typeof id !== "number") {
    ...
    MacroAccessNode.argNames = ["id", "data", "position"];
    State.addNodeFactory("macroAccess", MacroAccessNode);
    _proto.walk = function (f) {
      return this;
    };
    _proto.inspect = function (depth) {
      return "MacroAccessNode(" + inspect(this.id, null, depth != null ? depth - 1 : null) + ", " + inspect(this.data, null, depth != null ? depth - 1 : null) + ", " + inspect(this.position, null, depth != null ? depth - 1 : null) + ")";
    };
