(function () {
    ...
    _backend = inMacro((function () {
      ...
      return function (o) {
        ...
        ret = (function () {
          switch (x.type) {
          case "binary":
            return clone.defineBinaryOperator(i, ops, x.options, body);
          case "assign":
            return clone.defineAssignOperator(i, ops, x.options, body);
          case "unary":
            return clone.defineUnaryOperator(i, ops, x.options, body);
          default:
            throw Error();
          }
        }());
  ...
  State = (function () {
    ...
    function serializeParams(params) {
      ...
      for (_arr = [], _arr2 = __toArray(params), _i = 0, _len = _arr2.length, _f = function (param) {
        var ident, value;
        if (param.isConst()) {
        ...
        _arr.push(_f.call(this, _arr2[_i]));
      }
      return _arr;
    }
    ...
    function handleParams(params) {
      ...
      sequence = [];
      for (_arr = __toArray(params), _i = 0, _len = _arr.length, _f = function (param) {
        var _ref, _this, ident, key, string, type;
        _this = this;
        if (param.isConst()) {
          string = param.constValue();
          if (typeof string !== "string") {
