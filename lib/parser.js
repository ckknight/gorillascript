  ...
  function _BlockMutator(lines, parser, index) {
    ...
    for (_arr = __toArray(lines), i = 0, _len = _arr.length; i < _len; ++i) {
      ...
      for (_arr2 = __toArray(item), j = 0, _len2 = _arr2.length; j < _len2; ++j) {
        ...
        if (part.isValue) {
          nodes.push(part);
        } else if (part.isInternalCall("block")) {
  ...
  Parser = (function () {
    ...
    function serializeParams(params) {
      return simplifyArray((function () {
        var _arr, _i, _len, _ref, asType, ident, param, value;
    ...
    function handleParams(params) {
      ...
      return sequential.apply(void 0, (function () {
        var _arr, _i, _len, _ref, asType, ident, param, string;
        for (_arr = [], _i = 0, _len = params.length; _i < _len; ++_i) {
          param = params[_i];
          if (param.isConstType("string")) {
            string = param.constValue();
            _arr.push(__owns.call(macroSyntaxConstLiterals, string) && macroSyntaxConstLiterals[string] || wordOrSymbol(string));
          } else if (param.isInternalCall("syntaxParam")) {
            _ref = param.args;
            ident = _ref[0];
            asType = _ref[1];
            _arr.push([
              ident.name,
              calcParam.call(_this, !isNothing(asType) ? asType : LSymbol.ident(0, param.scope, "Expression"))
            ]);
          } else {
            throw Error("Unhandled value in switch");
          }
