(function () {
  ...
  _Space = named("_Space", (function () {
    var _rule;
    _rule = named(
      __strnum((SpaceChar != null ? SpaceChar.parserName : void 0) || void 0 || "SpaceChar") + "*",
      function (o) {
  ...
  EmptyLines = cache(named("EmptyLines", (function () {
    var _rule;
    _rule = named(
      __strnum((EmptyLine != null ? EmptyLine.parserName : void 0) || void 0 || "EmptyLine") + "*",
      function (o) {
        var clone, item, result;
        clone = o.clone();
        result = [];
  ...
  TripleDoubleQuote = cache(named("TripleDoubleQuote", (function () {
    var _rule;
    _rule = named(
      __strnum((DoubleQuote != null ? DoubleQuote.parserName : void 0) || void 0 || "DoubleQuote") + "{3}",
      function (o) {
        var clone, item, result;
        clone = o.clone();
        result = [];
  ...
  TripleSingleQuote = cache(named("TripleSingleQuote", (function () {
    var _rule;
    _rule = named(
      __strnum((SingleQuote != null ? SingleQuote.parserName : void 0) || void 0 || "SingleQuote") + "{3}",
      function (o) {
        var clone, item, result;
        clone = o.clone();
        result = [];
  ...
  NamePart = named("NamePart", named(
    __strnum((NameChar != null ? NameChar.parserName : void 0) || void 0 || "NameChar") + "+",
    function (o) {
      var clone, item, result;
      clone = o.clone();
      result = [];
  ...
  _Name = cache(named("_Name", (function () {
    return (function () {
      ...
      _rule2 = (function () {
        ...
        return named(
          __strnum((_rule3 != null ? _rule3.parserName : void 0) || void 0 || "<unknown>") + "*",
          function (o) {
            var clone, item, result;
            clone = o.clone();
            result = [];
  ...
  _Symbol = cache(named("_Symbol", (function () {
    var _rule;
    _rule = named(
      __strnum((SymbolChar != null ? SymbolChar.parserName : void 0) || void 0 || "SymbolChar") + "+",
      function (o) {
        var clone, item, result;
        clone = o.clone();
        result = [];
  ...
  _NameOrSymbol = (function () {
    ...
    return (function () {
      var _rule2;
      _rule2 = named(
        __strnum((_rule != null ? _rule.parserName : void 0) || void 0 || "<unknown>") + "+",
        function (o) {
          var clone, item, result;
          clone = o.clone();
          result = [];
  ...
  DecimalNumber = cache(named("DecimalNumber", (function () {
    ...
    RawDecimalDigits = named("RawDecimalDigits", named(
      __strnum((DecimalDigit != null ? DecimalDigit.parserName : void 0) || void 0 || "DecimalDigit") + "+",
      function (o) {
        var clone, item, result;
        clone = o.clone();
        result = [];
    ...
    DecimalDigits = named("DecimalDigits", (function () {
      ...
      _rule = (function () {
        ...
        _rule2 = (function () {
          var _rule3;
          _rule3 = named(
            __strnum((Underscore != null ? Underscore.parserName : void 0) || void 0 || "Underscore") + "+",
            function (o) {
              var clone, item, result;
              clone = o.clone();
              result = [];
        ...
        return named(
          __strnum((_rule2 != null ? _rule2.parserName : void 0) || void 0 || "<unknown>") + "*",
          function (o) {
            var clone, item, result;
            clone = o.clone();
            result = [];
  ...
  function makeRadixNumber(radix, separator, digit) {
    ...
    digits = (function () {
      var _rule, _rule2;
      _rule = named(
        __strnum((digit != null ? digit.parserName : void 0) || void 0 || "digit") + "+",
        function (o) {
          var clone, item, result;
          clone = o.clone();
          result = [];
  ...
  RadixNumber = named("RadixNumber", (function () {
    ...
    Radix = named(
      __strnum((DecimalDigit != null ? DecimalDigit.parserName : void 0) || void 0 || "DecimalDigit") + "{1,2}",
      function (o) {
        var clone, item, result;
        clone = o.clone();
        result = [];
  ...
  HexEscapeSequence = named("HexEscapeSequence", (function () {
    ...
    _backend = (function () {
      var _rule;
      _rule = named(
        __strnum((HexDigit != null ? HexDigit.parserName : void 0) || void 0 || "HexDigit") + "{2}",
        function (o) {
          var clone, item, result;
          clone = o.clone();
          result = [];
  ...
  UnicodeEscapeSequence = named("UnicodeEscapeSequence", (function () {
    ...
    _backend = (function () {
      var _rule;
      _rule = named(
        __strnum((HexDigit != null ? HexDigit.parserName : void 0) || void 0 || "HexDigit") + "{4}",
        function (o) {
          var clone, item, result;
          clone = o.clone();
          result = [];
            ...
            _rule4 = (function () {
              ...
              _rule6 = (function () {
                ...
                _rule7 = (function () {
                  ...
                  return named(
                    __strnum((_rule8 != null ? _rule8.parserName : void 0) || void 0 || "<unknown>") + "*",
                    function (o) {
                      var clone, item, result;
                      clone = o.clone();
                      result = [];
      ...
      _rule2 = (function () {
        ...
        _backend = (function () {
          ...
          _rule6 = (function () {
            ...
            return named(
              __strnum((_rule7 != null ? _rule7.parserName : void 0) || void 0 || "<unknown>") + "*",
              function (o) {
                var clone, item, result;
                clone = o.clone();
                result = [];
  ...
  Parenthetical = named("Parenthetical", (function () {
    ...
    _rule = (function () {
      ...
      _rule5 = (function () {
        var _rule6;
        _rule6 = named(
          __strnum((typeof InvocationOrAccessPart !== "undefined" && InvocationOrAccessPart !== null ? InvocationOrAccessPart.parserName : void 0) || void 0 || "InvocationOrAccessPart") + "+",
          function (o) {
            var clone, item, result;
            clone = o.clone();
            result = [];
    ...
    _rule = (function () {
      ...
      _rule3 = (function () {
        ...
        _rule4 = (function () {
          ...
          return named(
            __strnum((_rule5 != null ? _rule5.parserName : void 0) || void 0 || "<unknown>") + "*",
            function (o) {
              var clone, item, result;
              clone = o.clone();
              result = [];
  ...
  IdentifierOrSimpleAccess = cache(named("IdentifierOrSimpleAccess", (function () {
    var _rule;
    _rule = named(
      __strnum((IdentifierOrSimpleAccessPart != null ? IdentifierOrSimpleAccessPart.parserName : void 0) || void 0 || "IdentifierOrSimpleAccessPart") + "*",
      function (o) {
        var clone, item, result;
        clone = o.clone();
        result = [];
    ...
    _rule2 = (function () {
      ...
      _rule4 = (function () {
        ...
        _rule5 = (function () {
          ...
          return named(
            __strnum((_rule6 != null ? _rule6.parserName : void 0) || void 0 || "<unknown>") + "*",
            function (o) {
              var clone, item, result;
              clone = o.clone();
              result = [];
    ...
    _rule = (function () {
      ...
      _rule2 = (function () {
        ...
        _rule3 = (function () {
          ...
          return named(
            __strnum((_rule4 != null ? _rule4.parserName : void 0) || void 0 || "<unknown>") + "*",
            function (o) {
              var clone, item, result;
              clone = o.clone();
              result = [];
  ...
  IdentifierOrAccess = cache(named("IdentifierOrAccess", (function () {
    var _rule;
    _rule = named(
      __strnum((IdentifierOrAccessPart != null ? IdentifierOrAccessPart.parserName : void 0) || void 0 || "IdentifierOrAccessPart") + "*",
      function (o) {
        var clone, item, result;
        clone = o.clone();
        result = [];
  ...
  BasicInvocationOrAccess = named("BasicInvocationOrAccess", (function () {
    ...
    _rule3 = named(
      __strnum((InvocationOrAccessPart != null ? InvocationOrAccessPart.parserName : void 0) || void 0 || "InvocationOrAccessPart") + "*",
      function (o) {
        var clone, item, result;
        clone = o.clone();
        result = [];
  ...
  State = (function () {
    ...
    function calcParam(param) {
      ...
      if (param instanceof IdentNode) {
        ...
        case "*":
          return named(
            __strnum((calced != null ? calced.parserName : void 0) || void 0 || "calced") + "*",
            function (o) {
              var clone, item, result;
              clone = o.clone();
              result = [];
    ...
    _BlockNode_prototype.withLabel = function (label, o) {
      ...
      if (this.label == null) {
        if (this.nodes.length === 1) {
          ...
          return BlockNode(this.startIndex, this.endIndex, this.scopeId, __slice.call(this.nodes, 0, -1).concat([this.nodes[__num(this.nodes.length) - 1].withLabel(label, o)]));
        }
      }
      return BlockNode(
        this.startIndex,
