(function () {
  ...
  FunctionDeclaration = cache(named("FunctionDeclaration", (function () {
    ...
    return (function () {
      function _rule4(o) {
        ...
        clone = o.clone();
        result = {};
        if ((result.params = _rule(clone)) && (result.asType = MaybeAsType(clone)) && (result.autoReturn = _rule2(clone)) && (result.bound = _rule3(clone)) && (result.body = FunctionBody(clone))) {
          o.update(clone);
          return result;
        } else {
          return false;
  ...
  MacroHelper = (function () {
    ...
    _proto.call = function (func, args, isNew, isApply) {
      ...
      if (func instanceof CallChainNode) {
        return this.state.callChain(func.startIndex, func.head, __toArray(func.links).concat([{ type: "call", args: args, isNew: isNew, isApply: isApply }])).reduce();
      } else {
        return this.state.callChain(func.startIndex, func, [{ type: "call", args: args, isNew: isNew, isApply: isApply }]).reduce();
      }
    };
  ...
  State = (function () {
    ...
    _proto.macroSyntax = function (index, type, params, body, options) {
      var _this, data, handler, macroHelpers, macroId, macros, rule;
      _this = this;
      if (options == null) {
        options = {};
      }
    ...
    _proto._reduce = (function () {
      ...
      return function () {
        ...
        if (left instanceof ConstNode) {
          ...
          if (__owns(leftConstOps, op)) {
            if ((_ref = leftConstOps[op].call(this, left, right)) != null) {
              return _ref;
            }
          }
        }
        if (right instanceof ConstNode && __owns(rightConstOps, op)) {
          if ((_ref = rightConstOps[op].call(this, left, right)) != null) {
            return _ref;
          }
        }
        if (left !== this.left || right !== this.right) {
  ...
  Node.CallChain = CallChainNode = (function (_super) {
    ...
    _proto.type = (function () {
      var helperTypeCache, PRIMORDIAL_FUNCTIONS, PRIMORDIAL_SUBFUNCTIONS;
      ...
      function calculateType(node) {
        ...
        if (last instanceof ast.Func) {
          if ((_ref = (_ref = last.meta) != null ? _ref.asType : void 0) != null) {
            return _ref;
          } else {
            return types.any;
          }
      ...
      return function () {
        ...
        if ((_ref = this._type) != null) {
          ...
          return this._type = (function () {
            var head, helpers, links, name, type;
            head = _this.head;
            links = _this.links;
            if (head instanceof IdentNode) {
              name = head.name;
              if (links.length === 1 && links[0].type === "call" && !links[0].existential) {
                if (name.substring(0, 2) === "__") {
                  ...
                  if (helpers.has(name)) {
                    if (__owns(helperTypeCache, name)) {
                      ...
                      type = calculateType(helpers.get(name));
                      if (type != null) {
                        return helperTypeCache[name] = type;
                      }
                    }
                  }
                } else if (__owns(PRIMORDIAL_FUNCTIONS, name)) {
                  return PRIMORDIAL_FUNCTIONS[head.name];
                }
              } else if (links.length === 2 && links[0].type === "access" && !links[0].existential && links[1].type === "call" && !links[1].existential && links[0].child instanceof ConstNode) {
                if (__owns(PRIMORDIAL_SUBFUNCTIONS, name) && __owns(PRIMORDIAL_SUBFUNCTIONS[name], links[0].child.value)) {
  ...
  Node.Function = FunctionNode = (function (_super) {
    var _proto, _superproto;
    function FunctionNode(startIndex, endIndex, params, body, autoReturn, bound, asType) {
      var _i, _len, _this;
      if (!__isArray(params)) {
        throw TypeError("Expected params to be an Array, got " + __typeof(params));
      } else {
    ...
    _proto._reduce = function () {
      ...
      for (_arr = this.parts, _i = 0, _len = __num(_arr.length); _i < _len; ++_i) {
        ...
        if (reduced instanceof ConstNode) {
          ...
          j = reduced.endIndex;
          segments.push(CallChainNode(
            i,
            j,
            IdentNode(i, j, "__strnum"),
            [{ type: "call", args: [reduced] }]
          ));
        } else {
          segments.push(reduced);
        }
        ...
        "!": (function () {
          ...
          return function (node) {
            ...
            if (node instanceof UnaryNode) {
              ...
              if (__owns(invertibleBinaryOps, node.op)) {
  ...
  Node.UseMacro = UseMacroNode = (function (_super) {
    ...
    _proto._reduce = function () {
      var node;
      node = this.node.reduce();
      if (this.tmps.length === 0 && this.macroHelpers.length === 0) {
        return node;
