...
break;
  ...
  DefineHelper = cache(named("DefineHelper", (function () {
    ...
    _backend = (function () {
      ...
      function _mutator(x, o, i) {
        return o.defineHelper(x.name, x.value);
      }
      return named(
        (_rule != null ? _rule.parserName : void 0) || "<unknown>",
        function (o) {
  ...
  State = (function () {
    ...
    _proto.defineHelper = function (name, value) {
      var translator;
