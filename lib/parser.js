(function () {
  ...
  Node.CallChain = CallChainNode = (function (_super) {
    var _proto, _superproto;
    function CallChainNode(startIndex, endIndex, head, links) {
      ...
      if (this instanceof CallChainNode) {
        _this = this;
      } else {
        _this = __create(_proto);
      }
    ...
    _superproto = _super.prototype;
    _proto = CallChainNode.prototype = __create(_superproto);
    _proto.constructor = CallChainNode;
    CallChainNode.displayName = "CallChainNode";
  ...
  Node.UseMacro = UseMacroNode = (function (_super) {
    var _proto, _superproto;
    function UseMacroNode(startIndex, endIndex, node, tmps, macroHelpers) {
      ...
      if (this instanceof UseMacroNode) {
        _this = this;
      } else {
        _this = __create(_proto);
      }
    ...
    _superproto = _super.prototype;
    _proto = UseMacroNode.prototype = __create(_superproto);
    _proto.constructor = UseMacroNode;
    UseMacroNode.displayName = "UseMacroNode";
