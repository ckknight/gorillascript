(function (GLOBAL) {
  ...
  var __bind, __cmp, __compose, __create, __curry, __defer,
      __generatorToPromise, __import, __in, __isArray, __name, __owns,
      __promise, __slice, __toArray, __toPromise, __typeof, _arr, _Block,
      _DefineMacro, _FunctionBody, _FunctionDeclaration, _i,
      _IdentifierOrAccess, _len, _Name, _o, _ref, _ref2,
      _SomeEmptyLinesWithCheckIndent, _Symbol, _this, addParamToScope,
      ...
      BracketedObjectKey, cache, CallNode, CaretChar, Cascade, CascadePart,
  ...
  mutate = __curry(2, function (mutator, rule) {
    ...
    function f(parser, index) {
      ...
      result = rule(parser, index);
      if (result) {
        if (false && !(result instanceof Box)) {
  ...
  function separatedList(itemRule, separatorRule, tailRule) {
    ...
    return stackWrap(function (parser, index) {
      ...
      for (; ; ++i) {
        ...
        if (false && !(separator instanceof Box)) {
    ...
    linkTypes = {
      ...
      call: function (parser, index, head, link, linkIndex, links) {
        ...
        if (!link.existential) {
          ...
          tmpIds = [];
          setHead = head;
          if (head instanceof LispyNode && head.isInternalCall("access") && !link.isApply && !link.isNew) {
            _ref = head.args;
            parent = _ref[0];
            child = _ref[1];
            setParent = parent;
  ...
  Line = cache((function () {
    ...
    return function (parser, index) {
      ...
      while (true) {
        ...
        if (ret) {
          if (false && !(ret.value instanceof Node)) {
