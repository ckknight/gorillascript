      ...
      Block: function (x, func) {
        ...
        if (len !== 0) {
          ...
          if (lastNode !== nodes[__num(len) - 1]) {
            return BlockNode(x.startIndex, x.endIndex, x.scopeId, __toArray(__slice(nodes, 0, -1)).concat([lastNode]));
          }
        }
        return x;
      },
