(function () {
  ...
  ParserError = (function (_super) {
    ...
    function ParserError(message, text, index, line) {
      ...
      err = _super.call(_this, __strnum(message) + " at line #" + __strnum(line));
  ...
  MacroError = (function (_super) {
    ...
    function MacroError(inner, text, index, line) {
      ...
      err = _super.call(_this, (innerType === "Error" ? "" : __strnum(innerType) + ": ") + String(inner != null ? inner.message : void 0) + " at line #" + __strnum(line));
      _this.message = err.message;
      if (typeof Error.captureStackTrace === "function") {
  ...
  MacroHelper = (function () {
    ...
    _proto["var"] = function (ident, isMutable, asType) {
    ...
    _proto.isTypeFunction = function (node) {
      return this.macroExpand1(node) instanceof TypeFunctionNode;
    };
    _proto.returnType = function (node) {
      node = this.macroExpand1(node);
  ...
  MacroHolder = (function () {
    ...
    _proto.addSerializedHelper = function (name, helper, dependencies) {
  ...
  State = (function () {
    ...
    function State(data, macros, options, index, line, failures, cache, indent, currentMacro, preventFailures, scope) {
      var _this;
      if (macros == void 0) {
        macros = MacroHolder();
      }
    ...
    State.addNodeFactory = function (name, type) {
      State.prototype[name] = function (index) {
        ...
        return type.apply(void 0, [index, this.index].concat(__toArray(args)));
      };
    };
    return State;
  }());
        ...
        "+": function (x, y, o) {
          if (x.constValue() === 0 && y.type(o).isSubsetOf(Type.number)) {
            ...
            return BinaryNode(
              this.startIndex,
              this.endIndex,
              ConstNode(x.startIndex, y.left.endIndex, __strnum(x.constValue()) + __strnum(y.left.constValue())),
              "+",
              y.right
            );
          }
        ...
        "+": function (x, y, o) {
          if (y.constValue() === 0 && x.type(o).isSubsetOf(Type.number)) {
            ...
            return BinaryNode(
              ...
              x,
              "-",
              ConstNode(y.startIndex, y.endIndex, -__num(y.constValue()))
            );
            ...
            return BinaryNode(
              ...
              x.left,
              "+",
              ConstNode(x.right.startIndex, y.endIndex, __strnum(x.right.constValue()) + __strnum(y.constValue()))
            );
          }
        },
        "-": function (x, y, o) {
  ...
  Node.TypeFunction = TypeFunctionNode = (function (_super) {
    var _proto, _superproto;
    function TypeFunctionNode(startIndex, endIndex, returnType) {
      var _this;
      if (!(returnType instanceof Node)) {
        throw TypeError("Expected returnType to be a Node, got " + __typeof(returnType));
      }
      _this = this instanceof TypeFunctionNode ? this : __create(_proto);
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this._reduced = void 0;
      _this._macroExpanded = void 0;
    ...
    _superproto = _super.prototype;
    _proto = TypeFunctionNode.prototype = __create(_superproto);
    _proto.constructor = TypeFunctionNode;
    ...
    _proto.walk = function (f) {
      ...
      if (returnType !== this.returnType) {
        return TypeFunctionNode(this.startIndex, this.endIndex, returnType);
      } else {
        return this;
      }
    };
  ...
  Node.Var = VarNode = (function (_super) {
    var _proto, _superproto;
    function VarNode(startIndex, endIndex, ident, isMutable, asType) {
      var _this;
      if (!(ident instanceof IdentNode) && !(ident instanceof TmpNode)) {
        throw TypeError("Expected ident to be a IdentNode or TmpNode, got " + __typeof(ident));
      }
