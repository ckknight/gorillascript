(function () {
  ...
  Parenthetical = cache(named("Parenthetical", (function () {
    function _rule(o) {
      return ExpressionOrAssignment(o) || CustomOperator(o);
    }
    return (function () {
      function _rule2(o) {
        var clone, result;
