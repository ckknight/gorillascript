(function () {
  ...
  function cache(rule, dontCache) {
    ...
    if (dontCache) {
      ...
      return named(rule.parserName, function (o) {
        ...
        if ((_ref = indentCache[index]) != null) {
          inner = _ref;
        } else {
          inner = indentCache[index] = [];
        }
        item = inner[cacheKey];
        if (item) {
          o.index = item[0];
          ...
          inner[cacheKey] = !result ? false : [o.index, o.line, result];
          return result;
        } else {
          return false;
        }
      ...
      _rule2 = (function () {
        ...
        _rule3 = (function () {
          function _rule4(o) {
            var clone, result;
            clone = o.clone();
            return CommaOrNewline(clone) && (result = Parameter(clone)) && (o.update(clone), result);
          }
          return named(__strnum(_rule4 != null && _rule4.parserName || "<unknown>") + "*", function (o) {
            var clone, item, result;
            clone = o.clone();
        ...
        return (function () {
          function _rule4(o) {
            ...
            clone = o.clone();
            result = {};
            return (result.head = Parameter(clone)) && (result.tail = _rule3(clone)) && (o.update(clone), result);
          }
          function _mutator(x) {
            return [x.head].concat(__toArray(x.tail));
          }
  ...
  Parameters = named("Parameters", (function () {
    ...
    return (function () {
      function _rule2(o) {
        ...
        clone = o.clone();
        result = {};
        return (result.head = Parameter(clone)) && (result.tail = _rule(clone)) && (o.update(clone), result);
      }
      function _mutator(x, o, i) {
  ...
  Index = cache(named("Index", (function () {
    ...
    _rule = (function () {
      function _rule2(o) {
        var clone, result;
        clone = o.clone();
        return CommaOrNewline(clone) && (result = Expression(clone)) && (o.update(clone), result);
      }
      return named(__strnum(_rule2 != null && _rule2.parserName || "<unknown>") + "*", function (o) {
        var clone, item, result;
        clone = o.clone();
    ...
    return (function () {
      function _rule2(o) {
        ...
        clone = o.clone();
        result = {};
        return (result.head = Expression(clone)) && (result.tail = _rule(clone)) && (o.update(clone), result);
      }
      function _mutator(x) {
  ...
  Line = named("Line", function (o) {
    var clone, result;
    clone = o.clone();
    return CheckIndent(clone) && (result = Statement(clone)) && (o.update(clone), result);
  });
  _Block = (function () {
    var runSync;
