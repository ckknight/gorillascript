  ...
  FunctionType = cache(named("FunctionType", (function () {
    ...
    return (function () {
      function _rule5(o) {
        ...
        clone = o.clone();
        _result = void 0;
        return _rule(clone) && _rule2(clone) && _rule3(clone) && (_result = _rule4(clone)) && (o.update(clone), _result);
      }
      function _mutator(x, o, i) {
        if (x === NOTHING) {
  ...
  NonUnionType = cache(named("NonUnionType", (function () {
    ...
    _rule = (function () {
      ...
      return function (o) {
        ...
        clone = o.clone();
        _result = void 0;
        return OpenParenthesis(clone) && (_result = _rule2(clone)) && CloseParenthesis(clone) && (o.update(clone), _result);
      };
    }());
    return function (o) {
  ...
  FunctionDeclaration = named("FunctionDeclaration", (function () {
    ...
    restRule = (function () {
      ...
      return function (o) {
        ...
        clone = o.clone();
        _result = {};
        return (_result.asType = _rule(clone)) && (_result.autoReturn = _rule2(clone)) && (_result.bound = _rule3(clone)) && (_result.generatorBody = _rule4(clone)) && (o.update(clone), _result);
      };
    }());
    return function (o) {
