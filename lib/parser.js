(function () {
  ...
  _Space = named("_Space", named(__strnum(SpaceChar != null && SpaceChar.parserName || "SpaceChar") + "*", function (o) {
    while (SpaceChar(o));
    return true;
  }));
  ...
  MaybeComment = cache(named("MaybeComment", (function () {
    ...
    return named(__strnum(Comment != null && Comment.parserName || "Comment") + "?", function (o) {
  ...
  NoSpace = cache(named("NoSpace", named("!" + __strnum(SpaceChar != null && SpaceChar.parserName || "SpaceChar"), function (o) {
  ...
  EmptyLines = cache(named("EmptyLines", named(__strnum(EmptyLine != null && EmptyLine.parserName || "EmptyLine") + "*", function (o) {
    while (EmptyLine(o));
    return true;
  })));
  SomeEmptyLines = cache(named("SomeEmptyLines", named(__strnum(EmptyLine != null && EmptyLine.parserName || "EmptyLine") + "+", function (o) {
    if (!EmptyLine(o)) {
      return false;
    } else {
      while (EmptyLine(o));
  ...
  TripleDoubleQuote = cache(named("TripleDoubleQuote", named(__strnum(DoubleQuote != null && DoubleQuote.parserName || "DoubleQuote") + "{3}", function (o) {
    var clone, resultLength;
    clone = o.clone();
    resultLength = 0;
    while (resultLength < 3 && DoubleQuote(clone)) {
      ++resultLength;
    }
    if (resultLength < 3) {
      return false;
  ...
  TripleSingleQuote = cache(named("TripleSingleQuote", named(__strnum(SingleQuote != null && SingleQuote.parserName || "SingleQuote") + "{3}", function (o) {
    var clone, resultLength;
    clone = o.clone();
    resultLength = 0;
    while (resultLength < 3 && SingleQuote(clone)) {
      ++resultLength;
    }
    if (resultLength < 3) {
      return false;
  ...
  MaybeComma = cache(named("MaybeComma", named(__strnum(Comma != null && Comma.parserName || "Comma") + "?", function (o) {
    var clone, index, line, result;
    index = o.index;
    line = o.line;
    clone = o.clone();
  ...
  MaybeCommaOrNewline = named("MaybeCommaOrNewline", named(__strnum(CommaOrNewline != null && CommaOrNewline.parserName || "CommaOrNewline") + "?", function (o) {
    var clone, index, line, result;
    index = o.index;
    line = o.line;
    clone = o.clone();
  ...
  NamePart = named("NamePart", named(__strnum(NameChar != null && NameChar.parserName || "NameChar") + "+", function (o) {
    var clone, item, result;
    clone = o.clone();
    result = [];
  ...
  DecimalNumber = cache(named("DecimalNumber", (function () {
    ...
    RawDecimalDigits = named("RawDecimalDigits", named(__strnum(DecimalDigit != null && DecimalDigit.parserName || "DecimalDigit") + "+", function (o) {
      var clone, item, result;
      clone = o.clone();
      result = [];
          ...
          _rule6 = (function () {
            ...
            _rule7 = (function () {
              ...
              _rule8 = (function () {
                ...
                return named(_rule12 != null && _rule12.parserName || "<unknown>", function (o) {
                  var index, line, result;
                  index = o.index;
                  line = o.line;
                  result = _rule12(o);
          ...
          _rule6 = (function () {
            ...
            _rule7 = (function () {
              ...
              _rule8 = (function () {
                ...
                return named(_rule11 != null && _rule11.parserName || "<unknown>", function (o) {
                  var index, line, result;
                  index = o.index;
                  line = o.line;
                  result = _rule11(o);
          ...
          _rule6 = (function () {
            ...
            _rule7 = (function () {
              ...
              _rule8 = (function () {
                ...
                return named(_rule10 != null && _rule10.parserName || "<unknown>", function (o) {
                  var index, line, result;
                  index = o.index;
                  line = o.line;
                  result = _rule10(o);
  ...
  NotColon = cache(named("NotColon", named("!" + __strnum(Colon != null && Colon.parserName || "Colon"), function (o) {
