(function (GLOBAL) {
  ...
  FunctionDeclaration = named("FunctionDeclaration", (function () {
    ...
    return function (o) {
      var _arr, _i, asType, body, clone, flags, func, index, line, mutateFunctionMacro, param, params, rest;
      index = o.index;
      line = o.line;
      clone = o.clone(o.cloneScope());
  ...
  MacroHelper = (function () {
    ...
    _MacroHelper_prototype.func = function (params, body, autoReturn, bound, curry, asType, generator) {
      var _this, clone;
      _this = this;
