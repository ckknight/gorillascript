(function (GLOBAL) {
  ...
  var __bind, __cmp, __compose, __create, __curry, __defer,
      ...
      addParamToScope, allowSpaceBeforeAccess, AnyArrayLiteral,
      AnyObjectLiteral, ArgumentsLiteral, ArrayLiteral, ArrayParameter,
      ArrayType, AssignmentAsExpression, Ast, AsterixChar, AstExpression,
      AstPosition, AstStatement, AtSignChar, BackslashChar,
      BackslashEscapeSequence, BackslashStringLiteral, BasicInvocationOrAccess,
      BinaryDigit, BinaryNumber, BinaryOperationByPrecedence, Block, Body,
      ...
      IdentifierParameter, Imports, inAst, inCascade,
      ...
      Letter, LicenseComment, Line, LInternalCall, LispyNode, Literal, Logic,
      LSymbol, LValue, MacroAccessNode, MacroBody, MacroContext, MacroError,
      ...
      RegexLiteral, requireParameterSequence, RootInnerP, RootP, Scope,
      Semicolon, SemicolonChar, Semicolons, setImmediate, SetLiteral, Shebang,
      ...
      SpaceChar, SpaceChars, SpreadOrExpression, SpreadToken, Stack, Statement,
      StringInterpolation, StringLiteral, stringRepeat, SuperInvocation, Symbol,
      symbol, SymbolChar, ThisLiteral, ThisOrShorthandLiteral,
      ThisOrShorthandLiteralPeriod, ThisShorthandLiteral, trimRight,
      ...
      TripleSingleStringLiteral, Type, TypeObjectNode, TypeReference,
      UnclosedArguments, UnclosedArrayLiteralElement, UnclosedObjectLiteral,
  ...
  LValue = LispyNode.Value;
  LCall = LispyNode.Call;
  LInternalCall = LispyNode.InternalCall;
  LAccess = LispyNode.Access;
  LSymbol = LispyNode.Symbol;
  ...
  Identifier = cache(oneOf(
    (_ref = sequential(
      ...
      return LCall.apply(void 0, [
        index,
        parser.scope.peek(),
        LSymbol.ident(index, parser.scope.peek(), "$")
      ].concat(__toArray(args)));
    })(_ref)),
    function (parser, index) {
      var name;
  ...
  DoubleStringArrayLiteral = cache((_ref = sequential(
    ...
    return LInternalCall.apply(void 0, ["array", index, parser.scope.peek()].concat(stringParts));
  })(_ref)));
  ...
  NonUnionType = oneOf(
    ...
    (_ref = sequential(
      ...
      if (!args.length) {
        ...
        return LInternalCall.apply(void 0, ["typeGeneric", index, parser.scope.peek(), base].concat(__toArray(args)));
      }
    })(_ref))
  );
  ...
  TypeReference = cache((_ref = separatedList(NonUnionType, Pipe), mutate(function (types, parser, index) {
    ...
    for (_arr = __toArray(types), i = 0, _len = _arr.length; i < _len; ++i) {
      type = _arr[i];
      if (type instanceof LispyNode && type.isInternalCall("typeUnion")) {
    ...
    if (result.length === 1) {
      ...
      return LInternalCall.apply(void 0, ["typeUnion", index, parser.scope.peek()].concat(result));
    }
  })(_ref)));
  ...
  ArrayParameter = mutate(function (params, parser, index) {
    return LInternalCall.apply(void 0, ["array", index, parser.scope.peek()].concat(__toArray(params)));
  })(_ref);
  ...
  ParamSingularObjectKey = mutate(function (param, parser, index) {
    ...
    } else if (ident instanceof LispyNode && ident.isInternalCall("access")) {
      key = ident.args[1];
    } else {
  ...
  function makeObjectNode(parser, index, prototype, pairs) {
    ...
    return LInternalCall.apply(void 0, ["object", index, parser.scope.peek(), prototype || LSymbol.nothing(index)].concat((function () {
      ...
      for (_arr = [], _arr2 = __toArray(pairs), _i = 0, _len = _arr2.length; _i < _len; ++_i) {
        ...
        value = _ref.value;
        property = _ref.property;
        _arr.push(LInternalCall.apply(void 0, [
          "array",
          key.index,
          parser.scope.peek(),
          key,
  ...
  ParameterSequence = mutate((function () {
    function checkParam(param, parser, names) {
      ...
      } else if (param instanceof LispyNode && param.isInternalCall()) {
        if (param.func.isArray) {
  ...
  ArrayLiteral = cache(preventUnclosedObjectLiteral((_ref = sequential(
    ...
    return LInternalCall.apply(void 0, ["array", index, parser.scope.peek()].concat(__toArray(items)));
  })(_ref))));
  ...
  IdentifierOrAccess = cache(function (parser, index) {
    ...
    if (result) {
      value = result.value;
      if (value instanceof LSymbol.ident || value instanceof LispyNode && value.isInternalCall("access")) {
        return result;
      }
    }
  });
  SingularObjectKey = oneOf(
    (_ref = sequential(
      ...
      var key;
      if (ident instanceof LispyNode && ident.isInternalCall("access")) {
        key = ident.args[1];
        ...
        indexTypes = {
          multi: function (parser, index, child) {
            return function (parent) {
              ...
              result = LInternalCall.apply(void 0, ["array", index, parser.scope.peek()].concat((function () {
              ...
              if (tmpIds.length) {
                return LInternalCall.apply(void 0, ["tmpWrapper", index, result.scope, result].concat((function () {
                  var _arr, _i, _len, tmpId;
                  for (_arr = [], _i = 0, _len = tmpIds.length; _i < _len; ++_i) {
                    tmpId = tmpIds[_i];
      ...
      call: function (parser, index, head, link, linkIndex, links) {
        ...
        function nextChain() {
          return convertCallChain(
            ...
            index,
            link.isContextCall
              ? LInternalCall.apply(void 0, ["contextCall", index, parser.scope.peek(), head].concat(__toArray(link.args)))
              : link.isNew
              ? LInternalCall.apply(void 0, ["new", index, parser.scope.peek(), head].concat(__toArray(link.args)))
              : LCall.apply(void 0, [index, parser.scope.peek(), head].concat(__toArray(link.args))),
            +linkIndex + 1,
            links
          );
        }
        if (!link.existential) {
          ...
          tmpIds = [];
          setHead = head;
          if (head instanceof LispyNode && head.isInternalCall("access") && !link.isContextCall && !link.isNew) {
            _ref = head.args;
            parent = _ref[0];
            child = _ref[1];
            setParent = parent;
  ...
  SuperInvocation = cache((_ref = sequential(
    ...
    child = _p.child;
    args = _p.args;
    return LInternalCall.apply(void 0, ["super", index, parser.scope.peek(), child || LSymbol.nothing(index)].concat(__toArray(args)));
  })(_ref)));
  ...
  InvocationOrAccess = cache(oneOf(
    function (parser, index) {
      ...
      try {
        ...
        return Box(args.index, LCall.apply(void 0, [
          index,
          parser.scope.peek(),
          LSymbol.ident(index, parser.scope.peek(), "$")
        ].concat(__toArray(args.value))));
      } finally {
        inAst.pop();
      }
    },
    ...
    [
      ...
      oneOf(
        ...
        (_ref2 = sequential(
          ...
          return LInternalCall.apply(void 0, ["syntaxSequence", index, parser.scope.peek()].concat(__toArray(value)));
        })(_ref2)),
        (_ref2 = sequential(
          OpenParenthesis,
          EmptyLines,
          ...
          return LInternalCall.apply(void 0, ["syntaxChoice", index, parser.scope.peek()].concat(__toArray(choices)));
        })(_ref2))
      )
    ],
    [
  ...
  function addMacroSyntaxParametersToScope(params, scope) {
    ...
    for (_arr = __toArray(params), _i = 0, _len = _arr.length; _i < _len; ++_i) {
      param = _arr[_i];
      if (param instanceof LispyNode && param.isInternalCall("syntaxParam")) {
        ident = param.args[0];
        if (ident instanceof LSymbol.ident) {
  ...
  EmbeddedLiteralText = cache((_ref = sequential(
    ...
    return LInternalCall.apply(void 0, ["block", index, parser.scope.peek()].concat(__toArray(nodes)));
  })(_ref)));
  ...
  function _BlockMutator(lines, parser, index) {
    ...
    for (_arr = __toArray(lines), i = 0, _len = _arr.length; i < _len; ++i) {
      ...
      for (_arr2 = __toArray(item), j = 0, _len2 = _arr2.length; j < _len2; ++j) {
        ...
        } else if (part instanceof LispyNode && part.isInternalCall("block")) {
    ...
    default:
      return LInternalCall.apply(void 0, ["block", index, parser.scope.peek()].concat(nodes));
    }
  }
      ...
      while (true) {
        ...
        case 6:
          ...
          return {
            ...
            value: Box(currentIndex, LInternalCall.apply(void 0, ["block", index, parser.scope.peek()].concat(nodes, [
  ...
  Parser = (function () {
    ...
    function makeMacroRoot(index, params, body) {
      ...
      return LInternalCall(
        ...
        scope,
        LValue(index, null),
        LInternalCall("return", index, scope, this.Function(
          index,
          [
            params,
            this.Param(
              index,
              LSymbol.ident(index, scope, "__wrap"),
              void 0,
              false,
              true,
              void 0
            ...
            this.Param(
              index,
              LSymbol.ident(index, scope, "__node"),
              void 0,
              false,
              true,
              void 0
            ...
            this.Param(
              index,
              LSymbol.ident(index, scope, "__const"),
              void 0,
              false,
              true,
              void 0
            ...
            this.Param(
              index,
              LSymbol.ident(index, scope, "__value"),
              void 0,
              false,
              true,
              void 0
            ...
            this.Param(
              index,
              LSymbol.ident(index, scope, "__symbol"),
              void 0,
              false,
              true,
              void 0
            ...
            this.Param(
              index,
              LSymbol.ident(index, scope, "__call"),
              void 0,
              false,
              true,
              void 0
    ...
    function serializeParamType(asType) {
      if (asType instanceof LSymbol.ident) {
        return ["ident", asType.name];
      } else if (asType instanceof LispyNode && asType.isInternalCall("syntaxSequence")) {
        return ["sequence"].concat(__toArray(fixArray(serializeParams(asType.args))));
      } else if (asType instanceof LispyNode && asType.isInternalCall("syntaxChoice")) {
        return ["choice"].concat((function () {
          var _arr, _arr2, _i, _len, choice;
          for (_arr = [], _arr2 = __toArray(asType.args), _i = 0, _len = _arr2.length; _i < _len; ++_i) {
            choice = _arr2[_i];
      ...
      } else if (asType instanceof LispyNode && asType.isInternalCall("syntaxMany")) {
    ...
    function serializeParams(params) {
      return simplifyArray((function () {
        var _arr, _arr2, _i, _len, _ref, asType, ident, param, value;
        for (_arr = [], _arr2 = __toArray(params), _i = 0, _len = _arr2.length; _i < _len; ++_i) {
          param = _arr2[_i];
          if (param.isConst()) {
            _arr.push(["const", param.constValue()]);
          } else if (param instanceof LispyNode && param.isInternalCall("syntaxParam")) {
            _ref = param.args;
            ident = _ref[0];
            asType = _ref[1];
            if (!(ident instanceof LSymbol.ident)) {
              throw Error("Unknown param type: " + __typeof(ident));
            }
            if (ident.name === "this") {
              value = ["this"];
            } else {
    ...
    deserializeParamType = (function () {
      ...
      deserializeParamTypeByType = {
        ...
        sequence: function (scope) {
          ...
          return LInternalCall.apply(void 0, ["syntaxSequence", 0, scope].concat(__toArray(deserializeParams(items, scope))));
        },
        choice: function (scope) {
          var choices;
          choices = __slice.call(arguments, 1);
          return LInternalCall.apply(void 0, ["syntaxChoice", 0, scope].concat((function () {
    ...
    function calcParam(param) {
      ...
      if (param instanceof LSymbol.ident) {
      ...
      } else if (param instanceof LispyNode && param.isInternalCall("syntaxSequence")) {
        return handleParams.call(this, param.args);
      } else if (param instanceof LispyNode && param.isInternalCall("syntaxChoice")) {
        return oneOf.apply(void 0, (function () {
          var _arr, _arr2, _i, _len, choice;
          for (_arr = [], _arr2 = __toArray(param.args), _i = 0, _len = _arr2.length; _i < _len; ++_i) {
            choice = _arr2[_i];
        ...
        if (typeof string !== "string") {
          throw Error("Expected a constant string parameter, got " + __typeof(string));
        }
        return __owns.call(macroSyntaxConstLiterals, string) && macroSyntaxConstLiterals[string] || wordOrSymbol(string);
      } else if (param instanceof LispyNode && param.isInternalCall("syntaxMany")) {
        _ref = param.args;
        inner = _ref[0];
        multiplier = _ref[1];
        ...
        throw Error("Unexpected type: " + __typeof(param));
      }
    }
    function handleParams(params) {
      var _arr, _i, _len, _ref, asType, ident, param, sequence, string, type;
      sequence = [];
      for (_arr = __toArray(params), _i = 0, _len = _arr.length; _i < _len; ++_i) {
        param = _arr[_i];
        if (param.isConst()) {
        ...
        } else if (param instanceof Node && param.isInternalCall("syntaxParam")) {
          _ref = param.args;
          ident = _ref[0];
          asType = _ref[1];
          if (!(ident instanceof LSymbol.ident)) {
          ...
          if (!isNothing(asType)) {
            ...
            type = LSymbol.ident(0, param.scope, "Expression");
          }
          sequence.push([
            ident.name,
      ...
      return sequential.apply(void 0, sequence);
    }
    ...
    macroSyntaxTypes = {
      syntax: function (index, params, body, options, stateOptions, translator) {
        ...
        body = LInternalCall.apply(void 0, [
          "block",
          index,
          scope,
      ...
      defineSyntax: function (index, params, body, options, stateOptions, translator) {
        ...
        if (body != null) {
          handler = (function () {
            ...
            body = LInternalCall.apply(void 0, ["block", index, scope].concat(
              (function () {
                var _arr, _arr2, _i, _len, param;
                for (_arr = [], _arr2 = __toArray(params), _i = 0, _len = _arr2.length; _i < _len; ++_i) {
                  param = _arr2[_i];
    ...
    function handleMacroSyntax(index, type, handler, rule, params, options, macroId) {
      ...
      function mutator(data, parser, index) {
        var macroContext, pos, result, scope, tmps;
        if (parser.inAst.peek() || !parser.expandingMacros) {
          return parser.MacroAccess(
            index,
            macroId,
          ...
          if (result instanceof Node) {
            ...
            if (tmps.unsaved.length) {
              result = LInternalCall.apply(void 0, ["tmpWrapper", index, result.scope, result].concat((function () {
                var _arr, _arr2, _i, _len, tmpId;
                for (_arr = [], _arr2 = __toArray(tmps.unsaved), _i = 0, _len = _arr2.length; _i < _len; ++_i) {
                  tmpId = _arr2[_i];
                  _arr.push(LValue(index, tmpId));
                }
                return _arr;
    ...
    Parser.addNodeFactory = function (name, type) {
      Parser.prototype[name] = function (index) {
        var args;
        args = __slice.call(arguments, 1);
        return type.apply(void 0, [index, this.scope.peek()].concat(args));
      };
    };
    return Parser;
  }());
  ...
  for (_arr = ["Function", "MacroAccess", "Param", "TypeObject"], _i = 0, _len = _arr.length; _i < _len; ++_i) {
    nodeType = _arr[_i];
