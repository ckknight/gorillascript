(function (GLOBAL) {
  ...
  var __bind, __cmp, __compose, __create, __curry, __defer,
      ...
      ObjectKey, ObjectKeyColon, ObjectLiteral, ObjectNode, ObjectParameter,
      ObjectType, ObjectTypePair, OctalDigit, OctalNumber, OpenCurlyBrace,
  ...
  ParameterSequence = mutate((function () {
    function checkParam(param, parser, names) {
      ...
      } else if (param instanceof LispyNode && param.isCall && param.func.isSymbol && param.func.isInternal && param.func.isArray) {
