...
function sequential(array, mutator, dontCache) {
  ...
  for (i = 0, _tmp = __num(array.length); i < _tmp; ++i) {
    item = array[i];
    key = void 0;
    rule = void 0;
  ...
  return (function () {
    ...
    _tmp = named(name, function (o) {
      ...
      clone = o.clone();
      result = {};
      for (i = 0, _tmp2 = __num(rules.length); i < _tmp2; ++i) {
        rule = rules[i];
        item = rule(clone);
        if (!item) {
          return false;
...
function wordOrSymbol(text, mutator) {
  ...
  parts.push.apply(parts, __toArray((function () {
    var _tmp, _tmp2, _tmp3, i, part;
    for (_tmp = [], _tmp2 = text.split(/([a-z]+)/gi), i = 0, _tmp3 = __num(_tmp2.length); i < _tmp3; ++i) {
      part = _tmp2[i];
      if (part) {
        if (__num(i) % 2 === 0) {
          _tmp.push(ruleEqual(_Symbol, part));
        } else {
          _tmp.push(ruleEqual(_Name, part));
        }
      }
    }
    return _tmp;
...
CountIndent = cache(named("CountIndent", (function () {
  ...
  function _tmp2(x) {
    ...
    count = 1;
    for (_tmp3 = 0, _tmp4 = __num(x.length); _tmp3 < _tmp4; ++_tmp3) {
      c = x[_tmp3];
      i = INDENTS[c];
      if (!i) {
...
function processCharCodes(codes, array) {
  ...
  for (_tmp = 0, _tmp2 = __num(codes.length); _tmp < _tmp2; ++_tmp) {
    v = codes[_tmp];
...
_Name = cache(named("_Name", (function () {
  ...
  return (function () {
    ...
    function _tmp3(x) {
      ...
      for (_tmp4 = x.tail, _tmp5 = 0, _tmp6 = __num(_tmp4.length); _tmp5 < _tmp6; ++_tmp5) {
        part = _tmp4[_tmp5];
  ...
  digits = (function () {
    ...
    return (function () {
      ...
      function _tmp4(x) {
        ...
        parts = processCharCodes(x.head);
        for (_tmp5 = x.tail, _tmp6 = 0, _tmp7 = __num(_tmp5.length); _tmp6 < _tmp7; ++_tmp6) {
          part = _tmp5[_tmp6];
          processCharCodes(part, parts);
        }
        return parts.join("");
    ...
    return function (radix) {
      ...
      return (_tmp = digitCache[radix]) != null ? _tmp : (digitCache[radix] = (function () {
        ...
        digit = radix === 2 ? BinaryDigit : radix === 8 ? OctalDigit : radix === 10 ? DecimalDigit : radix === 16 ? HexDigit : (function () {
          var _tmp, chars, i;
          chars = [];
          for (i = 0, _tmp = __num(!__lte(radix, 10) ? radix : 10); i < _tmp; ++i) {
            chars[__num(i) + 48] = true;
          }
          for (i = 10, _tmp = __num(!__lte(radix, 36) ? radix : 36); i < _tmp; ++i) {
  ...
  _tmp = (function () {
    ...
    return (function () {
      ...
      function _tmp4(x, o, i) {
        ...
        stringParts = [];
        currentLiteral = [];
        for (_tmp5 = 0, _tmp6 = __num(x.length); _tmp5 < _tmp6; ++_tmp5) {
          part = x[_tmp5];
...
TripleDoubleStringLine = cache(named("TripleDoubleStringLine", (function () {
  ...
  return (function () {
    ...
    function _tmp3(x) {
      ...
      stringParts = [];
      currentLiteral = [];
      for (_tmp4 = 0, _tmp5 = __num(x.length); _tmp4 < _tmp5; ++_tmp4) {
        part = x[_tmp4];
        if (typeof part === "number") {
          currentLiteral.push(part);
        } else if (part.type !== "nothing") {
    ...
    _tmp = (function () {
      ...
      return (function () {
        ...
        function _tmp5(x, o, i) {
          ...
          for (j = 0, _tmp6 = __num(x.emptyLines.length); j < _tmp6; ++j) {
          ...
          result = [];
          for (j = 0, _tmp6 = __num(lines.length); j < _tmp6; ++j) {
            line = lines[j];
            if (!__lte(j, 0)) {
              result.push("\n");
            }
...
RegexLiteral = cache(named("RegexLiteral", (function () {
  ...
  return (function () {
    ...
    function _tmp4(x, o, i) {
      var _tmp5, _tmp6, _tmp7, currentLiteral, flags, part, stringParts, text;
      stringParts = [];
      currentLiteral = [];
      for (_tmp5 = x.text, _tmp6 = 0, _tmp7 = __num(_tmp5.length); _tmp6 < _tmp7; ++_tmp6) {
        part = _tmp5[_tmp6];
        if (typeof part === "number") {
          currentLiteral.push(part);
        } else if (part.type !== "nothing") {
  ...
  _tmp3 = (function () {
    ...
    return (function () {
      function _tmp5(o) {
        ...
        clone = o.clone();
        result = {};
        if ((result.parent = ThisOrShorthandLiteral(clone)) && (result.isProto = _tmp4(clone)) && OpenSquareBracketChar(clone) && (result.child = Expression(clone)) && CloseSquareBracket(clone)) {
          o.update(clone);
          return result;
        } else {
          return false;
...
BasicInvocationOrAccess = cache(named("BasicInvocationOrAccess", (function () {
  ...
  return (function () {
    ...
    function _tmp5(x, o, i) {
      ...
      for (_tmp6 = 0, _tmp7 = __num(tail.length); _tmp6 < _tmp7; ++_tmp6) {
        part = tail[_tmp6];
    ...
    function _tmp3(x, o, i) {
      ...
      if (x.op !== NOTHING) {
        if (x.node.type === "const" && typeof x.node.value === "number" && ((_tmp4 = x.op) === "+" || _tmp4 === "-" || _tmp4 === "~+" || _tmp4 === "~-")) {
          return o["const"](i, (_tmp4 = x.op) === "+" || _tmp4 === "~+" ? __num(x.node.value) : -__num(x.node.value));
        } else {
          return o.unary(i, x.op, x.node);
        }
      } else {
...
function binaryLeftToRight(x, o, i) {
  ...
  current = x.head;
  for (_tmp = x.tail, _tmp2 = 0, _tmp3 = __num(_tmp.length); _tmp2 < _tmp3; ++_tmp2) {
    part = _tmp[_tmp2];
...
Block = cache(named("Block", (function () {
  ...
  return (function () {
    ...
    function _tmp3(x, o, i) {
      var _tmp4, _tmp5, _tmp6, item, nodes;
      nodes = [];
      for (_tmp4 = [x.head].concat(__toArray(x.tail)), _tmp5 = 0, _tmp6 = __num(_tmp4.length); _tmp5 < _tmp6; ++_tmp5) {
        item = _tmp4[_tmp5];
        if (item.type === "block") {
...
MacroHelper = (function () {
  ...
  MacroHelper.prototype.tmp = function (save) {
    ...
    return this.state.tmp(this.index, id);
  };
  ...
  MacroHelper.prototype.array = function (elements) {
    var _tmp, _tmp2, _tmp3, element, i;
    if (!__isArray(elements)) {
      ...
      for (_tmp = 0, _tmp2 = elements.length; _tmp < _tmp2; ++_tmp) {
        if (!(elements[_tmp] instanceof Object)) {
          throw TypeError("Expected elements[" + _tmp + "] to be a Object, got " + __typeof(elements[_tmp]));
        }
      }
    }
    for (i = 0, _tmp3 = __num(elements.length); i < _tmp3; ++i) {
      element = elements[i];
  ...
  MacroHelper.prototype.object = function (pairs) {
    ...
    for (i = 0, _tmp = __num(pairs.length); i < _tmp; ++i) {
      pair = pairs[i];
  ...
  MacroHelper.prototype.isComplex = function (node) {
    var _tmp;
    return node != null && (_tmp = node.type) !== "const" && _tmp !== "ident" && _tmp !== "tmp" && (node.type !== "block" || node.nodes.length !== 0);
  };
  ...
  MacroHelper.prototype.empty = function (node) {
    ...
    if (node == null) {
      ...
      return (function () {
        ...
        for (_tmp = node.nodes, _tmp2 = 0, _tmp3 = __num(_tmp.length); _tmp2 < _tmp3; ++_tmp2) {
          item = _tmp[_tmp2];
          if (!_this.empty(item)) {
            return false;
          }
  ...
  function map(array, func, arg) {
    ...
    result = [];
    changed = false;
    for (_tmp = 0, _tmp2 = __num(array.length); _tmp < _tmp2; ++_tmp) {
      item = array[_tmp];
  ...
  function constifyArray(array, startIndex, endIndex) {
    return ParserNode("array", startIndex, endIndex, {
      elements: (function () {
        var _tmp, _tmp2, _tmp3, x;
        for (_tmp = [], _tmp2 = 0, _tmp3 = __num(array.length); _tmp2 < _tmp3; ++_tmp2) {
          x = array[_tmp2];
          _tmp.push(constifyObject(x, startIndex, endIndex));
        }
        return _tmp;
      }())
    });
  ...
  MacroHelper.wrap = function (value) {
    var _tmp, _tmp2, item, nodes, wrapped;
    if (value == null) {
      value = [];
    }
    if (Array.isArray(value)) {
      if (value.length === 1) {
        ...
        nodes = [];
        for (_tmp = 0, _tmp2 = __num(value.length); _tmp < _tmp2; ++_tmp) {
          item = value[_tmp];
    ...
    if (__owns(byName, name)) {
      ...
      m = (function () {
        ...
        _tmp = named("<" + __strnum(name) + " macro>", function (o) {
          ...
          for (_tmp2 = m.data, _tmp3 = 0, _tmp4 = __num(_tmp2.length); _tmp3 < _tmp4; ++_tmp3) {
            item = _tmp2[_tmp3];
            result = item(o);
            if (result) {
              return result;
    ...
    syntax: function (index, params, body) {
      ...
      function calcParam(param) {
        ...
        if (type === "ident") {
          ...
          choices = (function () {
            var _tmp, _tmp2, _tmp3, _tmp4, choice;
            for (_tmp = [], _tmp2 = param.choices, _tmp3 = 0, _tmp4 = __num(_tmp2.length); _tmp3 < _tmp4; ++_tmp3) {
              choice = _tmp2[_tmp3];
              _tmp.push(calcParam(choice));
            }
            return _tmp;
          }());
          return cache(function (o) {
            var _tmp, _tmp2, result, rule;
            for (_tmp = 0, _tmp2 = __num(choices.length); _tmp < _tmp2; ++_tmp) {
              rule = choices[_tmp];
              result = rule(o);
              if (result) {
                return result;
      ...
      function handleParams(params, sequence) {
        ...
        for (_tmp = 0, _tmp2 = __num(params.length); _tmp < _tmp2; ++_tmp) {
          ...
          if (type === "const") {
            ...
            type = (_tmp3 = param.asType) != null ? _tmp3 : ParserNode("ident", 0, 0, { name: "Expression" });
      ...
      funcParams = (function () {
        var _tmp, _tmp2, _tmp3, param;
        for (_tmp = [], _tmp2 = 0, _tmp3 = __num(params.length); _tmp2 < _tmp3; ++_tmp2) {
          param = params[_tmp2];
...
State.prototype.object = function (index, pairs) {
  ...
  if (!__isArray(pairs)) {
    ...
    for (_tmp = 0, _tmp2 = pairs.length; _tmp < _tmp2; ++_tmp) {
      if (!(pairs[_tmp] instanceof Object)) {
        throw TypeError("Expected pairs[" + _tmp + "] to be a Object, got " + __typeof(pairs[_tmp]));
      }
    }
  }
...
State.prototype["function"] = function (index, params, body, autoReturn, bound) {
  ...
  if (!__isArray(params)) {
    ...
    for (_tmp = 0, _tmp2 = params.length; _tmp < _tmp2; ++_tmp) {
      if (!(params[_tmp] instanceof Object)) {
        throw TypeError("Expected params[" + _tmp + "] to be a Object, got " + __typeof(params[_tmp]));
      }
    }
  }
  if (!(body instanceof Object)) {
...
State.prototype.syntaxChoice = function (index, choices) {
  ...
  if (!__isArray(choices)) {
    ...
    for (_tmp = 0, _tmp2 = choices.length; _tmp < _tmp2; ++_tmp) {
      if (!(choices[_tmp] instanceof Object)) {
        throw TypeError("Expected choices[" + _tmp + "] to be a Object, got " + __typeof(choices[_tmp]));
      }
    }
  }
...
State.prototype.callChain = function (index, head, links) {
  ...
  if (!__isArray(links)) {
    ...
    for (_tmp = 0, _tmp2 = links.length; _tmp < _tmp2; ++_tmp) {
      if (!(links[_tmp] instanceof Object)) {
        throw TypeError("Expected links[" + _tmp + "] to be a Object, got " + __typeof(links[_tmp]));
      }
    }
  }
...
State.prototype.block = function (index, nodes) {
  ...
  if (!__isArray(nodes)) {
    ...
    for (_tmp = 0, _tmp2 = nodes.length; _tmp < _tmp2; ++_tmp) {
      if (!(nodes[_tmp] instanceof Object)) {
        throw TypeError("Expected nodes[" + _tmp + "] to be a Object, got " + __typeof(nodes[_tmp]));
      }
    }
  }
...
State.prototype.tmp = function (index, id) {
  if (typeof index !== "number") {
    throw TypeError("Expected index to be a Number, got " + __typeof(index));
  }
  if (typeof id !== "number") {
  ...
  return ParserNode("tmp", index, this.index, { id: id });
};
