(function (GLOBAL) {
  ...
  var __bind, __cmp, __compose, __create, __curry, __defer,
      ...
      ArrayType, AssignmentAsExpression, AssignNode, Ast, AsterixChar,
      AstExpression, AstPosition, AstStatement, AtSignChar, BackslashChar,
      ...
      BodyWithIndent, BOM, Box, BracketedObjectKey, cache, CallNode, CaretChar,
      Cascade, CascadePart, CascadePartWithCascade, CheckPeriodNotDoublePeriod,
      ...
      ConstantLiteral, ConstantLiteralAccessPart, ConstObjectKey,
      convertInvocationOrAccess, CountIndent, CurrentArrayLength,
      CustomOperatorCloseParenthesis, DecimalDigit, DecimalNumber, DedentedBody,
      DefineConstLiteral, DefineHelper, DefineMacro, DefineOperator,
      DefineSyntax, disallowEmbeddedText, DollarSign, DollarSignChar,
      ...
      KeyValuePair, KvpParameter, LCall, LessThan, LessThanChar, Letter,
      LicenseComment, Line, LInternalCall, LispyNode, Literal, Logic, LSymbol,
      LValue, MacroAccessNode, MacroBody, MacroConstNode, MacroContext,
      ...
      TypeObjectNode, TypeReference, TypeUnionNode, UnaryNode,
  ...
  DoubleStringArrayLiteral = cache((_ref = sequential(
    ...
    return LInternalCall.apply(void 0, ["array", index, parser.scope].concat(__toArray(stringParts)));
  })(_ref)));
  ...
  IdentifierOrSimpleAccessStart = oneOf(
    ...
    (_ref = sequential(
      ...
      return parser.Access(
        index,
        parser.Access(index, parent, LValue(index, "prototype")),
        child
      );
    })(_ref)),
    (_ref = sequential(
  ...
  IdentifierOrSimpleAccessPart = mutate(function (_p, parser, childIndex) {
    ...
    return function (parent, parser, index) {
      return parser.Access(
        index,
        isProto
          ? parser.Access(index, parent, LValue(childIndex, "prototype"))
          : parent,
        child
      );
    };
  ...
  ArrayParameter = mutate(function (params, parser, index) {
    return LInternalCall.apply(void 0, ["array", index, parser.scope].concat(__toArray(params)));
  })(_ref);
  ...
  function makeObjectNode(parser, index, prototype, pairs) {
    ...
    return LInternalCall.apply(void 0, [
      ...
      index,
      parser.scope,
      prototype || NothingNode(index, parser.scope)
    ].concat((function () {
  ...
  ParameterSequence = mutate((function () {
    function checkParam(param, parser, names) {
      ...
      } else if (param instanceof LispyNode && param.isCall && param.func.isSymbol && param.func.isInternal) {
  ...
  ArrayLiteral = cache(preventUnclosedObjectLiteral((_ref = sequential(
    ...
    return LInternalCall.apply(void 0, ["array", index, parser.scope].concat(__toArray(items)));
  })(_ref))));
        ...
        indexTypes = {
          multi: function (parser, index, child) {
            return function (parent) {
              ...
              result = LInternalCall.apply(void 0, ["array", index, parser.scope].concat((function () {
      ...
      function (parser, index) {
        ...
        for (; ; ++currentIndex) {
          ...
          if (ch === 42 && source.charCodeAt(currentIndex + 1) === 47) {
            ...
            return Box(currentIndex + 2, LInternalCall("comment", index, parser.scope, LValue(index, result.join(""))));
        ...
        case 6:
          ...
          return {
            ...
            value: Box(currentIndex, parser.Block(index, __toArray(nodes).concat([
              LInternalCall("return", index, parser.scope, parser.Ident(index, "write"))
            ])))
          };
        case 7:
          return { done: true, value: void 0 };
  ...
  Parser = (function () {
    ...
    function makeMacroRoot(index, params, body) {
      return this.Root(index, void 0, LInternalCall("return", index, this.scope, this.Function(
        index,
        [
          params,
          this.Param(
    ...
    macroSyntaxTypes = {
      syntax: function (index, params, body, options, stateOptions, translator) {
        ...
        body = this.Block(index, [
          LispyNode.InternalCall("var", index, scope, macroNameIdent),
          this.Assign(index, macroNameIdent, "=", this.Access(index, macroFullDataIdent, LValue(index, "macroName"))),
          LispyNode.InternalCall("var", index, scope, macroDataIdent),
          this.Assign(index, macroDataIdent, "=", this.Access(index, macroFullDataIdent, LValue(index, "macroData")))
        ].concat(
          (function () {
            var _arr, _arr2, _i, _len, param;
            for (_arr = [], _arr2 = __toArray(params), _i = 0, _len = _arr2.length; _i < _len; ++_i) {
              ...
              if (param instanceof SyntaxParamNode) {
                ...
                _arr.push(_this.Block(index, [
                  ...
                  _this.Assign(index, param.ident, "=", _this.Access(index, macroDataIdent, LValue(index, param.ident.name)))
                ]));
              }
            }
            return _arr;
            ...
            for (_arr = [], _arr2 = __toArray(params), i = 0, _len = _arr2.length; i < _len; ++i) {
              ...
              if (param instanceof ParamNode) {
                ...
                _arr.push(_this.Block(index, [
                  ...
                  _this.Assign(index, param.ident, "=", _this.Access(index, macroDataIdent, LValue(index, i)))
                ]));
              }
            }
            return _arr;
        ...
        body = this.Block(index, (function () {
          ...
          for (_arr = [], _arr2 = ["left", "op", "right"], _i = 0, _len = _arr2.length; _i < _len; ++_i) {
            ...
            _arr.push(_this.Block(index, [
              ...
              _this.Assign(index, ident, "=", _this.Access(index, macroDataIdent, LValue(index, name)))
            ]));
          }
          return _arr;
        }()).concat([body]));
