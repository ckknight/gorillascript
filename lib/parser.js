(function () {
  ...
  MacroHelper = (function () {
    ...
    _MacroHelper_prototype.isLabelledBlock = function (node) {
    ...
    _MacroHelper_prototype.withLabel = function (node, label) {
      ...
      node = this.macroExpand1(node);
      if (typeof node.withLabel !== "function") {
        throw TypeError("Cannot add a label to " + __typeof(node));
      }
      return node.withLabel(label);
    };
  ...
  Node.Block = BlockNode = (function (Node) {
    ...
    _BlockNode_prototype.withLabel = function (label) {
      if (label == null) {
        label = null;
      } else if (!(label instanceof IdentNode) && !(label instanceof TmpNode)) {
        throw TypeError("Expected label to be an IdentNode or TmpNode or null, got " + __typeof(label));
    ...
    _BlockNode_prototype.walkAsync = function (f, callback) {
      ...
      return mapAsync(this.nodes, f, function (_e, nodes) {
        ...
        return callback(null, nodes !== _this.nodes
          ? BlockNode(
            _this.startIndex,
            _this.endIndex,
            _this.scopeId,
    ...
    _BlockNode_prototype.inspect = function (depth) {
      return "BlockNode(" + inspect(this.nodes, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.label, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return BlockNode;
  }(Node));
  Node.Break = BreakNode = (function (Node) {
    ...
    _BreakNode_prototype.inspect = function (depth) {
      return "BreakNode(" + inspect(this.label, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return BreakNode;
  }(Node));
  ...
  Node.Continue = ContinueNode = (function (Node) {
    ...
    _ContinueNode_prototype.inspect = function (depth) {
      return "ContinueNode(" + inspect(this.label, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return ContinueNode;
  }(Node));
  ...
  Node.For = ForNode = (function (Node) {
    ...
    _ForNode_prototype.inspect = function (depth) {
      return "ForNode(" + inspect(this.init, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.test, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.step, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.body, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.label, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return ForNode;
  }(Node));
  Node.ForIn = ForInNode = (function (Node) {
    ...
    _ForInNode_prototype.inspect = function (depth) {
      return "ForInNode(" + inspect(this.key, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.object, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.body, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.label, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return ForInNode;
  }(Node));
  ...
  Node.If = IfNode = (function (Node) {
    ...
    _IfNode_prototype.inspect = function (depth) {
      return "IfNode(" + inspect(this.test, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.whenTrue, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.whenFalse, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.label, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return IfNode;
  }(Node));
  ...
  Node.Switch = SwitchNode = (function (Node) {
    ...
    _SwitchNode_prototype.inspect = function (depth) {
      return "SwitchNode(" + inspect(this.node, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.cases, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.defaultCase, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.label, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return SwitchNode;
  }(Node));
  ...
  Node.TryCatch = TryCatchNode = (function (Node) {
    ...
    _TryCatchNode_prototype.inspect = function (depth) {
      return "TryCatchNode(" + inspect(this.tryBody, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.catchIdent, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.catchBody, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.label, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return TryCatchNode;
  }(Node));
  Node.TryFinally = TryFinallyNode = (function (Node) {
    ...
    _TryFinallyNode_prototype.inspect = function (depth) {
      return "TryFinallyNode(" + inspect(this.tryBody, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.finallyBody, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.label, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return TryFinallyNode;
  }(Node));
