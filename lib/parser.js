(function (GLOBAL) {
  ...
  var __bind, __cmp, __compose, __create, __curry, __defer,
      ...
      Body, BodyNoEnd, BodyNoIndent, BodyNoIndentNoEnd, BodyWithIndent, BOM,
      Box, BracketedObjectKey, cache, CallNode, CaretChar, Cascade, CascadePart,
  ...
  function _BlockMutator(lines, parser, index) {
    var _arr, _arr2, _arr3, _i, _len, _len2, _len3, arg, i, item, j, nodes,
        part;
    nodes = [];
    for (_arr = __toArray(lines), i = 0, _len = _arr.length; i < _len; ++i) {
      ...
      for (_arr2 = __toArray(item), j = 0, _len2 = _arr2.length; j < _len2; ++j) {
        ...
        } else if (part instanceof LispyNode && part.isCall && part.func.isSymbol && part.func.isInternal && part.func.isBlock && part.args[0] instanceof NothingNode) {
          for (_arr3 = __toArray(part.args), _i = 1, _len3 = _arr3.length; _i < _len3; ++_i) {
            arg = _arr3[_i];
            nodes.push(arg);
          }
        } else if (!(part instanceof NothingNode)) {
      ...
      while (true) {
        ...
        case 6:
          ...
          return {
            ...
            value: Box(currentIndex, LInternalCall.apply(void 0, [
              "block",
              index,
              parser.scope.peek(),
              NothingNode(index, parser.scope.peek())
