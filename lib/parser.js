(function () {
  ...
  Stack = (function () {
    ...
    function Stack(initial, data) {
      ...
      if (this instanceof Stack) {
        ...
        _this = __create(_Stack_prototype);
      }
        ...
        if ((_ref = digitCache[radix]) == null) {
          return digitCache[radix] = (function () {
            ...
            default:
              ...
              for (i = 10, _end = __num(radix) > 36 ? __num(radix) : 36; i < _end; ++i) {
                chars[i - 10 + 97] = true;
                chars[i - 10 + 65] = true;
              }
              digit = function (o) {
  ...
  ConstObjectKey = cache(named("ConstObjectKey", (function () {
    var _rule;
    _rule = (function () {
      function _mutator(x, o, i) {
  ...
  ObjectTypePair = cache(named("ObjectTypePair", function (o) {
    var clone, result;
    clone = o.clone();
    result = {};
  ...
  MacroBody = cache(named("MacroBody", (function () {
    ...
    function _rule2(o) {
      var _arr, _i, _len, body, clone, i, options, param, params;
      i = o.index;
      clone = o.clone(o.cloneScope());
  ...
  Index = cache(named("Index", IndexMultiple));
    ...
    return function (precedence) {
      ...
      if ((_ref = precedenceCache[precedence]) == null) {
        return precedenceCache[precedence] = cache(function (o) {
          var _arr, _i, _i2, _len, _len2, binaryOperators, clone, current, head, inverted, j, line, nextRule, node, op, operator, operators, part, rule, startIndex, tail;
          startIndex = o.index;
          line = o.line;
                ...
                for (_arr = __toArray(operators), _i = 0, _len = _arr.length; _i < _len; ++_i) {
                  ...
                  if (tail.length) {
                    if (!operator.rightToLeft) {
                      current = head;
                      for (_i2 = 0, _len2 = tail.length; _i2 < _len2; ++_i2) {
                        part = tail[_i2];
                      ...
                      current = tail[tail.length - 1].node;
                      for (j = tail.length - 1; j > 0; --j) {
                        current = operator.func(
                          { left: tail[j - 1].node, inverted: tail[j].inverted, op: tail[j].op, right: current },
                          o,
                          startIndex,
                          line
                        );
  ...
  ParserError = (function (Error) {
    ...
    function ParserError(message, text, index, line) {
      ...
      if (this instanceof ParserError) {
        ...
        _this = __create(_ParserError_prototype);
      }
  ...
  MacroError = (function (Error) {
    ...
    function MacroError(inner, text, index, line) {
      ...
      if (this instanceof MacroError) {
        _this = this;
      } else {
        _this = __create(_MacroError_prototype);
      }
  ...
  FailureManager = (function () {
    ...
    function FailureManager() {
      ...
      if (this instanceof FailureManager) {
        ...
        _this = __create(_FailureManager_prototype);
      }
      _this.messages = [];
      _this.index = 0;
      _this.line = 0;
  ...
  nodeToType = (function () {
    ...
    return function (node) {
      ...
      if (node instanceof IdentNode) {
        return (__owns(identToType, _ref = node.name) ? identToType[_ref] : void 0) || Type.any;
        ...
        current = nodeToType(node.types[0]);
        for (_arr = __toArray(__slice(node.types, 1)), _i = 0, _len = _arr.length; _i < _len; ++_i) {
          type = _arr[_i];
  ...
  MacroHelper = (function () {
    ...
    function MacroHelper(state, index, position, inGenerator) {
      ...
      if (this instanceof MacroHelper) {
        ...
        _this = __create(_MacroHelper_prototype);
      }
      _this.unsavedTmps = [];
      _this.savedTmps = [];
      _this.state = state;
    ...
    _MacroHelper_prototype.object = function (pairs) {
      ...
      for (i = 0, _len = pairs.length; i < _len; ++i) {
        ...
        if (!pair || typeof pair !== "object") {
          throw Error("Expected an object at index #" + i + ", got " + __typeof(pair));
        } else if (!(pair.key instanceof Node)) {
          throw Error("Expected an object with Node 'key' at index #" + i + ", got " + __typeof(pair.key));
        } else if (!(pair.value instanceof Node)) {
          throw Error("Expected an object with Node 'value' at index #" + i + ", got " + __typeof(pair.value));
        }
      }
    ...
    _MacroHelper_prototype.type = function (node) {
      ...
      if (typeof node === "string") {
        return (__owns(Type, node) ? Type[node] : void 0) || (function () {
      ...
      Block: function (x, func) {
        ...
        if (len !== 0) {
          ...
          if (lastNode !== nodes[__num(len) - 1]) {
            return BlockNode(x.startIndex, x.endIndex, x.scopeId, __slice(nodes, 0, -1).concat([lastNode]));
          }
        }
        return x;
      },
    ...
    _MacroHelper_prototype.mutateLast = function (node, func, includeNoop) {
      ...
      if (!__owns(mutators, node.constructor.cappedName) || includeNoop && node instanceof NothingNode) {
    ...
    _MacroHelper_prototype.canMutateLast = function (node) {
      return node instanceof Node && __owns(mutators, node.constructor.cappedName);
    };
    return MacroHelper;
  }());
  ...
  MacroHolder = (function () {
    ...
    function MacroHolder() {
      ...
      if (this instanceof MacroHolder) {
        ...
        _this = __create(_MacroHolder_prototype);
      }
      _this.byName = {};
      _this.byId = [];
      _this.byLabel = {};
  ...
  Scope = (function () {
    ...
    function Scope(id, parent) {
      ...
      if (this instanceof Scope) {
        ...
        _this = __create(_Scope_prototype);
      }
      _this.id = id;
      _this.parent = parent;
      _this.variables = {};
    ...
    function get(ident) {
      if (ident instanceof TmpNode) {
        if (__owns(this.tmps, ident.id)) {
          return this.tmps[ident.id];
        } else if (this.parent != null) {
          return get.call(this.parent, ident);
        }
      } else if (__owns(this.variables, ident.name)) {
  ...
  State = (function () {
    ...
    function State(data, macros, options, index, line, failures, cache, indent, currentMacro, preventFailures, knownScopes, scope) {
      ...
      if (this instanceof State) {
        ...
        _this = __create(_State_prototype);
      }
      _this.data = data;
      _this.macros = macros;
    ...
    function handleParams(params) {
      ...
      for (_arr = __toArray(params), _i = 0, _len = _arr.length; _i < _len; ++_i) {
        ...
        if (param.isConst()) {
          ...
          sequence.push((__owns(macroSyntaxConstLiterals, string) ? macroSyntaxConstLiterals[string] : void 0) || wordOrSymbol(string));
        } else if (param instanceof SyntaxParamNode) {
          ident = param.ident;
          if (ident instanceof IdentNode) {
            key = ident.name;
  ...
  Node.Access = AccessNode = (function (Node) {
    ...
    function AccessNode(startIndex, endIndex, scopeId, parent, child) {
      ...
      if (this instanceof AccessNode) {
        ...
        _this = __create(_AccessNode_prototype);
      }
    ...
    _AccessNode_prototype._reduce = function (o) {
      var _ref, call, child, cValue, end, inclusive, parent, pValue, start, step, value;
      ...
      if (child instanceof CallNode && child.func instanceof IdentNode && child.func.name === "__range") {
        ...
        call = CallNode(
          ...
          this.endIndex,
          this.scopeId,
          IdentNode(this.startIndex, this.endIndex, this.scopeId, "__slice"),
          [parent, start].concat(end.isConst() && end.constValue() === 1/0 ? []
            : inclusive.isConst()
            ? (inclusive.constValue()
              ? (end.isConst() && typeof end.constValue() === "number" && end.constValue() === -1 ? []
                : [
                  BinaryNode(
                    this.startIndex,
                    this.endIndex,
                    ...
                    BinaryNode(
                      ...
                      "+",
                      ConstNode(this.startIndex, this.endIndex, this.scopeId, 1)
                    ),
                    "||",
                    ConstNode(this.startIndex, this.endIndex, this.scopeId, 1/0)
                  )
                ])
              : [end])
            : [
        ...
        if (step.isConst() && step.constValue() === 1) {
          return call;
        } else {
          return CallNode(
            this.startIndex,
            this.endIndex,
            this.scopeId,
            IdentNode(this.startIndex, this.endIndex, this.scopeId, "__step"),
            [call, step],
            false,
            false
          );
  ...
  Node.AccessIndex = AccessIndexNode = (function (Node) {
    ...
    function AccessIndexNode(startIndex, endIndex, scopeId, parent, child) {
      ...
      if (!__isObject(child)) {
        throw TypeError("Expected child to be an Object, got " + __typeof(child));
      }
      if (this instanceof AccessIndexNode) {
        _this = this;
      } else {
        _this = __create(_AccessIndexNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
    ...
    _AccessIndexNode_prototype.type = function () {
      return Type.array;
    };
  ...
  Node.Args = ArgsNode = (function (Node) {
    ...
    function ArgsNode(startIndex, endIndex, scopeId) {
      ...
      if (this instanceof ArgsNode) {
        ...
        _this = __create(_ArgsNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Array = ArrayNode = (function (Node) {
    ...
    function ArrayNode(startIndex, endIndex, scopeId, elements) {
      ...
      if (this instanceof ArrayNode) {
        ...
        _this = __create(_ArrayNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Assign = AssignNode = (function (Node) {
    ...
    function AssignNode(startIndex, endIndex, scopeId, left, op, right) {
      ...
      if (this instanceof AssignNode) {
        ...
        _this = __create(_AssignNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Binary = BinaryNode = (function (Node) {
    ...
    function BinaryNode(startIndex, endIndex, scopeId, left, op, right) {
      ...
      if (this instanceof BinaryNode) {
        ...
        _this = __create(_BinaryNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Block = BlockNode = (function (Node) {
    ...
    function BlockNode(startIndex, endIndex, scopeId, nodes) {
      ...
      if (this instanceof BlockNode) {
        ...
        _this = __create(_BlockNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Break = BreakNode = (function (Node) {
    ...
    function BreakNode(startIndex, endIndex, scopeId) {
      ...
      if (this instanceof BreakNode) {
        ...
        _this = __create(_BreakNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Call = CallNode = (function (Node) {
    ...
    function CallNode(startIndex, endIndex, scopeId, func, args, isNew, isApply) {
      ...
      if (this instanceof CallNode) {
        ...
        _this = __create(_CallNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Const = ConstNode = (function (Node) {
    ...
    function ConstNode(startIndex, endIndex, scopeId, value) {
      ...
      if (this instanceof ConstNode) {
        ...
        _this = __create(_ConstNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Continue = ContinueNode = (function (Node) {
    ...
    function ContinueNode(startIndex, endIndex, scopeId) {
      ...
      if (this instanceof ContinueNode) {
        ...
        _this = __create(_ContinueNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Debugger = DebuggerNode = (function (Node) {
    ...
    function DebuggerNode(startIndex, endIndex, scopeId) {
      ...
      if (this instanceof DebuggerNode) {
        ...
        _this = __create(_DebuggerNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Def = DefNode = (function (Node) {
    ...
    function DefNode(startIndex, endIndex, scopeId, left, right) {
      ...
      if (this instanceof DefNode) {
        ...
        _this = __create(_DefNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Eval = EvalNode = (function (Node) {
    ...
    function EvalNode(startIndex, endIndex, scopeId, code) {
      ...
      if (this instanceof EvalNode) {
        ...
        _this = __create(_EvalNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.For = ForNode = (function (Node) {
    ...
    function ForNode(startIndex, endIndex, scopeId, init, test, step, body) {
      ...
      if (this instanceof ForNode) {
        ...
        _this = __create(_ForNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.ForIn = ForInNode = (function (Node) {
    ...
    function ForInNode(startIndex, endIndex, scopeId, key, object, body) {
      ...
      if (this instanceof ForInNode) {
        ...
        _this = __create(_ForInNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Function = FunctionNode = (function (Node) {
    ...
    function FunctionNode(startIndex, endIndex, scopeId, params, body, autoReturn, bound, asType, generator) {
      ...
      if (this instanceof FunctionNode) {
        ...
        _this = __create(_FunctionNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Ident = IdentNode = (function (Node) {
    ...
    function IdentNode(startIndex, endIndex, scopeId, name) {
      ...
      if (this instanceof IdentNode) {
        ...
        _this = __create(_IdentNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.If = IfNode = (function (Node) {
    ...
    function IfNode(startIndex, endIndex, scopeId, test, whenTrue, whenFalse) {
      ...
      if (this instanceof IfNode) {
        ...
        _this = __create(_IfNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.MacroAccess = MacroAccessNode = (function (Node) {
    ...
    function MacroAccessNode(startIndex, endIndex, scopeId, id, line, data, position, inGenerator) {
      ...
      if (this instanceof MacroAccessNode) {
        ...
        _this = __create(_MacroAccessNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Nothing = NothingNode = (function (Node) {
    ...
    function NothingNode(startIndex, endIndex, scopeId) {
      ...
      if (this instanceof NothingNode) {
        ...
        _this = __create(_NothingNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Object = ObjectNode = (function (Node) {
    ...
    function ObjectNode(startIndex, endIndex, scopeId, pairs, prototype) {
      ...
      if (this instanceof ObjectNode) {
        ...
        _this = __create(_ObjectNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Param = ParamNode = (function (Node) {
    ...
    function ParamNode(startIndex, endIndex, scopeId, ident, defaultValue, spread, isMutable, asType) {
      ...
      if (this instanceof ParamNode) {
        ...
        _this = __create(_ParamNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Regexp = RegexpNode = (function (Node) {
    ...
    function RegexpNode(startIndex, endIndex, scopeId, text, flags) {
      ...
      if (this instanceof RegexpNode) {
        ...
        _this = __create(_RegexpNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Return = ReturnNode = (function (Node) {
    ...
    function ReturnNode(startIndex, endIndex, scopeId, node) {
      ...
      if (this instanceof ReturnNode) {
        ...
        _this = __create(_ReturnNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Root = RootNode = (function (Node) {
    ...
    function RootNode(startIndex, endIndex, scopeId, body) {
      ...
      if (this instanceof RootNode) {
        ...
        _this = __create(_RootNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Spread = SpreadNode = (function (Node) {
    ...
    function SpreadNode(startIndex, endIndex, scopeId, node) {
      ...
      if (this instanceof SpreadNode) {
        ...
        _this = __create(_SpreadNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  State.prototype.string = function (index, parts) {
    ...
    if (parts.length === 0) {
      ...
      current = parts[0];
      for (_arr = __toArray(__slice(parts, 1)), _i = 0, _len = _arr.length; _i < _len; ++_i) {
        part = _arr[_i];
  ...
  Node.Super = SuperNode = (function (Node) {
    ...
    function SuperNode(startIndex, endIndex, scopeId, child, args) {
      ...
      if (this instanceof SuperNode) {
        ...
        _this = __create(_SuperNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Switch = SwitchNode = (function (Node) {
    ...
    function SwitchNode(startIndex, endIndex, scopeId, node, cases, defaultCase) {
      ...
      if (this instanceof SwitchNode) {
        ...
        _this = __create(_SwitchNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.SyntaxChoice = SyntaxChoiceNode = (function (Node) {
    ...
    function SyntaxChoiceNode(startIndex, endIndex, scopeId, choices) {
      ...
      if (this instanceof SyntaxChoiceNode) {
        ...
        _this = __create(_SyntaxChoiceNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.SyntaxMany = SyntaxManyNode = (function (Node) {
    ...
    function SyntaxManyNode(startIndex, endIndex, scopeId, inner, multiplier) {
      ...
      if (this instanceof SyntaxManyNode) {
        ...
        _this = __create(_SyntaxManyNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.SyntaxParam = SyntaxParamNode = (function (Node) {
    ...
    function SyntaxParamNode(startIndex, endIndex, scopeId, ident, asType) {
      ...
      if (this instanceof SyntaxParamNode) {
        ...
        _this = __create(_SyntaxParamNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.SyntaxSequence = SyntaxSequenceNode = (function (Node) {
    ...
    function SyntaxSequenceNode(startIndex, endIndex, scopeId, params) {
      ...
      if (this instanceof SyntaxSequenceNode) {
        ...
        _this = __create(_SyntaxSequenceNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.This = ThisNode = (function (Node) {
    ...
    function ThisNode(startIndex, endIndex, scopeId) {
      ...
      if (this instanceof ThisNode) {
        ...
        _this = __create(_ThisNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Throw = ThrowNode = (function (Node) {
    ...
    function ThrowNode(startIndex, endIndex, scopeId, node) {
      ...
      if (this instanceof ThrowNode) {
        ...
        _this = __create(_ThrowNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Tmp = TmpNode = (function (Node) {
    ...
    function TmpNode(startIndex, endIndex, scopeId, id, name, _type) {
      ...
      if (this instanceof TmpNode) {
        ...
        _this = __create(_TmpNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.TmpWrapper = TmpWrapperNode = (function (Node) {
    ...
    function TmpWrapperNode(startIndex, endIndex, scopeId, node, tmps) {
      ...
      if (this instanceof TmpWrapperNode) {
        ...
        _this = __create(_TmpWrapperNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.TryCatch = TryCatchNode = (function (Node) {
    ...
    function TryCatchNode(startIndex, endIndex, scopeId, tryBody, catchIdent, catchBody) {
      ...
      if (this instanceof TryCatchNode) {
        ...
        _this = __create(_TryCatchNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.TryFinally = TryFinallyNode = (function (Node) {
    ...
    function TryFinallyNode(startIndex, endIndex, scopeId, tryBody, finallyBody) {
      ...
      if (this instanceof TryFinallyNode) {
        ...
        _this = __create(_TryFinallyNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.TypeArray = TypeArrayNode = (function (Node) {
    ...
    function TypeArrayNode(startIndex, endIndex, scopeId, subtype) {
      ...
      if (this instanceof TypeArrayNode) {
        ...
        _this = __create(_TypeArrayNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.TypeFunction = TypeFunctionNode = (function (Node) {
    ...
    function TypeFunctionNode(startIndex, endIndex, scopeId, returnType) {
      ...
      if (this instanceof TypeFunctionNode) {
        _this = this;
      } else {
        _this = __create(_TypeFunctionNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.TypeObject = TypeObjectNode = (function (Node) {
    ...
    function TypeObjectNode(startIndex, endIndex, scopeId, pairs) {
      ...
      if (this instanceof TypeObjectNode) {
        _this = this;
      } else {
        _this = __create(_TypeObjectNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
    ...
    _TypeObjectNode_prototype.inspect = function (depth) {
      return "TypeObjectNode(" + inspect(this.pairs, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
  ...
  Node.TypeUnion = TypeUnionNode = (function (Node) {
    ...
    function TypeUnionNode(startIndex, endIndex, scopeId, types) {
      ...
      if (this instanceof TypeUnionNode) {
        ...
        _this = __create(_TypeUnionNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
  ...
  Node.Unary = UnaryNode = (function (Node) {
    ...
    function UnaryNode(startIndex, endIndex, scopeId, op, node) {
      ...
      if (this instanceof UnaryNode) {
        ...
        _this = __create(_UnaryNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
    ...
    _UnaryNode_prototype._isNoop = function (o) {
      var _ref, _ref2;
      if ((_ref = this.__isNoop) == null) {
        return this.__isNoop = (_ref2 = this.op) !== "++" && _ref2 !== "--" && _ref2 !== "delete" && this.node.isNoop(o);
      } else {
        return _ref;
      }
    };
  ...
  Node.Var = VarNode = (function (Node) {
    ...
    function VarNode(startIndex, endIndex, scopeId, ident, isMutable) {
      ...
      if (this instanceof VarNode) {
        ...
        _this = __create(_VarNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
    ...
    _VarNode_prototype.inspect = function (depth) {
      return "VarNode(" + inspect(this.ident, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ", " + inspect(this.isMutable, null, typeof depth !== "undefined" && depth !== null ? depth - 1 : null) + ")";
    };
    return VarNode;
  }(Node));
  Node.Yield = YieldNode = (function (Node) {
    ...
    function YieldNode(startIndex, endIndex, scopeId, node) {
      ...
      if (this instanceof YieldNode) {
        ...
        _this = __create(_YieldNode_prototype);
      }
      _this.startIndex = startIndex;
      _this.endIndex = endIndex;
      _this.scopeId = scopeId;
