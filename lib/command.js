(function () {
  "use strict";
  var __async, __create, __import, __isArray, __num, __once, __owns, __slice, __strnum, __toArray, __typeof, _once, _this, child_process, cli, fs, gorilla, path, util;
  _this = this;
  ...
  child_process.exec("which gjs", (_once = false, function (err, whichGjsStdout, whichGjsStderr) {
    ...
    return cli.main((_once2 = false, function (filenames, options) {
      ...
      if (options["no-prelude"]) {
        ...
        _f = function (next) {
          var _once3;
          return gorilla.init({ lang: lang }, (_once3 = false, function (_e) {
            if (_once3) {
              throw Error("Attempted to call function more than once");
            } else {
              _once3 = true;
      ...
      return _f(function () {
        ...
        function handleCode(code, callback) {
          ...
          if (options.ast) {
            ...
            _f = function (next) {
              var _once3;
              return gorilla["eval"](code, opts, (_once3 = false, function (_e, result) {
                if (_once3) {
                  throw Error("Attempted to call function more than once");
                } else {
                  _once3 = true;
