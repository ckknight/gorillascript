(function () {
  "use strict";
  var __async, __create, __import, __isArray, __num, __once, __owns, __slice, __strnum, __toArray, __typeof, _this, child_process, cli, fs, gorilla, path, util;
  _this = this;
  ...
  child_process.exec("which gjs", __once(function (err, whichGjsStdout, whichGjsStderr) {
    var hasGjs, parseOptions;
    hasGjs = err == null && whichGjsStdout.length && !whichGjsStderr.length;
    cli.enable("version");
    cli.setApp("gorilla", "0.5.2");
    ...
    return cli.main(__once(function (filenames, options) {
      var _f, lang, opts;
      lang = "js";
      opts = {};
      if (options.uglify) {
      ...
      if (options["no-prelude"]) {
        ...
        _f = function (next) {
          return gorilla.init({ lang: lang }, __once(function (_e) {
            if (_e != null) {
              throw _e;
            }
            return next();
      ...
      return _f(function () {
        ...
        function handleCode(code, callback) {
          ...
          if (options.ast) {
            _f = function (next) {
              return gorilla.ast(code, opts, __once(function (_e, ast) {
                if (_e != null) {
                  return next(_e);
                }
            ...
            _f = function (next) {
              return gorilla.parse(code, opts, __once(function (_e, nodes) {
                if (_e != null) {
                  return next(_e);
                }
            ...
            _f = function (next) {
              return gorilla.compile(code, opts, __once(function (_e, result) {
                if (_e != null) {
                  return next(_e);
                }
                if (opts.uglify) {
            ...
            _f = function (next) {
              return gorilla["eval"](code, opts, __once(function (_e, result) {
                if (_e != null) {
                  return next(_e);
                }
        ...
        if (options.ast && options.compile) {
          ...
          return __async(
            ...
            function (_i, next) {
              ...
              return fs.readFile(filename, __once(function (_e, code) {
                if (_e != null) {
                  return next(_e);
                }
            ...
            function (err) {
              ...
              function handleSingle(filename, code, done) {
                ...
                if (options.compile) {
                  ...
                  startTime = Date.now();
                  return gorilla.compile(code, opts, __once(function (_e, compilation) {
                    var endTime;
                    if (_e != null) {
                      return done(_e);
                    }
              ...
              if (!options.join) {
                ...
                _f = function (next) {
                  ...
                  return gorilla.compile(
                    ...
                    opts,
                    __once(function (_e, compilation) {
                      if (_e != null) {
                        throw _e;
                      }
              ...
              return _f(function () {
                ...
                function writeSingle(filename, done) {
                  ...
                  return fs.exists(jsDir, __once(function (exists) {
                    var _f;
                    if (!exists) {
                      _f = function (next) {
                        return child_process.exec("mkdir -p " + __strnum(jsDir), __once(function () {
                          return next();
                        }));
                      };
                    } else {
                    ...
                    return _f(function () {
                      ...
                      return fs.writeFile(jsPath, jsCode, "utf8", __once(function (_e) {
                        if (_e != null) {
                          return done(_e);
                        }
                        return done();
                  ...
                  _f = function (next) {
                    ...
                    if (!options.join) {
                      ...
                      _f = function (next) {
                        ...
                        return fs.writeFile(jsPath, compiled.join, "utf8", __once(function (_e) {
                          if (_e != null) {
                            throw _e;
                          }
                          return next();
                ...
                return _f(function () {
                  ...
                  if (sourcemap != null) {
                    _f = function (next) {
                      return fs.writeFile(options.sourcemap, opts.sourcemap.toString(), "utf8", __once(function (_e) {
                        if (_e != null) {
                          throw _e;
                        }
                        return next();
                    ...
                    if (options.watch) {
                      ...
                      handleQueue = (function () {
                        ...
                        return function () {
                          ...
                          if (bestName != null) {
                            ...
                            return handleSingle(bestName, input[bestName], __once(function (_e) {
                              if (_e != null) {
                                throw _e;
                              }
                              return writeSingle(bestName, __once(function (_e2) {
                                if (_e2 != null) {
                                  throw _e2;
                                }
                                inHandle = false;
                      ...
                      for (_arr = __toArray(filenames), _i = 0, _len = _arr.length, _f = function (filename) {
                        return fs.watch(filename, function (event, name) {
                          ...
                          fs.readFile(name, __once(function (err, code) {
