  ...
  child_process.exec("which gjs", (_once = false, function (err, whichGjsStdout, whichGjsStderr) {
    ...
    return cli.main(function (filenames, options) {
      ...
      __generatorToPromise((function () {
        ...
        function _throw(_e) {
          if (_state === 0 || _state === 1 || _state === 2 || _state === 3 || _state === 4 || _state === 5 || _state === 6 || _state === 7 || _state === 8 || _state === 9 || _state === 10 || _state === 11 || _state === 12 || _state === 13 || _state === 14 || _state === 15 || _state === 16 || _state === 17 || _state === 18 || _state === 19 || _state === 20 || _state === 21 || _state === 22 || _state === 23 || _state === 24 || _state === 25 || _state === 26 || _state === 27 || _state === 28 || _state === 29 || _state === 30 || _state === 31 || _state === 32 || _state === 33 || _state === 34 || _state === 35 || _state === 36 || _state === 37 || _state === 38 || _state === 39 || _state === 40 || _state === 41 || _state === 42 || _state === 43 || _state === 44 || _state === 45 || _state === 46 || _state === 47 || _state === 48 || _state === 49 || _state === 50) {
            e = _e;
            _state = 51;
          } else {
            _close();
