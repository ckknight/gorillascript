(function () {
  "use strict";
  var __async, __create, __import, __isArray, __num, __once, __owns, __slice, __strnum, __toArray, __typeof, child_process, cli, fs, gorilla, path, util;
  ...
  child_process.exec("which gjs", function (err, whichGjsStdout, whichGjsStderr) {
    ...
    return cli.main(function (filenames, options) {
      ...
      if (options["no-prelude"]) {
        ...
        _f = function (next) {
          return gorilla.init({ lang: lang }, function (err) {
            if (err != null) {
              throw err;
            }
            return next();
          ...
          return __async(
            ...
            function (err) {
              ...
              return _f(function () {
                ...
                if (sourcemap != null) {
                  return fs.writeFile(options.sourcemap, opts.sourcemap.toString(), "utf8", function (err) {
                    if (err) {
                      return cli.error(err.toString());
                    }
                  });
