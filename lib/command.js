(function () {
  "use strict";
  var __async, __create, __num, __strnum, __typeof, child_process, cli, fs, gorilla, path, util;
      ...
      function handleCode(code, callback) {
        ...
        if (options.ast) {
          return gorilla.ast(code, opts, function (_e, ast) {
            ...
            return next(null, util.inspect(ast, false, null));
          });
          ...
          return gorilla.compile(code, opts, function (_e) {
            if (_e != null) {
              return next(_e);
            }
            return next(null, "");
            ...
            return __async(
              ...
              function (_i, next) {
                ...
                if (options.compile) {
                  ...
                  startTime = Date.now();
                  return gorilla.compile(code, opts, function (_e, jsCode) {
                    var endTime;
                    if (_e != null) {
                      return next(_e);
                    }
