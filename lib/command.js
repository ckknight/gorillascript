(function () {
  ...
  child_process.exec("which gjs", function (err, whichGjsStdout, whichGjsStderr) {
    var hasGjs, parseOptions;
    hasGjs = err == null && whichGjsStdout.length && !whichGjsStderr.length;
    cli.enable("version");
    cli.setApp("gorilla", "0.5.1");
    ...
    return cli.main(function (filenames, options) {
      ...
      if (options["no-prelude"]) {
        ...
        _f = function (next) {
          return gorilla.init({ lang: lang }, function (_e) {
            if (_e != null) {
              throw _e;
            }
            return next();
            ...
            function (err) {
              ...
              return _f(function () {
                ...
                function writeSingle(filename, done) {
                  ...
                  return fs.exists(jsDir, function (exists) {
                    ...
                    return _f(function () {
                      ...
                      return fs.writeFile(jsPath, jsCode, "utf8", function (_e) {
                        if (_e != null) {
                          return done(_e);
                        }
                        return done();
                  ...
                  _f = function (next) {
                    ...
                    if (!options.join) {
                      ...
                      _f = function (next) {
                        ...
                        return fs.writeFile(jsPath, compiled.join, "utf8", function (_e) {
                          if (_e != null) {
                            throw _e;
                          }
                          return next();
                ...
                return _f(function () {
                  ...
                  if (sourcemap != null) {
                    _f = function (next) {
                      return fs.writeFile(options.sourcemap, opts.sourcemap.toString(), "utf8", function (_e) {
                        if (_e != null) {
                          throw _e;
                        }
                        return next();
                    ...
                    if (options.watch) {
                      ...
                      handleQueue = (function () {
                        ...
                        return function () {
                          ...
                          if (bestName != null) {
                            ...
                            return handleSingle(bestName, input[bestName], function (_e) {
                              if (_e != null) {
                                throw _e;
                              }
                              return writeSingle(bestName, function (_e2) {
                                if (_e2 != null) {
                                  throw _e2;
                                }
                                inHandle = false;
                      ...
                      for (_arr = __toArray(filenames), _i = 0, _len = _arr.length, _f = function (filename) {
                        return fs.watch(filename, function (event, name) {
                          ...
                          fs.readFile(name, function (err, code) {
