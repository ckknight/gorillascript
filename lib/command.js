(function (GLOBAL) {
  "use strict";
  var __async, __create, __fromPromise, __import, __isArray, __num, __once,
      __owns, __slice, __strnum, __toArray, __typeof, _once, _this,
      child_process, cli, fs, gorilla, path, setImmediate, util;
  _this = this;
      ...
      return (options["no-prelude"]
        ...
        function handleCode(code, callback) {
          ...
          return (options.ast
            ? function (next) {
              var _once3;
              return __fromPromise(gorilla.ast(code, opts))((_once3 = false, function (_e, ast) {
                if (_once3) {
                  throw Error("Attempted to call function more than once");
                } else {
                  _once3 = true;
            ...
            ? function (next) {
              var _once3;
              return __fromPromise(gorilla.parse(code, opts))((_once3 = false, function (_e, nodes) {
                if (_once3) {
                  throw Error("Attempted to call function more than once");
                } else {
                  _once3 = true;
            ...
            ? function (next) {
              var _once3;
              return __fromPromise(gorilla.compile(code, opts))((_once3 = false, function (_e, result) {
                if (_once3) {
                  throw Error("Attempted to call function more than once");
                } else {
                  _once3 = true;
            ...
            ? function (next) {
              var _once3;
              return __fromPromise(gorilla.compile(code, __import({ "eval": true }, opts)))((_once3 = false, function (_e, compiled) {
                var gjs;
                if (_once3) {
                  throw Error("Attempted to call function more than once");
                } else {
            ...
            function (err) {
              ...
              function handleSingle(filename, code, done) {
                ...
                if (options.compile) {
                  ...
                  startTime = Date.now();
                  return __fromPromise(gorilla.compile(code, opts))((_once3 = false, function (_e, compilation) {
                    var endTime;
                    if (_once3) {
                      throw Error("Attempted to call function more than once");
                    } else {
              ...
              return (!options.join
                ...
                : function (next) {
                  ...
                  startTime = Date.now();
                  return __fromPromise(gorilla.compile(
                    (function () {
