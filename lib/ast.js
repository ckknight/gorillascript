(function () {
  ...
  function inspectHelper(depth, name) {
    ...
    function isLarge(item) {
      ...
      if (item instanceof Node) {
        ...
        if (__num(item.length) > 4) {
          return true;
        } else {
          return (function () {
            var _arr, _i, _len, x;
            for (_arr = __toArray(item), _i = 0, _len = _arr.length; _i < _len; ++_i) {
              x = _arr[_i];
              if (isLarge(x)) {
                return true;
              }
        ...
        return __num(item.length) > 50;
      } else if (item instanceof RegExp) {
        return __num(item.source.length) > 50;
      } else if (item === null || (_ref = typeof item) === "undefined" || _ref === "boolean" || _ref === "number") {
        return false;
      }
    }
    hasLarge = (function () {
    ...
    if (hasLarge) {
      for (_arr = [], _i = 0, _len = args.length; _i < _len; ++_i) {
        arg = args[_i];
        _arr.push("  " + __strnum(inspect(arg, null, d).split("\n").join("\n  ")));
      }
      parts = _arr;
  ...
  exports.BlockStatement = BlockStatement = (function (Statement) {
    ...
    _BlockStatement_prototype.inspect = function (depth) {
      return inspectHelper(depth, "BlockStatement", this.body);
    };
  ...
  exports.DoWhile = DoWhile = (function (Statement) {
    ...
    _DoWhile_prototype.inspect = function (depth) {
      return inspectHelper(depth, "DoWhile", this.body, this.test);
    };
  ...
  exports.TryFinally = TryFinally = (function (Statement) {
    ...
    _TryFinally_prototype.inspect = function (depth) {
      return inspectHelper(depth, "Root", this.tryBody, this.finallyBody);
    };
