    ...
    _Call_prototype.shouldCompileLarge = function () {
      ...
      if (__num(this.args.length) > 4) {
        ...
        return (function () {
          ...
          for (_arr = __toArray(__slice(_this.args, 0, -1)), _i = 0, _len = _arr.length; _i < _len; ++_i) {
            arg = _arr[_i];
            if (!arg.isSmall()) {
              return true;
            }
