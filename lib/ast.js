      ...
      if (func instanceof Ident) {
        ...
        if (func.left.isConst() && func.right.isConst()) {
          if (typeof func.left.constValue()[func.right.constValue()] === "function") {
            try {
              return toConst((_tmp3 = func.left.constValue())[func.right.constValue()].apply(_tmp3, __toArray((function () {
                var _tmp3, _tmp4, _tmp5, arg;
                for (_tmp3 = [], _tmp4 = 0, _tmp5 = __num(args.length); _tmp4 < _tmp5; ++_tmp4) {
                  arg = args[_tmp4];
                  _tmp3.push(arg.constValue());
          ...
          try {
            return toConst((_tmp3 = global[func.left.name])[func.right.constValue()].apply(_tmp3, __toArray((function () {
              var _tmp3, _tmp4, _tmp5, arg;
              for (_tmp3 = [], _tmp4 = 0, _tmp5 = __num(args.length); _tmp4 < _tmp5; ++_tmp4) {
                arg = args[_tmp4];
                _tmp3.push(arg.constValue());
