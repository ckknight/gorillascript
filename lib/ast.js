(function () {
  "use strict";
  var __create, __in, __isArray, __lt, __lte, __num, __owns, __slice, __strnum, __toArray, __typeof, Arguments, Arr, Binary, Block, BlockExpression, BlockStatement, Break, Call, Const, Continue, Debugger, DoWhile, Eval, Expression, For, ForIn, fromJSON, Func, getIndent, Ident, If, IfExpression, IfStatement, INDENT, inspect, isAcceptableIdent, Level, Node, Noop, Obj, Return, Root, Statement, Switch, This, Throw, toJSSourceTypes, TryCatch, TryFinally, Type, Unary, While;
  ...
  exports.Concat = function () {
    ...
    for (_i = 0, _len = __num(args.length); _i < _len; ++_i) {
      ...
      if (current == null) {
        if (arg.type().isSubsetOf(Type.string)) {
          current = arg;
        } else {
          current = Binary("", "+", arg);
        }
  ...
  exports.Call = Call = (function (_super) {
    ...
    HELPER_TYPES = {
      ...
      __isArray: Type.boolean,
      __toArray: Type.array,
      ...
      __xor: function (args) {
        return Type.boolean.union(__num(args.length) >= 2 ? args[1].type() : Type["undefined"]);
      }
    };
    _proto.type = function () {
      var _ref, helper;
      if ((_ref = this._type) == null) {
        return this._type = this.func instanceof Ident && __owns(HELPER_TYPES, this.func.name) ? (helper = HELPER_TYPES[this.func.name], typeof helper === "function" ? helper(this.args) : helper) : Type.any;
      } else {
        return _ref;
      }
    };
  ...
  exports.Func = Func = (function (_super) {
    var _proto, _superproto, findTypeName;
  ...
  exports.Unary = Unary = (function (_super) {
    var _proto, _superproto, ASSIGNMENT_OPERATORS, KNOWN_OPERATORS, OPERATOR_TYPES;
