...
Arr = exports.Arr = (function () {
  ...
  Arr.prototype.compile = function (options, level, lineStart, sb) {
    var f;
    sb("[");
    f = this.isLarge() && !__lte(this.elements.length, 1) ? compileLarge : compileSmall;
    f(
      this.elements,
      options,
      level,
...
Call = exports.Call = (function () {
  ...
  Call.prototype.isSmall = function () {
    var _ref;
    return (_ref = this._isSmall) != null ? _ref : (this._isSmall = !this.func.isSmall() || !__lte(this.args.length, 1) ? false : this.args.length === 0 ? true : this.args[0].isSmall());
  };
