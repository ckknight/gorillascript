(function () {
  ...
  exports.BinaryChain = function (op) {
    ...
    current = args[0];
    for (_arr = __toArray(__slice(args, 1)), _i = 0, _len = _arr.length; _i < _len; ++_i) {
      arg = _arr[_i];
    ...
    _Call_prototype.shouldCompileLarge = function () {
      ...
      if (__num(this.args.length) > 4) {
        ...
        return (function () {
          ...
          for (_arr = __toArray(__step(
            __slice(_this.args, 0, -1),
            -1
