"use strict";
var __create, __in, __isArray, __lt, __lte, __num, __owns, __slice, __strnum, __toArray, __typeof, Access, And, Arguments, Arr, Assign, Binary, Block, BlockExpression, BlockStatement, Break, Call, Concat, Const, Continue, Debugger, DoWhile, Eval, Expression, For, ForIn, Func, Ident, If, IfExpression, IfStatement, INDENT, isAcceptableIdent, LEVEL_ACCESS, LEVEL_ADDITION, LEVEL_ASSIGNMENT, LEVEL_BITWISE_AND, LEVEL_BITWISE_OR, LEVEL_BITWISE_SHIFT, LEVEL_BITWISE_XOR, LEVEL_BLOCK, LEVEL_CALL, LEVEL_EQUALITY, LEVEL_INCREMENT, LEVEL_INLINE_CONDITION, LEVEL_INSIDE_PARENTHESES, LEVEL_LOGICAL_AND, LEVEL_LOGICAL_OR, LEVEL_MULTIPLICATION, LEVEL_RELATIONAL, LEVEL_SEQUENCE, LEVEL_UNARY, Node, Obj, Or, Return, Root, Statement, Switch, This, Throw, toJSSourceTypes, TryCatch, TryFinally, types, Unary, While;
...
Node = exports.Node = (function () {
  ...
  Node.prototype.toString = function () {
    var sb;
    sb = StringBuilder();
    this.compileAsStatement({ indent: 0 }, true, sb);
    return sb.toString();
  };
  ...
  Node.prototype.isLarge = function () {
    return true;
  };
...
Access = exports.Access = function (parent) {
...
Arguments = exports.Arguments = (function () {
  function Arguments() {
    var self;
...
Arr = exports.Arr = (function () {
  ...
  Arr.prototype.shouldCompileLarge = function () {
    var len;
  ...
  Arr.prototype.isSmall = function () {
    var len;
    len = this.elements.length;
    if (len === 0) {
      return true;
  ...
  Arr.prototype.isLarge = function () {
    var _ref, _this;
    _this = this;
    return (_ref = this._isLarge) != null ? _ref
      : (this._isLarge = !__lte(this.elements.length, 4) || (function () {
...
Assign = exports.Assign = function (left, right) {
...
Concat = exports.Concat = function () {
...
Binary = exports.Binary = (function () {
  ...
  Binary.prototype.type = function () {
    var _ref, _this;
    _this = this;
    return (_ref = this._type) != null ? _ref
      : (this._type = (function () {
        var handler;
  ...
  Binary.prototype.isSmall = function () {
...
BlockStatement = exports.BlockStatement = (function () {
...
BlockExpression = exports.BlockExpression = (function () {
  ...
  BlockExpression.prototype.isLarge = function () {
    ...
    _this = this;
    return (_ref = this._isLarge) != null ? _ref
      : (this._isLarge = !__lte(this.body.length, 4) || (function () {
  ...
  BlockExpression.prototype.isSmall = function () {
    return false;
  };
...
Call = exports.Call = (function () {
  var HELPER_TYPES, PRIMORDIAL_FUNCTIONS;
  ...
  Call.prototype.shouldCompileLarge = function () {
    var _this;
    _this = this;
    if (!__lte(this.args.length, 4)) {
      ...
      return (function () {
        ...
        for (_arr = __slice(
          ...
          void 0,
          -1
        ), _i = 0, _len = __num(_arr.length); _i < _len; ++_i) {
          arg = _arr[_i];
          if (!arg.isSmall()) {
            return true;
          }
  ...
  Call.prototype.hasLargeArgs = function () {
    var _ref, _this;
    _this = this;
    return (_ref = this._hasLargeArgs) != null ? _ref
      : (this._hasLargeArgs = !__lte(this.args.length, 4) ? true
        : (function () {
          var _arr, _i, _len, arg;
  ...
  Call.prototype.isSmall = function () {
    var _ref;
    return (_ref = this._isSmall) != null ? _ref
      : (this._isSmall = !this.func.isSmall() ? false
  ...
  Call.prototype.type = function () {
    var _ref, helper;
    return (_ref = this._type) != null ? _ref
      : (this._type = this.func instanceof Ident && __owns(HELPER_TYPES, this.func.name) ? (helper = HELPER_TYPES[this.func.name], typeof helper === "function" ? helper(this.args) : helper) : types.any);
  };
  return Call;
}());
...
Debugger = exports.Debugger = (function () {
  function Debugger() {
    var self;
...
DoWhile = exports.DoWhile = (function () {
...
IfStatement = exports.IfStatement = (function () {
...
IfExpression = exports.IfExpression = (function () {
  ...
  function compileSmall(test, whenTrue, whenFalse, options, lineStart, sb) {
    test.compile(options, LEVEL_INLINE_CONDITION, lineStart, sb);
    sb(" ? ");
  ...
  function compileLarge(test, whenTrue, whenFalse, options, lineStart, sb) {
    ...
    test.compile(
      childOptions,
      wrapTest ? LEVEL_INSIDE_PARENTHESES : LEVEL_INLINE_CONDITION,
      lineStart && !wrapTest,
      sb
    );
    if (wrapTest) {
    ...
    whenTrue.compile(
      childOptions,
      wrapWhenTrue ? LEVEL_INSIDE_PARENTHESES : LEVEL_INLINE_CONDITION,
      false,
      sb
    );
    if (wrapWhenTrue) {
    ...
    if (whenFalse instanceof IfExpression) {
      ...
      whenFalse.compile(childOptions, LEVEL_INLINE_CONDITION, false, sb);
    }
  }
  ...
  IfExpression.prototype.isSmall = function () {
    return false;
  };
...
Obj = exports.Obj = (function () {
  ...
  Obj.prototype.shouldCompileLarge = function () {
    var len;
    len = this.elements.length;
    if (len === 0) {
      return false;
  ...
  Obj.prototype.isSmall = function () {
    var len;
    len = this.elements.length;
    if (len === 0) {
      return true;
  ...
  Obj.Pair = ObjPair;
  ObjPair.prototype.isSmall = function () {
...
TryCatch = exports.TryCatch = (function () {
...
TryFinally = exports.TryFinally = (function () {
...
Unary = exports.Unary = (function () {
  ...
  Unary.prototype.isSmall = function () {
