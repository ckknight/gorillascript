(function () {
  ...
  __sliceStep = function (array, start, end, step, inclusive) {
    ...
    if (step < 0) {
      ...
      arr = __slice(array, start, inclusive ? +end + 1 || 1/0 : end);
    }
    if (step === 1) {
      return arr;
    } else if (step === -1) {
  ...
  __step = function (array, step) {
    ...
    if (step === 0) {
      ...
      if (step > 0) {
        i = 0;
        len = __num(array.length);
        for (; i < len; i += step) {
          result.push(array[i]);
        }
      } else {
        i = __num(array.length) - 1;
        for (; i >= 0; i += step) {
          result.push(array[i]);
        }
      }
  ...
  toJSSource = (function () {
    ...
    return function (value) {
      var _ref, f;
      if (__owns(toJSSourceTypes, _ref = typeof value)) {
  ...
  exports.Node = Node = (function () {
    ...
    function Node() {
      ...
      if (this instanceof Node) {
        ...
        _this = __create(_Node_prototype);
      }
  ...
  exports.Expression = Expression = (function (Node) {
    ...
    function Expression() {
      ...
      if (this instanceof Expression) {
        ...
        _this = __create(_Expression_prototype);
      }
  ...
  exports.Statement = Statement = (function (Node) {
    ...
    function Statement() {
      ...
      if (this instanceof Statement) {
        ...
        _this = __create(_Statement_prototype);
      }
      throw Error("Expression cannot be instantiated directly");
    }
    _Node_prototype = Node.prototype;
  ...
  exports.Arguments = Arguments = (function (Expression) {
    ...
    function Arguments() {
      ...
      if (this instanceof Arguments) {
        ...
        _this = __create(_Arguments_prototype);
      }
      return _this;
    }
  ...
  exports.BinaryChain = function (op) {
    ...
    current = args[0];
    for (_arr = __slice(args, 1), _i = 0, _len = _arr.length; _i < _len; ++_i) {
      arg = _arr[_i];
  ...
  exports.Binary = Binary = (function (Expression) {
    ...
    function Binary(left, op, right) {
      ...
      if (this instanceof Binary) {
        ...
        _this = __create(_Binary_prototype);
      }
  ...
  exports.BlockStatement = BlockStatement = (function (Statement) {
    ...
    function BlockStatement(body) {
      ...
      if (this instanceof BlockStatement) {
        ...
        _this = __create(_BlockStatement_prototype);
      }
      result = [];
      for (_i = 0, _len = body.length; _i < _len; ++_i) {
        item = body[_i];
    ...
    _BlockStatement_prototype.compile = function (options, level, lineStart, sb) {
      var _arr, _arr2, _i, _len, i, item, node, nodes;
  ...
  exports.BlockExpression = BlockExpression = (function (Expression) {
    ...
    function BlockExpression(body) {
      ...
      if (this instanceof BlockExpression) {
        ...
        _this = __create(_BlockExpression_prototype);
      }
      result = [];
  ...
  exports.Break = Break = (function (Statement) {
    ...
    function Break() {
      ...
      if (this instanceof Break) {
        ...
        _this = __create(_Break_prototype);
      }
      return _this;
    }
    _Statement_prototype = Statement.prototype;
  ...
  exports.Call = Call = (function (Expression) {
    ...
    function Call(func, args, isNew) {
      ...
      if (this instanceof Call) {
        ...
        _this = __create(_Call_prototype);
      }
      _this.func = func;
      _this.args = args;
      _this.isNew = isNew;
  ...
  exports.Const = Const = (function (Expression) {
    ...
    function Const(value) {
      ...
      if (this instanceof Const) {
        ...
        _this = __create(_Const_prototype);
      }
      _this.value = value;
      return _this;
    }
  ...
  exports.Continue = Continue = (function (Statement) {
    ...
    function Continue() {
      ...
      if (this instanceof Continue) {
        ...
        _this = __create(_Continue_prototype);
      }
      return _this;
    }
    _Statement_prototype = Statement.prototype;
  ...
  exports.Debugger = Debugger = (function (Statement) {
    ...
    function Debugger() {
      ...
      if (this instanceof Debugger) {
        ...
        _this = __create(_Debugger_prototype);
      }
      return _this;
    }
    _Statement_prototype = Statement.prototype;
  ...
  exports.DoWhile = DoWhile = (function (Statement) {
    ...
    function DoWhile(body, test) {
      ...
      if (this instanceof DoWhile) {
        ...
        _this = __create(_DoWhile_prototype);
      }
  ...
  exports.Eval = Eval = (function (Expression) {
    ...
    function Eval(code) {
      ...
      if (this instanceof Eval) {
        ...
        _this = __create(_Eval_prototype);
      }
  ...
  exports.ForIn = ForIn = (function (Statement) {
    ...
    function ForIn(key, object, body) {
      ...
      if (this instanceof ForIn) {
        ...
        _this = __create(_ForIn_prototype);
      }
      _this.key = key;
      _this.object = object;
      _this.body = body.maybeToStatement();
  ...
  exports.Func = Func = (function (Expression) {
    ...
    function Func(name, params, variables, body, declarations) {
      ...
      if (this instanceof Func) {
        ...
        _this = __create(_Func_prototype);
      }
  ...
  exports.Ident = Ident = (function (Expression) {
    ...
    function Ident(name) {
      ...
      if (this instanceof Ident) {
        ...
        _this = __create(_Ident_prototype);
      }
  ...
  exports.IfStatement = IfStatement = (function (Statement) {
    ...
    function IfStatement(test, whenTrue, whenFalse) {
      ...
      if (this instanceof IfStatement) {
        ...
        _this = __create(_IfStatement_prototype);
      }
  ...
  exports.IfExpression = IfExpression = (function (Expression) {
    ...
    function IfExpression(test, whenTrue, whenFalse) {
      ...
      if (this instanceof IfExpression) {
        ...
        _this = __create(_IfExpression_prototype);
      }
  ...
  exports.Noop = Noop = (function (Expression) {
    ...
    function Noop() {
      ...
      if (this instanceof Noop) {
        ...
        _this = __create(_Noop_prototype);
      }
      return _this;
    }
    _Expression_prototype = Expression.prototype;
    ...
    Obj.Pair = ObjPair = (function () {
      ...
      function ObjPair(key, value) {
        ...
        if (this instanceof ObjPair) {
          ...
          _this = __create(_ObjPair_prototype);
        }
  ...
  exports.Return = Return = (function (Statement) {
    ...
    function Return(node) {
      ...
      if (this instanceof Return) {
        ...
        _this = __create(_Return_prototype);
      }
  ...
  exports.Root = Root = (function () {
    ...
    function Root(body, variables, declarations) {
      ...
      if (this instanceof Root) {
        ...
        _this = __create(_Root_prototype);
      }
  ...
  exports.This = This = (function (Expression) {
    ...
    function This() {
      ...
      if (this instanceof This) {
        ...
        _this = __create(_This_prototype);
      }
      return _this;
    }
    _Expression_prototype = Expression.prototype;
  ...
  exports.Throw = Throw = (function (Statement) {
    ...
    function Throw(node) {
      ...
      if (this instanceof Throw) {
        ...
        _this = __create(_Throw_prototype);
      }
      if (typeof node.toStatement === "function") {
  ...
  exports.Switch = Switch = (function (Statement) {
    ...
    function Switch(node, cases, defaultCase) {
      ...
      if (this instanceof Switch) {
        ...
        _this = __create(_Switch_prototype);
      }
    ...
    Switch.Case = SwitchCase = (function () {
      ...
      function SwitchCase(node, body) {
        ...
        if (this instanceof SwitchCase) {
          ...
          _this = __create(_SwitchCase_prototype);
        }
        if (!(node instanceof Expression)) {
          node = toConst(node);
        }
  ...
  exports.TryCatch = TryCatch = (function (Statement) {
    ...
    function TryCatch(tryBody, catchIdent, catchBody) {
      ...
      if (this instanceof TryCatch) {
        ...
        _this = __create(_TryCatch_prototype);
      }
  ...
  exports.TryFinally = TryFinally = (function (Statement) {
    ...
    function TryFinally(tryBody, finallyBody) {
      ...
      if (this instanceof TryFinally) {
        ...
        _this = __create(_TryFinally_prototype);
      }
      _this.tryBody = tryBody.maybeToStatement();
  ...
  exports.Unary = Unary = (function (Expression) {
    ...
    function Unary(op, node) {
      ...
      if (this instanceof Unary) {
        ...
        _this = __create(_Unary_prototype);
      }
