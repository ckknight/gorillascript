(function () {
  ...
  exports.Access = function (parent) {
    var _arr, _i, _len, child, children, current;
    children = __slice(arguments, 1);
    current = parent;
    for (_arr = __toArray(children), _i = 0, _len = _arr.length; _i < _len; ++_i) {
      child = _arr[_i];
  ...
  function walkArray(array, walker) {
    ...
    changed = false;
    result = (function () {
      var _arr, _arr2, _i, _len, item, newItem;
  ...
  exports.BinaryChain = function (op, left) {
    var _arr, _i, _len, arg, args, current;
  ...
  exports.BlockStatement = BlockStatement = (function (Statement) {
    ...
    function BlockStatement(body) {
      var _arr, _i, _len, _this, item, result, statement;
      if (body == null) {
        body = [];
      ...
      result = [];
      for (_arr = __toArray(body), _i = 0, _len = _arr.length; _i < _len; ++_i) {
        item = _arr[_i];
    ...
    _BlockStatement_prototype.compile = function (options, level, lineStart, sb) {
      var _arr, _len, _this, i, item, nodes;
      _this = this;
      ...
      for (_arr = __toArray(nodes), i = 0, _len = _arr.length; i < _len; ++i) {
        item = _arr[i];
        if (__num(i) > 0) {
          sb("\n");
          sb.indent(options.indent);
  ...
  exports.BlockExpression = BlockExpression = (function (Expression) {
    ...
    function BlockExpression(body) {
      var _arr, _i, _len, _this, i, item, len, result;
      if (body == null) {
        body = [];
      } else if (!__isArray(body)) {
        throw TypeError("Expected body to be an Array, got " + __typeof(body));
      ...
      result = [];
      for (_arr = __toArray(body), i = 0, len = _arr.length; i < len; ++i) {
        item = _arr[i];
    ...
    _BlockExpression_prototype.compile = function (options, level, lineStart, sb) {
      var _arr, _len, _this, i, item, nodes, wrap;
      _this = this;
      if (level === Level.block) {
  ...
  exports.Func = Func = (function (Expression) {
    var _Expression_prototype, _Func_prototype, findTypeName, Type;
