  ...
  Arr.prototype.isLarge = function () {
    ...
    return (_ref = this._isLarge) != null ? _ref : (this._isLarge = !__lte(this.elements.length, 4) || (function () {
      ...
      for (_arr = _this.elements, _i = 0, _len = __num(_arr.length); _i < _len; ++_i) {
        element = _arr[_i];
        if ((element instanceof Arr || element instanceof Obj || element instanceof Call) && !element.isEmpty() || element.isLarge()) {
          return true;
        }
      }
      return false;
    ...
    if (!__lte(this.args.length, 4)) {
      ...
      return (function () {
        ...
        for (_arr = __slice(_this.args, void 0, -1), _i = 0, _len = __num(_arr.length); _i < _len; ++_i) {
          arg = _arr[_i];
          if ((arg instanceof Arr || arg instanceof Obj || arg instanceof Call) && !arg.isEmpty() || arg.isLarge()) {
            return true;
          }
        }
        return false;
  ...
  IfExpression.prototype.isLarge = function () {
    ...
    return (_ref = this._isLarge) != null ? _ref : (this._isLarge = (function () {
      ...
      for (_arr = [_this.test, _this.whenTrue, _this.whenFalse], _i = 0, _len = __num(_arr.length); _i < _len; ++_i) {
        part = _arr[_i];
        if ((part instanceof Arr || part instanceof Obj || part instanceof Call) && !part.isEmpty() || part.isLarge()) {
          return true;
        }
      }
      return false;
...
Obj = exports.Obj = (function () {
  ...
  Obj.prototype.isLarge = function () {
    ...
    return (_ref = this._isLarge) != null ? _ref : (this._isLarge = !__lte(this.elements.length, 4) || (function () {
      ...
      for (_arr = _this.elements, _i = 0, _len = __num(_arr.length); _i < _len; ++_i) {
        element = _arr[_i];
        if (((_ref = element.value) instanceof Arr || _ref instanceof Obj || _ref instanceof Call) && !element.value.isEmpty() || element.isLarge()) {
          return true;
        }
      }
      return false;
