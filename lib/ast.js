...
function StringBuilder() {
  ...
  sb.indent = function (count) {
    var i;
    for (i = 0, __num(count); i < count; i = __num(i) + 1) {
      data.push(INDENT);
    }
  };
...
function walkArray(array, walker) {
  ...
  changed = false;
  result = (_tmp = array.length, (function () {
    var _tmp2, _tmp3, item, newItem;
...
Arr = (function () {
  ...
  Arr.prototype.isLarge = function () {
    ...
    _this = this;
    return (_tmp = this._isLarge) != null ? _tmp : (this._isLarge = !__lte(this.elements.length, 4) || (_tmp = this.elements, _tmp2 = _tmp.length, (function () {
      var _tmp3, element;
...
function And() {
  ...
  if (args.length === 0) {
    ...
    current = args[0];
    for (i = 1, _tmp3 = __num(args.length); i < _tmp3; i = __num(i) + 1) {
...
BlockExpression = (function () {
  function BlockExpression(body) {
    var _tmp, _tmp2, _tmp3, _tmp4, item, result, self;
    if (body == null) {
      body = [];
    } else if (!__isArray(body)) {
      throw TypeError("Expected body to be an Array, got " + __typeof(body));
  ...
  BlockExpression.prototype.isLarge = function () {
    var _this, _tmp, _tmp2;
    _this = this;
    return (_tmp = this._isLarge) != null ? _tmp : (this._isLarge = !__lte(this.body.length, 4) || (_tmp = this.body, _tmp2 = _tmp.length, (function () {
      var _tmp3, part;
      for (_tmp3 = 0, __num(_tmp2); _tmp3 < _tmp2; _tmp3 = __num(_tmp3) + 1) {
        part = _tmp[_tmp3];
        if (part.isLarge()) {
...
function Block(body) {
  var _tmp, _tmp2, _tmp3, allExpressions;
  if (body == null) {
    body = [];
  } else if (!__isArray(body)) {
    throw TypeError("Expected body to be an Array, got " + __typeof(body));
  ...
  allExpressions = (_tmp3 = body.length, (function () {
    var _tmp4, item;
    for (_tmp4 = 0, __num(_tmp3); _tmp4 < _tmp3; _tmp4 = __num(_tmp4) + 1) {
      item = body[_tmp4];
...
Call = (function () {
  ...
  function Call(func, args, isNew) {
    ...
    if (!isNew && (_tmp3 = args.length, (function () {
      var _tmp4, arg;
      for (_tmp4 = 0, __num(_tmp3); _tmp4 < _tmp3; _tmp4 = __num(_tmp4) + 1) {
        arg = args[_tmp4];
        if (!isConst(arg)) {
      ...
      if (func instanceof Ident) {
        if (__owns(PRIMORDIAL_FUNCTIONS, func.name) && PRIMORDIAL_FUNCTIONS[func.name] === true && typeof global !== "undefined" && typeof global[func.name] === "function") {
          try {
            return toConst(global[func.name].apply(null, (_tmp3 = args.length, (function () {
              var _tmp4, _tmp5, arg;
              for (_tmp4 = [], _tmp5 = 0, __num(_tmp3); _tmp5 < _tmp3; _tmp5 = __num(_tmp5) + 1) {
                arg = args[_tmp5];
                _tmp4.push(constValue(arg));
              }
              return _tmp4;
            }()))));
          } catch (e) {
        ...
        if (isConst(func.left) && isConst(func.right)) {
          if (typeof constValue(func.left)[constValue(func.right)] === "function") {
            try {
              return toConst((_tmp3 = constValue(func.left))[constValue(func.right)].apply(_tmp3, __toArray((_tmp3 = args.length, (function () {
                var _tmp4, _tmp5, arg;
                for (_tmp4 = [], _tmp5 = 0, __num(_tmp3); _tmp5 < _tmp3; _tmp5 = __num(_tmp5) + 1) {
                  arg = args[_tmp5];
                  _tmp4.push(constValue(arg));
          ...
          try {
            return toConst((_tmp3 = global[func.left.name])[constValue(func.right)].apply(_tmp3, __toArray((_tmp3 = args.length, (function () {
              var _tmp4, _tmp5, arg;
              for (_tmp4 = [], _tmp5 = 0, __num(_tmp3); _tmp5 < _tmp3; _tmp5 = __num(_tmp5) + 1) {
                arg = args[_tmp5];
                _tmp4.push(constValue(arg));
  ...
  Call.prototype.shouldCompileLargeArgs = function () {
    ...
    if (!__lte(this.args.length, 4)) {
      ...
      _tmp = __slice(this.args, void 0, -1);
      _tmp2 = _tmp.length;
      return (function () {
        var _tmp3, arg;
        for (_tmp3 = 0, __num(_tmp2); _tmp3 < _tmp2; _tmp3 = __num(_tmp3) + 1) {
  ...
  Call.prototype.hasLargeArgs = function () {
    var _this, _tmp, _tmp2;
    _this = this;
    return (_tmp = this._hasLargeArgs) != null ? _tmp : (this._hasLargeArgs = !__lte(this.args.length, 4) ? true : (_tmp = this.args, _tmp2 = _tmp.length, (function () {
      var _tmp3, arg;
      for (_tmp3 = 0, __num(_tmp2); _tmp3 < _tmp2; _tmp3 = __num(_tmp3) + 1) {
        arg = _tmp[_tmp3];
        if ((arg instanceof Arr || arg instanceof Obj) && !arg.isEmpty() || arg.isLarge()) {
...
function toConst(value) {
  ...
  if (value instanceof Node) {
    ...
    return Arr((_tmp = value.length, (function () {
      var _tmp2, _tmp3, item;
      for (_tmp2 = [], _tmp3 = 0, __num(_tmp); _tmp3 < _tmp; _tmp3 = __num(_tmp3) + 1) {
        item = value[_tmp3];
        _tmp2.push(toConst(item));
      }
      return _tmp2;
    }())));
...
function validateFuncParamsAndVariables(params, variables) {
  ...
  _tmp = variables.length;
  for (_tmp2 = 0, __num(_tmp); _tmp2 < _tmp; _tmp2 = __num(_tmp2) + 1) {
    variable = variables[_tmp2];
...
function compileFuncBody(options, sb, declarations, variables, body) {
  ...
  _tmp = declarations.length;
  for (_tmp2 = 0, __num(_tmp); _tmp2 < _tmp; _tmp2 = __num(_tmp2) + 1) {
    declaration = declarations[_tmp2];
    sb.indent(options.indent);
...
IfStatement = (function () {
  function IfStatement(test, whenTrue, whenFalse) {
    ...
    if (isConst(test)) {
      ...
      if (whenTrue instanceof BlockStatement && whenTrue.body.length === 0) {
        if (whenFalse instanceof BlockStatement && whenFalse.body.length === 0) {
          return test;
        } else {
  ...
  IfStatement.prototype.compile = function (options, level, lineStart, sb) {
    ...
    if (!(whenFalse instanceof BlockStatement) || !__lte(whenFalse.body.length, 0)) {
      sb(" else ");
...
IfExpression = (function () {
  ...
  IfExpression.prototype.isLarge = function () {
    var _this, _tmp, _tmp2;
    _this = this;
    return (_tmp = this._isLarge) != null ? _tmp : (this._isLarge = (_tmp = [this.test, this.whenTrue, this.whenFalse], _tmp2 = _tmp.length, (function () {
      var _tmp3, part;
      for (_tmp3 = 0, __num(_tmp2); _tmp3 < _tmp2; _tmp3 = __num(_tmp3) + 1) {
        part = _tmp[_tmp3];
...
Root = (function () {
  function Root(body, variables, declarations) {
    ...
    self.body = [];
    _tmp7 = body.length;
    for (_tmp8 = 0, __num(_tmp7); _tmp8 < _tmp7; _tmp8 = __num(_tmp8) + 1) {
      item = body[_tmp8];
      statement = maybeToStatement(item);
      if (statement instanceof BlockStatement) {
...
Switch = (function () {
  ...
  Switch.prototype.compile = function (options, level, lineStart, sb) {
    ...
    for (_tmp3 = 0, __num(_tmp2); _tmp3 < _tmp2; _tmp3 = __num(_tmp3) + 1) {
      ...
      sb(":");
      if (!(case_.body instanceof BlockStatement) || !__lte(case_.body.body.length, 0)) {
        sb("\n");
        sb.indent(childOptions.indent);
        case_.body.compileAsStatement(childOptions, true, sb);
      }
    }
    if (!(this.defaultCase instanceof BlockStatement) || !__lte(this.defaultCase.body.length, 0)) {
      sb("\n");
      sb.indent(options.indent);
      sb("default:\n");
      sb.indent(childOptions.indent);
  ...
  Switch.prototype.walk = function (walker) {
    ...
    if (node !== this.node || cases !== this.cases || defaultCases !== this.defaultCases) {
