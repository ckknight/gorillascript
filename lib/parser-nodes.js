(function () {
  ...
  Node.Function = Node.byTypeId[20] = FunctionNode = (function (Node) {
    ...
    function FunctionNode(index, scope, params, body, autoReturn, bound, curry, asType, generator) {
      var _this;
    ...
    _FunctionNode_prototype._toJSON = function () {
      return [this.params, this.body, this.autoReturn].concat(simplifyArray([this.bound, this.curry, this.asType, this.generator]));
    };
