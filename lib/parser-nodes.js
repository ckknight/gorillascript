(function () {
  ...
  var __async, __create, __isArray, __keys, __once, __owns, __slice, __toArray,
      ...
      mapAsync, Node, nodeToType, ParamNode, quote, Type;
  ...
  Node.Param = Node.byTypeId[{ Function: 20, MacroAccess: 23 }.Param] = ParamNode = (function (Node) {
    ...
    _ParamNode_prototype.typeId = { Function: 20, MacroAccess: 23 }.Param;
    ParamNode.argNames = [
      "ident",
      "defaultValue",
      "spread",
