(function (GLOBAL) {
  ...
  var __async, __create, __curry, __in, __isArray, __keys, __once, __owns,
      ...
      ArrayNode, AssignNode, BinaryNode, BlockNode, CallNode, CascadeNode,
      CommentNode, ContinueNode, DebuggerNode, DefNode, EmbedWriteNode,
      EvalNode, ForInNode, ForNode, FunctionNode, IdentNode, IfNode, inspect,
    ...
    _BlockNode_prototype._reduce = function (o) {
      ...
      for (_arr = __toArray(this.nodes), i = 0, len = _arr.length; i < len; ++i) {
        ...
        if (reduced instanceof BlockNode && reduced.label == null) {
          ...
          changed = true;
        } else if (reduced instanceof ContinueNode || reduced instanceof ThrowNode || reduced instanceof ReturnNode) {
          body.push(reduced);
    ...
    _RegexpNode_prototype._reduce = function (o) {
      ...
      if (!source.isConst()) {
        return CallNode(
          ...
          [
            source,
            LispyNode_Value(this.index, this.flags)
          ]
        );
  ...
  Node.Return = Node.byTypeId[29] = ReturnNode = (function (Node) {
    ...
    function ReturnNode(index, scope, node) {
      ...
      if (node == null) {
        node = LispyNode_Value(index, void 0);
      }
      _this.index = index;
      _this.scope = scope;
      _this._reduced = void 0;
