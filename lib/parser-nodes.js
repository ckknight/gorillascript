(function (GLOBAL) {
  ...
  var __async, __create, __curry, __in, __isArray, __keys, __once, __owns,
      __slice, __toArray, __typeof, _ref, AccessNode, AssignNode, BinaryNode,
      BlockNode, CallNode, DefNode, EmbedWriteNode, FunctionNode, IdentNode,
  ...
  Node.Access = Node.byTypeId[1] = AccessNode = (function (Node) {
    ...
    _AccessNode_prototype._reduce = function (o) {
      var _arr, _i, _len, _ref, args, cachedParent, child, cValue, end, hasEnd,
          hasStep, inclusive, key, LispyNode, parent, pValue, start, step,
          value;
      ...
      if (parent.isLiteral() && child.isConst()) {
        ...
        if (parent.isConst()) {
          ...
          if (parent instanceof LispyNode && parent.isCall && parent.func.isSymbol && parent.func.isInternal && parent.func.isArray) {
            if (cValue === "length") {
