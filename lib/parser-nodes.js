(function (GLOBAL) {
  ...
  var __async, __create, __curry, __in, __isArray, __keys, __once, __owns,
      ...
      CommentNode, DefNode, EmbedWriteNode, EvalNode, ForInNode, ForNode,
      FunctionNode, IdentNode, IfNode, inspect, isPrimordial, MacroAccessNode,
      MacroConstNode, map, mapAsync, Node, nodeToType, NothingNode, ObjectNode,
