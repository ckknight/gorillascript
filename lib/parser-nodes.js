(function () {
  ...
  var __async, __create, __isArray, __keys, __once, __owns, __slice, __toArray,
      ...
      mapAsync, Node, nodeToType, quote, Type;
  ...
  Node.Function = Node.byTypeId[20] = FunctionNode = (function (Node) {
    ...
    function FunctionNode(index, scope, params, body, autoReturn, bound, asType, generator) {
      var _this;
      ...
      if (autoReturn) {
        throw Error("Expected autoReturn to be falsy");
      }
    ...
    _FunctionNode_prototype.type = function (o) {
      ...
      if ((_ref = this._type) == null) {
        if (this.asType != null) {
          ...
          return this._type = Type.generator;
        } else {
          return this._type = this.body.returnType(o, true)["function"]();
        }
      } else {
        return _ref;
      }
    ...
    _FunctionNode_prototype._toJSON = function () {
      return [this.params, this.body, this.autoReturn].concat(simplifyArray([this.bound, this.asType, this.generator]));
    };
    _FunctionNode_prototype.returnType = function (o, isLast) {
      if (isLast) {
    ...
    _FunctionNode_prototype.walkAsync = function (f, context, callback) {
      var _once, _this;
      _this = this;
      mapAsync(this.params, f, context, (_once = false, function (_e, params) {
        var _once2;
        if (_once) {
          throw Error("Attempted to call function more than once");
        } else {
