(function () {
  ...
  var __async, __create, __isArray, __keys, __once, __owns, __slice, __toArray,
      ...
      mapAsync, Node, nodeToType, ParamNode, quote, Type, TypeFunctionNode,
  ...
  Node.TypeFunction = Node.byTypeId[{
    Function: 20,
    MacroAccess: 23,
    Param: 27,
    TypeGeneric: 45,
    TypeObject: 46
  }.TypeFunction] = TypeFunctionNode = (function (Node) {
    ...
    _TypeFunctionNode_prototype.typeId = {
      Function: 20,
      MacroAccess: 23,
      Param: 27,
      TypeGeneric: 45,
