(function (GLOBAL) {
  ...
  var __async, __create, __isArray, __keys, __once, __owns, __slice, __toArray,
      __typeof, _ref, CallNode, FunctionNode, IdentNode, inspect, isPrimordial,
      MacroAccessNode, map, mapAsync, Node, nodeToType, ParamNode, quote,
      SuperNode, SyntaxManyNode, SyntaxParamNode, SyntaxSequenceNode, TmpNode,
      ...
      return function (o) {
        ...
        if ((_ref = this._type) == null) {
          return this._type = (function () {
            var _ref, _ref2, _ref3, _ref4, child, func, funcType, LispyNode,
            ...
            if (funcType.isSubsetOf(Type["function"])) {
              ...
              if (func instanceof LispyNode && func.isInternalCall("access")) {
                ...
                if (child.isConst()) {
                  ...
                  } else if (parent instanceof IdentNode && __owns.call(PRIMORDIAL_SUBFUNCTIONS, _ref = parent.name) && __owns.call(_ref2 = PRIMORDIAL_SUBFUNCTIONS[_ref], _ref3 = child.constValue()) && (_ref4 = _ref2[_ref3]) != null) {
                    return _ref4;
                  }
                }
              }
  ...
  Node.Tmp = Node.byTypeId[43] = TmpNode = (function (Node) {
