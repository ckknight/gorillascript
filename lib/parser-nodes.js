(function () {
  ...
  Node.Function = Node.byTypeId[20] = FunctionNode = (function (Node) {
    ...
    function FunctionNode(index, scope, params, body, bound, asType, generator) {
      var _this;
    ...
    _FunctionNode_prototype._toJSON = function () {
      return [this.params, this.body].concat(simplifyArray([this.bound, this.asType, this.generator]));
    };
