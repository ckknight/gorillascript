(function (GLOBAL) {
  ...
  var __async, __create, __isArray, __keys, __once, __owns, __slice, __toArray,
      ...
      SuperNode, SyntaxParamNode, TmpNode, Type, TypeFunctionNode,
      TypeGenericNode, TypeObjectNode, TypeUnionNode;
  ...
  Node.SyntaxParam = Node.byTypeId[{
    Call: 9,
    Function: 20,
    Ident: 21,
    MacroAccess: 23,
    ...
    TypeObject: 46,
    TypeUnion: 47
  }.SyntaxParam] = SyntaxParamNode = (function (Node) {
    ...
    _SyntaxParamNode_prototype.typeId = {
      Call: 9,
      Function: 20,
      Ident: 21,
      MacroAccess: 23,
