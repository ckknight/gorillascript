(function (GLOBAL) {
  ...
  var __async, __create, __curry, __isArray, __keys, __once, __owns, __slice,
      ...
      CallNode, EmbedWriteNode, FunctionNode, IdentNode, inspect, isPrimordial,
      MacroAccessNode, MacroConstNode, map, mapAsync, Node, nodeToType,
      NothingNode, ParamNode, quote, RootNode, SpreadNode, SuperNode,
    ...
    _AccessNode_prototype._reduce = function (o) {
      ...
      if (cachedParent != null) {
        ...
        return LispyNode.InternalCall(
          ...
          LispyNode.Value(this.index, cachedParent.id)
        );
      }
    ...
    _BlockNode_prototype.withLabel = function (label, o) {
      ...
      if (this.label == null) {
        if (this.nodes.length === 1) {
          ...
          LispyNode = require("./parser-lispynodes");
          if (last instanceof LispyNode && last.isCall && last.func.isInternal && last.func.isForIn && (function () {
            ...
            for (_arr = __toArray(_this.nodes), _i = 0, _len = _arr.length, _end = -1, _end += _len, _end > _len && (_end = _len); _i < _end; ++_i) {
              node = _arr[_i];
              if (!(node instanceof AssignNode) && (!(node instanceof LispyNode) || !node.isCall || !node.func.isSymbol || !node.func.isInternal || !node.func.isVar)) {
                _every = false;
                break;
              }
            }
