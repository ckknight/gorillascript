(function (GLOBAL) {
  ...
  var __async, __create, __isArray, __keys, __once, __owns, __slice, __toArray,
      __typeof, _ref, CallNode, FunctionNode, inspect, isPrimordial,
      MacroAccessNode, map, mapAsync, Node, nodeToType, ParamNode, quote, Type,
  ...
  Node.Call = Node.byTypeId[9] = CallNode = (function (Node) {
      ...
      return function (o) {
        ...
        if ((_ref = this._type) == null) {
          return this._type = (function () {
            ...
            } else if (func instanceof LispyNode && func.isInternalCall("access")) {
              _ref = func.args;
              parent = _ref[0];
              child = _ref[1];
              if (child.isConst()) {
                ...
                } else if (parent instanceof LispyNode.Symbol.ident && __owns.call(PRIMORDIAL_SUBFUNCTIONS, _ref = parent.name) && __owns.call(_ref2 = PRIMORDIAL_SUBFUNCTIONS[_ref], _ref3 = child.constValue()) && (_ref4 = _ref2[_ref3]) != null) {
                  return _ref4;
                }
              }
            }
    ...
    _CallNode_prototype._reduce = (function () {
      ...
      return function (o) {
        var _arr, _i, _len, _ref, _ref2, allConst, arg, args, child, constArgs,
            cValue, func, LispyNode, parent, pValue, value;
        ...
        if (!this.isNew && !this.isApply) {
          ...
          if (allConst) {
            ...
            if (func instanceof LispyNode.Symbol.ident) {
            ...
            } else if (func instanceof LispyNode && func.isInternalCall("access") && func.args[1].isConst()) {
              _ref = func.args;
              parent = _ref[0];
              child = _ref[1];
              ...
              if (parent.isConst()) {
                ...
                if (typeof pValue[cValue] === "function") {
                  try {
                    value = pValue[cValue].apply(pValue, constArgs);
                    if (value === null || (_ref = typeof value) === "number" || _ref === "string" || _ref === "boolean" || _ref === "undefined") {
                      return LispyNode_Value(this.index, value);
                    }
                  } catch (e) {}
                }
              } else if (parent instanceof LispyNode.Symbol.ident && (__owns.call(PURE_PRIMORDIAL_SUBFUNCTIONS, _ref = parent.name) && __owns.call(_ref2 = PURE_PRIMORDIAL_SUBFUNCTIONS[_ref], cValue) ? _ref2[cValue] : void 0)) {
                try {
                  value = (_ref = GLOBAL[parent.name])[cValue].apply(_ref, constArgs);
                  if (value === null || (_ref = typeof value) === "number" || _ref === "string" || _ref === "boolean" || _ref === "undefined") {
                    return LispyNode_Value(this.index, value);
                  }
                } catch (e) {}
  ...
  Node.Function = Node.byTypeId[20] = FunctionNode = (function (Node) {
    ...
    _FunctionNode_prototype.walk = function (f, context) {
      ...
      if (false || params !== this.params || body !== this.body || bound !== this.bound || asType !== this.asType || generic !== this.generic) {
        return FunctionNode(
          this.index,
          this.scope,
          params,
          ...
          return (_this.bound instanceof Node
            ...
            return (_this.asType instanceof Node
              ...
              return mapAsync(_this.generic, f, context, (_once3 = false, function (_e3, generic) {
                ...
                return callback(null, false || params !== _this.params || body !== _this.body || bound !== _this.bound || asType !== _this.asType || generic !== _this.generic
                  ? FunctionNode(
                    _this.index,
                    _this.scope,
                    params,
