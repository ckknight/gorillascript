(function (GLOBAL) {
  ...
  var __async, __create, __in, __is, __isArray, __name, __once, __owns, __slice,
      __toArray, __typeof, _ref, Cache, Call, isPrimordial, Node, OldNode,
      Symbol, toJSSource, Type, Value;
    ...
    Internal = (function (Symbol) {
      ...
      internalSymbols = {
        access: {
          ...
          __type: (function () {
            var cache, PRIMORDIAL_METHODS, PRIMORDIAL_SUBFUNCTIONS;
            ...
            return function (access, call, parser) {
              ...
              if (_value === void 0) {
                _value = (function () {
                  var _ref, child, childValue, methodGroup, parent, parentName,
                      parentType, types;
                  _ref = access.args;
                  parent = _ref[0];
                  child = _ref[1];
                  if (child.isConst()) {
                    ...
                    if (parent instanceof Ident) {
                      ...
                      if (__owns.call(PRIMORDIAL_SUBFUNCTIONS, parentName)) {
                        types = PRIMORDIAL_SUBFUNCTIONS[parentName];
                        if (__owns.call(types, childValue)) {
                          return types[childValue];
                        }
                      }
                    }
                    parentType = parent.type(parser);
                    if (parentType.isSubsetOf(Type.string)) {
                      methodGroup = PRIMORDIAL_METHODS.String;
                    } else if (parentType.isSubsetOf(Type.boolean)) {
                      methodGroup = PRIMORDIAL_METHODS.Boolean;
                    } else if (parentType.isSubsetOf(Type.number)) {
                      methodGroup = PRIMORDIAL_METHODS.Number;
                    } else if (parentType.isSubsetOf(Type.date)) {
                      methodGroup = PRIMORDIAL_METHODS.Date;
                    } else if (parentType.isSubsetOf(Type.regexp)) {
                      methodGroup = PRIMORDIAL_METHODS.RegExp;
                    } else if (parentType.isSubsetOf(Type.error)) {
                      methodGroup = PRIMORDIAL_METHODS.Error;
                    } else if (parentType.isSubsetOf(Type["function"])) {
                      methodGroup = PRIMORDIAL_METHODS.Function;
                    }
        ...
        array: {
          ...
          __reduce: function (call, parser) {
            ...
            if (changed) {
              return Call.apply(void 0, [call.index, call.scope, call.func].concat(elements));
            } else {
              return call;
            }
          },
        ...
        syntaxSequence: { doWrapArgs: false },
        "throw": {
          validateArgs: function (node) {
            var rest;
            rest = __slice.call(arguments, 1);
  ...
  Call = (function (Node) {
    ...
    _Call_prototype.type = function (parser) {
      var _ref, func, funcType, reduced;
      reduced = this.reduce(parser);
      func = reduced.func;
      if (typeof func._type === "function" && (_ref = func._type(reduced, parser)) != null) {
        return _ref;
      }
      funcType = func.type(parser);
      if (funcType.isSubsetOf(Type["function"])) {
        return funcType.args[0];
      } else {
        return Type.any;
    ...
    _Call_prototype._reduce = function (parser) {
      ...
      if (typeof reduced.func.__reduce === "function" && (_ref = reduced.func.__reduce(this, parser)) != null) {
        return _ref;
      }
      return reduced;
    };
    ...
    _Call_prototype.isStatement = function () {
      ...
      } else if (this.func instanceof Symbol) {
    ...
    _Call_prototype.doWrap = function (parser) {
      ...
      if (typeof this.func._doWrap === "function") {
        ...
        result = Call(this.index, this.scope, OldNode.Function(
          this.index,
          this.scope,
          [],
