(function () {
  ...
  Node = (function (OldNode) {
    ...
    _Node_prototype.walkAsync = function () {
  ...
  Value = (function (Node) {
    ...
    _Value_prototype.walk = function () {
      return this;
    };
    _Value_prototype.walkAsync = function (f, context, callback) {
  ...
  Symbol = (function (Node) {
    ...
    Tmp = (function (Symbol) {
      ...
      _Tmp_prototype.inspect = function () {
        return "Symbol.tmp(" + this.id + ")";
      };
      Symbol.tmp = function (index, scope, name) {
        return Tmp(index, scope, name);
      };
      return Tmp;
    }(Symbol));
