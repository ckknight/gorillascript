(function (GLOBAL) {
  ...
  var __async, __create, __in, __is, __isArray, __name, __once, __owns, __slice,
      __toArray, __typeof, _ref, Cache, Call, isPrimordial, Node, nodeToType,
      OldNode, Symbol, toJSSource, Type, Value;
        ...
        "function": {
          ...
          validateArgs: function (params, body, bound, asType, isGenerator) {
            if (!params.isInternalCall("array")) {
              throw Error("Expected params to be an internal Array call, got " + __typeof(params));
            }
          },
          _type: (function () {
            var cache;
