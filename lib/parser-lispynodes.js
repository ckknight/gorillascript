      ...
      internalSymbols = {
        access: {
          ...
          __reduce: function (call, parser) {
            ...
            if (child instanceof OldNode.Call && child.func instanceof Ident && child.func.name === "__range") {
              _ref = child.args;
              start = _ref[0];
              end = _ref[1];
              step = _ref[2];
              ...
              return OldNode.Call(
                call.index,
                call.scope,
                Ident(call.index, call.scope, hasStep ? "__sliceStep" : "__slice"),
                args,
                false,
                !hasStep
              ).reduce(parser);
  ...
  Call = (function (Node) {
    ...
    function Call(index, scope, func) {
      ...
      if (false && typeof func.validateArgs === "function") {
        func.validateArgs.apply(func, args);
      }
      return _this;
    }
    _Node_prototype = Node.prototype;
