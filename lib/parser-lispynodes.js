        ...
        Symbol.unary = {
          ...
          "-": Negate = (function (UnaryOperator) {
            ...
            _Negate_prototype.__reduce = function (call, parser) {
              ...
              if (node.isConst()) {
                return Value(call.index, -node.constValue());
              } else if (node instanceof Node && node.isCall && ((_ref = node.func) instanceof ToNumber || _ref instanceof Negate)) {
                return Call(
                  call.index,
                  call.scope,
                ...
                if ((_ref = node.op) === "-" || _ref === "+") {
                  return OldNode.Binary(
                    this.index,
                    this.scope,
                    Call(node.left.index, node.left.scope, Negate(node.left.index), node.left),
                    node.op === "-" ? "+" : "-",
                    node.right
                  );
          ...
          "!": Not = (function (UnaryOperator) {
            ...
            _Not_prototype.__reduce = function (call, parser) {
              ...
              if (node.isConst()) {
                ...
                if (__owns.call(invertibleBinaryOps, node.op)) {
