(function () {
  "use strict";
  var __async, __create, __isArray, __once, __owns, __slice, __toArray,
  ...
  Symbol = (function (Node) {
    ...
    Internal = (function (Symbol) {
      ...
      internalSymbols = {
        ...
        def: {},
        "for": { usedAsStatement: true },
        forIn: { usedAsStatement: true },
        "function": {},
        "if": {},
        ...
        spread: {},
        "super": {},
        "throw": { isGoto: true, usedAsStatement: true },
        tmpWrapper: {},
        tryCatch: { usedAsStatement: true },
        tryFinally: { usedAsStatement: true },
        write: {},
        "var": {},
        "yield": {}
      };
      function _f(name, data) {
        ...
        return Symbol[name] = (function (Internal) {
          var _Internal_prototype2, _prototype, k, v;
          ...
          _prototype = _class.prototype = __create(_Internal_prototype2);
          _prototype.constructor = _class;
          if (typeof Internal.extended === "function") {
            Internal.extended(_class);
          }
          _prototype[isNameKey] = true;
          for (k in data) {
  ...
  Call = (function (Node) {
    ...
    _Call_prototype.walk = function (walker, context) {
      ...
      if (func !== this.func || changedArgs) {
        return Call(this.index, this.scope, func, args);
      } else {
        return this;
      }
    };
        ...
        return __async(
          ...
          function (err, args) {
            if (err) {
              ...
              return callback(null, Call(_this.index, _this.scope, func, args));
            } else {
