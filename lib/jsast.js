(function () {
  ...
  function isNegative(value) {
    return __num(value) < 0 || value === 0 && 1 / value < 0;
  }
  ...
  toJSSource = (function () {
    ...
    return function (value) {
      var _ref, f;
      if (__owns.call(toJSSourceTypes, _ref = value === null ? "null" : typeof value)) {
  ...
  exports.Node = Node = (function () {
    ...
    _Node_prototype.compile = function () {
      throw Error("Not implemented: " + __strnum(this.constructor.displayName || this.constructor.name) + ".compile()");
    };
