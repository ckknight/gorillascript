(function () {
  "use strict";
  var __isArray, __lt, __num, __slice, __strnum, __toArray, _i, _len, ACCESSOR, backlog, enableColors, g, gorilla, module, nonContextGlobals, readline, repl, REPL_PROMPT, REPL_PROMPT_CONTINUATION, sandbox, SIMPLEVAR, stdin, stdout, util, vm;
  ...
  function completeVariable(text) {
    ...
    if (free) {
      ...
      possibilities = __toArray(vars).concat(__toArray(gorilla.RESERVED));
