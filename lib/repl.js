(function () {
  "use strict";
  var __cmp, __isArray, __lt, __num, __owns, __slice, __strnum, __toArray, __typeof, _arr, _i, _len, backlog, enableColors, g, gorilla, module, nonContextGlobals, readline, recentSigint, repl, REPL_PROMPT, REPL_PROMPT_CONTINUATION, sandbox, stdin, stdout, toGsIdent, toJsIdent, util, vm;
  ...
  for (_arr = __toArray(nonContextGlobals), _i = 0, _len = _arr.length; _i < _len; ++_i) {
    g = _arr[_i];
    sandbox[g] = this[g];
  }
