(function (GLOBAL) {
  "use strict";
  var __cmp, __fromPromise, __in, __isArray, __lt, __num, __owns, __slice, __strnum, __toArray, __typeof, _i, backlog, child_process, enableColors, g, gorilla, module, nonContextGlobals, readline, sandbox, setImmediate, stdin, stdout, toGsIdent, toJsIdent, util, vm;
  ...
  exports.start = function (options) {
    ...
    repl.on("line", function (buffer) {
      ...
      backlog = "";
      if (pipe) {
        return __fromPromise(gorilla.compile(code, { "eval": true, filename: "repl", modulename: "repl" }))((_once = false, function (err, compiled) {
          if (_once) {
        ...
        return __fromPromise(gorilla["eval"](code, { sandbox: sandbox, filename: "repl", modulename: "repl" }))((_once2 = false, function (err, ret) {
          if (_once2) {
            throw Error("Attempted to call function more than once");
          } else {
            _once2 = true;
