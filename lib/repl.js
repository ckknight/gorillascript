(function () {
  "use strict";
  var __cmp, __isArray, __lt, __num, __owns, __slice, __strnum, __toArray, __typeof, _i, _len, backlog, enableColors, g, gorilla, module, nonContextGlobals, readline, repl, REPL_PROMPT, REPL_PROMPT_CONTINUATION, sandbox, stdin, stdout, toGsIdent, toJsIdent, util, vm;
  ...
  function getAllPropertyNames(obj) {
    ...
    current = obj;
    for (; current != null; ) {
      result.push.apply(result, __toArray(Object.getOwnPropertyNames(current)));
