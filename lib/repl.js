(function (GLOBAL) {
  "use strict";
  var __cmp, __fromPromise, __in, __isArray, __lt, __num, __owns, __slice,
      __strnum, __toArray, __typeof, _i, backlog, child_process, enableColors,
      g, gorilla, module, nonContextGlobals, readline, sandbox, setImmediate,
      stdin, stdout, toGsIdent, toJsIdent, util, vm;
