(function () {
  "use strict";
  var __cmp, __in, __isArray, __lt, __num, __owns, __slice, __strnum, __toArray, __typeof, _i, backlog, enableColors, g, gorilla, module, nonContextGlobals, readline, recentSigint, repl, REPL_PROMPT, REPL_PROMPT_CONTINUATION, sandbox, stdin, stdout, toGsIdent, toJsIdent, util, vm;
  ...
  repl.on("line", function (buffer) {
    ...
    backlog = backlog + __strnum(buffer);
