        ...
        p = __generatorToPromise((function () {
          ...
          function _step(_received) {
            while (true) {
              ...
              case 1:
                compiled = _received;
                process.stdout.write(__strnum(compiled.code) + "\n");
                ++_state;
        ...
        p = __generatorToPromise((function () {
          ...
          function _step(_received) {
            while (true) {
              ...
              case 1:
                ret = _received;
                process.stdout.write(__strnum(util.inspect(ret.node, false, 2, enableColors)) + "\n");
                ++_state;
                return { done: true, value: repl.prompt() };
              case 2:
                return { done: true, value: void 0 };
        ...
        p = __generatorToPromise((function () {
          ...
          function _step(_received) {
            while (true) {
              ...
              case 1:
                ret = _received;
                process.stdout.write(__strnum(util.inspect(ret.result, false, 2, enableColors)) + "\n");
                ++_state;
                return { done: true, value: repl.prompt() };
              case 2:
                return { done: true, value: void 0 };
