(function (GLOBAL) {
  "use strict";
  var __async, __isArray, __num, __once, __owns, __slice, __strnum, __toArray, __typeof, cli, commandToAction, commandToDescription, fs, gorilla, options, path, switches;
  ...
  switches = {};
  options = {};
  GLOBAL.command = function (name, description, action) {
  ...
  GLOBAL.invoke = function (name, callback) {
    ...
    if (__num(action.length) >= 2 && typeof callback !== "function") {
  ...
  exports.run = function (callback) {
    ...
    return fs.realpath(".", function (_e, path) {
      if (_e != null) {
        return callback(_e);
      }
      return findGorkfile(path, function (_e2, filepath) {
        if (_e2 != null) {
          return callback(_e2);
        }
            ...
            function (_e4) {
              ...
              return cli.main(function (args, opts) {
                ...
                for (_i = 0, _len = commands.length; _i < _len; ++_i) {
                  command = commands[_i];
                  if (!__owns.call(commandToAction, command)) {
