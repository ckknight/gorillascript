(function (GLOBAL) {
  "use strict";
  var __async, __fromPromise, __in, __isArray, __num, __once, __owns, __slice, __strnum, __toArray, __typeof, cli, commandToAction, commandToDependencies, commandToDescription, fs, gorilla, options, path, ranCommands, setImmediate, switches;
  ...
  cli = require("cli");
  cli.enable("version");
  cli.setApp("gork", gorilla.version);
  ...
  exports.run = function (callback) {
    ...
    return fs.realpath(".", (_once = false, function (_e, currentPath) {
      var _once2;
      if (_once) {
        throw Error("Attempted to call function more than once");
      } else {
      ...
      return findGorkfile(currentPath, (_once2 = false, function (_e2, filepath) {
        var _once3;
        if (_once2) {
          throw Error("Attempted to call function more than once");
        } else {
        ...
        return fs.readFile(filepath, "utf-8", (_once3 = false, function (_e3, text) {
          var _once4;
          if (_once3) {
            throw Error("Attempted to call function more than once");
          } else {
          ...
          return __fromPromise(gorilla.run(text, { filename: "Gorkfile", includeGlobals: true }))((_once4 = false, function (_e4) {
            if (_once4) {
              throw Error("Attempted to call function more than once");
            } else {
              _once4 = true;
  ...
  function fatalError(message) {
    ...
    if (message instanceof Error && message.stack) {
      console.error(__strnum(message.stack) + "\n");
    } else {
  ...
  function findGorkfile(dir, callback) {
    ...
    return fs.exists(filepath, (_once = false, function (exists) {
      var parent;
      if (_once) {
        throw Error("Attempted to call function more than once");
      } else {
