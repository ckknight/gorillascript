(function (GLOBAL) {
  "use strict";
  var __async, __fromPromise, __in, __isArray, __num, __once, __owns, __slice,
      __strnum, __toArray, __typeof, cli, commandToAction,
      commandToDependencies, commandToDescription, fs, gorilla, options, path,
      ranCommands, setImmediate, switches;
