(function () {
  "use strict";
  var __cmp, __create, __in, __isArray, __isObject, __num, __owns, __slice, __str, __strnum, __toArray, __typeof, __xor, ast, AstNode, GeneratorBuilder, generatorTranslate, Helpers, HELPERS, ParserNode, Scope, translators, Type;
    ...
    Function: (function () {
      ...
      function buildAccessStringNode(accesses) {
        if (accesses.length === 0) {
          ...
          return [typeof accesses[0].value === "string" && ast.isAcceptableIdent(accesses[0].value) ? ast.Const("." + __strnum(accesses[0].value)) : ast.Const("[" + __str(JSON.stringify(accesses[0].value)) + "]")].concat(__toArray(buildAccessStringNode(__slice(accesses, 1, void 0))));
        } else {
          return ["[", accesses[0], "]"].concat(__toArray(buildAccessStringNode(__slice(accesses, 1, void 0))));
        }
      }
      translateTypeChecks = {
