(function () {
  "use strict";
  var __cmp, __create, __in, __isArray, __num, __owns, __slice, __str, __strnum, __toArray, __typeof, __xor, ast, GeneratorBuilder, generatorTranslate, Helpers, HELPERS, parser, Scope, translators, Type;
  ...
  module.exports.defineHelper = function (name, value, dependencies) {
    ...
    ident = typeof name === "string" ? ast.Ident(name)
      : name instanceof parser.Node.Ident ? translate(name, scope, "leftExpression")()
      : (function () {
    ...
    helper = value instanceof ast.Node ? value
      : value instanceof parser.Node ? translate(value, scope, "expression")()
      : (function () {
