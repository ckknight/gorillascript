(function () {
  "use strict";
  var __cmp, __create, __in, __isArray, __num, __owns, __slice, __strnum, __toArray, __typeof, __xor, ast, Helpers, HELPERS, parser, Scope, translators, types;
  ...
  translators = {
    ...
    Function: (function () {
      ...
      return function (node, scope, location, autoReturn) {
        return function () {
          ...
          if (node.asType != null) {
            asType = translateType(node.asType, scope);
          } else {
            asType = void 0;
          }
          func = ast.Func(
    ...
    Let: (function () {
      ...
      ArrayDeclarable = (function () {
        ...
        function ArrayDeclarable(elements) {
          var _this;
          if (this instanceof ArrayDeclarable) {
            _this = this;
          } else {
            _this = __create(_proto);
          }
      ...
      ObjectDeclarable = (function () {
        ...
        function ObjectDeclarable(pairs) {
          var _this;
          if (this instanceof ObjectDeclarable) {
            _this = this;
          } else {
            _this = __create(_proto);
          }
    ...
    Root: function (node, scope) {
      ...
      return function () {
        var _arr, _i, _len, bareInit, body, callFunc, fakeThis, helper, ident, init;
        body = tBody();
        init = [];
        ...
        if (scope.options.bare) {
          return ast.Root(
            __toArray(bareInit).concat(__toArray(init), [body]),
            scope.getVariables(),
            ["use strict"]
          );
        } else {
          ...
          return ast.Root(__toArray(bareInit).concat([callFunc]), [], []);
        }
      };
    },
