      ...
      translateTypeChecks = {
          ...
          result = ast.If(
            ...
            ast.Throw(ast.Call(ast.Ident("TypeError"), [
              arrayIndex != null
                ...
                : ast.BinaryChain("+", "Expected " + __strnum(ident.name) + " to be " + withArticle(node.name) + ", got ", ast.Call(ast.Ident("__typeof"), [ident]))
            ]))
          );
            ...
            check: ast.If(
              ...
              ast.Throw(ast.Call(ast.Ident("TypeError"), [
                arrayIndex != null
                  ...
                  : ast.BinaryChain("+", "Expected " + __strnum(ident.name) + " to be " + withArticle(type.right.value) + ", got ", ast.Call(ast.Ident("__typeof"), [ident]))
              ]))
            ),
            type: Type.any
          };
        ...
        TypeUnion: function (ident, node, scope, hasDefaultValue, arrayIndex) {
          ...
          result = ast.If(
            ...
            ast.Throw(ast.Call(ast.Ident("TypeError"), [
              ast.BinaryChain("+", "Expected " + __strnum(ident.name) + " to be " + withArticle(names.join(" or ")) + ", got ", ast.Call(ast.Ident("__typeof"), [ident]))
            ]))
          );
          if (!hasDefaultValue) {
            if (hasNull || hasVoid) {
