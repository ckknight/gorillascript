(function () {
  "use strict";
  var __cmp, __create, __in, __isArray, __num, __owns, __slice, __strnum, __toArray, __typeof, __xor, ast, GeneratorBuilder, generatorTranslate, Helpers, HELPERS, parser, Scope, translators, types;
  ...
  GeneratorBuilder = (function () {
    ...
    function GeneratorBuilder(scope, states, currentState, stateIdent, pendingFinalliesIdent, finallies, catches, currentCatch) {
      ...
      _this.stateIdent = stateIdent != null ? stateIdent : scope.reserveIdent("state");
      _this.pendingFinalliesIdent = pendingFinalliesIdent != null ? pendingFinalliesIdent : scope.reserveIdent("finallies");
    ...
    _proto.pendingFinally = function (tFinallyBody) {
      ...
      ident = this.scope.reserveIdent("finally");
    ...
    _proto.create = function () {
      ...
      close = this.scope.reserveIdent("close");
          ...
          for (_arr = array.elements, i = 0, len = __num(_arr.length); i < len; ++i) {
            ...
            if (!param.spread) {
              ...
              if (i === __num(len) - 1) {
                ...
                spreadCounter = scope.reserveIdent("i");
        ...
        if (location === "topStatement" && left instanceof ast.Ident && right instanceof ast.Func && right.name == null) {
          ...
          if (left.elements.length === 1 && !left.elements[0].spread) {
            ...
            if (needsCaching(right)) {
              arrayIdent = scope.reserveIdent("a");
          ...
          if (left.pairs.length === 1) {
            ...
            objectIdent = void 0;
            if (needsCaching(right)) {
              objectIdent = scope.reserveIdent("o");
