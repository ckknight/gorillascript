(function () {
  "use strict";
  var __cmp, __create, __in, __isArray, __lt, __num, __owns, __slice, __strnum, __toArray, __typeof, __xor, ast, HELPERS, KNOWN_HELPERS, parser, Scope, translators, types;
      ...
      linkTypes = {
        access: (function () {
          ...
          return function (links, link, scope, i, tCurrent) {
            var _obj, _setObj, makeAccess, tRight, uncache;
            makeAccess = (function () {
              var tChild;
              switch (link.type) {
              case "access":
              ...
              case "accessIndex":
                ...
                return indexTypes[link.child.type](link.child, scope);
              default:
  ...
  function translate(node, scope, location, autoReturn) {
    ...
    if (typeof ret !== "function") {
      throw Error("Translated non-function: " + __strnum(__typeof(ret)));
    }
    return ret;
  }
