(function () {
  ...
  MacroHolder = (function () {
    ...
    _MacroHolder_prototype.deserialize = function (getData, state) {
      var _ref, _ref2, ast, data, dependencies, helper, name, type, value;
      ast = require("./jsast");
      data = getData(Type, ast.byTypeId);
      for (name in (_ref = __owns.call(data, "helpers") ? data.helpers : void 0) != null ? _ref : {}) {
        if (__owns.call(
          (_ref = __owns.call(data, "helpers") ? data.helpers : void 0) != null ? _ref : {},
          name
        )) {
          _ref = ((_ref2 = __owns.call(data, "helpers") ? data.helpers : void 0) != null ? _ref2 : {})[name];
          helper = _ref.helper;
          type = _ref.type;
      ...
      for (name in (_ref = __owns.call(data, "consts") ? data.consts : void 0) != null ? _ref : {}) {
        if (__owns.call(
          (_ref = __owns.call(data, "consts") ? data.consts : void 0) != null ? _ref : {},
          name
        )) {
          value = ((_ref = __owns.call(data, "consts") ? data.consts : void 0) != null ? _ref : {})[name];
