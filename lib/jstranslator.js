(function (GLOBAL) {
  "use strict";
  var __arrayToIter, __cmp, __create, __freeze, __import, __indexOfIdentical, __isArray, __iter, __name, __num, __owns, __slice, __strnum, __toArray, __typeof, _ref, ast, AstNode, Cache, GeneratorBuilder, GeneratorState, generatorTranslate, MacroHolder, Map, ParserNode, Scope, StopIteration, translators, Type;
  ...
  __freeze = typeof Object.freeze === "function" ? Object.freeze
    : function (x) {
      return x;
    };
      ...
      function Map(iterable) {
        ...
        if (iterable != null) {
          try {
            ...
            if (_iter != null && typeof _iter.close === "function") {
              _iter.close();
            }
          }
        }
  ...
  StopIteration = GLOBAL.StopIteration != null ? GLOBAL.StopIteration : __freeze({});
  ast = require("./jsast");
  AstNode = ast.Node;
  Type = require("./types");
