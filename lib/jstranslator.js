(function () {
  "use strict";
  var __cmp, __create, __instanceofsome, __isArray, __num, __owns, __slice, __strnum, __toArray, __typeof, ast, AstNode, GeneratorBuilder, generatorTranslate, Helpers, HELPERS, ParserNode, Scope, translators, Type;
  ...
  translators = {
    ...
    Function: (function () {
      ...
      return function (node, scope, location, autoReturn) {
        return function () {
          var _arr, body, fakeThis, func, i, initializers, innerScope, len, p, param, paramIdents, realInnerScope, unassigned;
