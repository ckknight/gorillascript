(function (GLOBAL) {
        ...
        if (func.isInternal) {
          if (func.isBreak) {
            ...
            mutatedNode = args[0].mutateLast(
              null,
              function (n) {
                return LispyNode.Call(n.index, n.scope, LispyNode.Symbol["return"](n.index), n);
              },
              null,
              true
            );
      ...
      return function (node, scope, location) {
        return function () {
          ...
          _ref = translateFunctionBody(
            ...
            node.generator,
            innerScope,
            node.autoReturn ? LispyNode.Call(node.body.index, node.body.scope, LispyNode.Symbol["return"](node.body.index), node.body) : node.body,
            unassigned
          );
          body = _ref.body;
          wrap = _ref.wrap;
  ...
  function translateRoot(roots, scope, getPosition) {
    ...
    if (roots.length === 1) {
      ...
      ret = translateFunctionBody(rootPos, roots[0].isGenerator, innerScope, scope.options["return"] || scope.options["eval"] ? LispyNode.Call(roots[0].body.index, roots[0].body.scope, LispyNode.Symbol["return"](roots[0].body.index), roots[0].body) : roots[0].body);
