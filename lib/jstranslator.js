(function (GLOBAL) {
  ...
  function translateRoot(roots, scope, getPosition) {
    var _arr, _i, _len, _ref, bareInit, body, callFunc, comments, fakeThis,
        helper, ident, init, innerScope, name, noPos, uncommentedBody, walker,
        wrap;
    if (!__isArray(roots)) {
      roots = [roots];
    }
    ...
    _ref = roots.length === 1
      ...
      : {
        ...
        body: ast.Block(noPos, (function () {
          var _arr, _arr2, _len, _ref, bodyScope, comments, i, root, rootBody,
              rootPos;
          for (_arr = [], _arr2 = __toArray(roots), i = 0, _len = _arr2.length; i < _len; ++i) {
            ...
            bodyScope = innerScope.clone(true);
