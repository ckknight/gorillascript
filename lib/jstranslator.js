(function (GLOBAL) {
  ...
  var __arrayToIter, __cmp, __create, __curry, __first, __import,
      ...
      MacroHolder, Map, primordialsBetterWithNew, Scope, translateLispyInternal,
  ...
  generatorTranslate = (function () {
    ...
    _ref[4] = function (node, args, scope, state, breakState) {
      if (args[0]) {
        throw new Error("Not implemented: break with label in a generator");
      }
      if (breakState == null) {
    ...
    _ref[7] = function (node, args, scope, state, breakState, continueState) {
      if (args[0]) {
        throw new Error("Not implemented: continue with label in a generator");
      }
