(function (GLOBAL) {
  "use strict";
  var __arrayToIter, __cmp, __create, __first, __import, __indexOfIdentical,
      __isArray, __iter, __name, __num, __owns, __slice, __strnum, __throw,
      __toArray, __typeof, _ref, ast, AstNode, Cache, GeneratorBuilder,
      GeneratorState, generatorTranslate, MacroHolder, Map, ParserNode, Scope,
      translators, Type;
