(function (GLOBAL) {
  ...
  var __arrayToIter, __cmp, __create, __curry, __first, __import,
      ...
      MacroHolder, Map, Scope, translateLispyInternal, translateLispyOperator,
      Type;
  ...
  function makeHasGeneratorNode() {
    ...
    function hasInLoop(node) {
      ...
      return inLoopCache.getOrAdd(node, (_once = false, function (node) {
        ...
        if (!(node instanceof LispyNode) || !node.isInternalCall("function")) {
          FOUND = {};
          try {
  ...
  translateLispyInternal = {
    ...
    embedWrite: function (node, args, scope, location, unassigned) {
      ...
      if (args[0].isStatement()) {
        ...
        wrapped = LispyNode.Call(args[0].index, args[0].scope, LispyNode.InternalCall(
          "function",
          args[0].index,
          innerScope,
          LispyNode.InternalCall("array", args[0].index, innerScope),
      ...
      return function (node, args, scope, location, unassigned) {
        return function () {
          ...
          if (!node.args[2].isConst()) {
            ...
            convertAutoReturn = function (subnode) {
              return LispyNode.Call(subnode.index, subnode.scope, LispyNode.Symbol["return"](subnode.index), subnode.args[0]);
            };
          }
          function translateAutoReturn(subnode) {
            if (subnode instanceof LispyNode && subnode.isInternalCall("function")) {
              return subnode;
            }
            if (subnode instanceof LispyNode && subnode.isInternalCall("autoReturn")) {
