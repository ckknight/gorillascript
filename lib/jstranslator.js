(function () {
  "use strict";
  var __cmp, __create, __import, __instanceofsome, __isArray, __name, __num, __once, __owns, __slice, __strnum, __toArray, __typeof, _ref, ast, AstNode, GeneratorBuilder, generatorTranslate, MacroHolder, ParserNode, Scope, translators, Type;
  ...
  generatorTranslate = (function () {
    ...
    generatorTranslators = {
      Assign: function (node, scope, builder, breakState, continueState) {
        var left, tLeft;
        if (!(node.right instanceof ParserNode.Yield)) {
          return builder.add(translate(node, scope, "statement", false));
        }
        tLeft = translate(node.left, scope, "leftExpression");
        builder.add(function () {
          return scope.maybeCacheAccess(tLeft(), __once(function (setLeft, _left) {
            left = _left;
            return setLeft;
          }));
        });
        ...
        return builder.add(function () {
          return ast.Binary(getPos(node), left, node.op, builder.receivedIdent);
        });
      },
