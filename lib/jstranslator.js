(function (GLOBAL) {
  ...
  generatorTranslate = (function () {
    ...
    _ref[31] = function (node, args, scope, state, assignTo, unassigned) {
      var gNode;
    ...
    _ref[38] = function (node, args, scope, state, assignTo, unassigned) {
      var gNode;
      gNode = generatorTranslateExpression(
        args[0],
        scope,
    ...
    _ref = [];
    _ref[3] = function (node, args, scope, state, breakState, continueState, unassigned, isTop) {
    ...
    _ref[4] = function (node, args, scope, state, breakState) {
      if (args[0]) {
    ...
    _ref[7] = function (node, args, scope, state, breakState, continueState) {
      if (args[0]) {
    ...
    _ref[10] = function (node, args, scope, state, breakState, continueState, unassigned) {
      var gText;
    ...
    _ref[11] = function (node, args, scope, state, _p, _p2, unassigned) {
    ...
    _ref[12] = function (node, args, scope, state, _p, _p2, unassigned) {
    ...
    _ref[14] = function (node, args, scope, state, breakState, continueState, unassigned) {
    ...
    _ref[21] = function (node, args, scope, state, breakState, continueState, unassigned, isTop) {
    ...
    _ref[24] = function (node, args, scope, state, _p, continueState, unassigned) {
    ...
    _ref[30] = function (node, args, scope, state) {
      var gNode;
      gNode = generatorTranslateExpression(args[0], scope, state, false);
    ...
    _ref[31] = function (node, args, scope, state, breakState, continueState, unassigned, isTop) {
    ...
    _ref[32] = function (node, args, scope, state, breakState, continueState, unassigned, isTop) {
      var postBranch;
    ...
    _ref[33] = function (node, args, scope, state, breakState, continueState, unassigned, isTop) {
      var tFinally;
    ...
    _ref[38] = function (node, args, scope, state) {
      var gNode;
      gNode = generatorTranslateExpression(args[0], scope, state, false);
      ...
      case 1:
        ...
        case 0:
          if (node.isNothing) {
            ...
            throw Error("Unknown type: " + __typeof(node));
          }
          break;
  ...
  _ref[30] = function (node, args, scope, location, unassigned) {
    var tNode;
  ...
  _ref[37] = function (node, args, scope, location, unassigned) {
    var ident, tIdent;
    ident = args[0];
    ...
    case 1:
      ...
      case 0:
        if (node.isNothing) {
          ...
          throw Error("Unhandled symbol: " + __typeof(node));
        }
        break;
      default: throw Error("Unhandled value in switch");
      }
