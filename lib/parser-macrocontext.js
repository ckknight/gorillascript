(function () {
  ...
  var __create, __isArray, __owns, __slice, __throw, __toArray, __typeof, _ref,
      addParamToScope, FunctionNode, Ident, LispyNode, MacroAccessNode,
      MacroContext, Node, nodeToType, Scope, Tmp, Type;
  ...
  MacroContext = (function () {
    ...
    _MacroContext_prototype.func = function (params, body, autoReturn, bound, asType, generator) {
