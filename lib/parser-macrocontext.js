(function () {
  ...
  var __create, __isArray, __owns, __slice, __throw, __toArray, __typeof, _ref,
      ...
      CustomNode, EmbedWriteNode, FunctionNode, IdentNode, LispyNode,
      MacroAccessNode, MacroConstNode, MacroContext, Node, nodeToType,
      NothingNode, ParamNode, RootNode, Scope, SpreadNode, SuperNode,
      SyntaxChoiceNode, SyntaxManyNode, SyntaxParamNode, SyntaxSequenceNode,
      TmpNode, TmpWrapperNode, Type, TypeFunctionNode, TypeGenericNode,
      TypeObjectNode, TypeUnionNode, UnaryNode, VarNode;
  ...
  MacroContext = (function () {
    ...
    _MacroContext_prototype.custom = function (name) {
      ...
      return this.parser.Custom(this.index, name, data);
    };
    ...
    _MacroContext_prototype.name = function (node) {
      node = this.real(node);
      if (this.isIdent(node) || this.isCustom(node)) {
        return node.name;
      }
    };
    ...
    _MacroContext_prototype.isCustom = function (node) {
      return this.real(node) instanceof CustomNode;
    };
