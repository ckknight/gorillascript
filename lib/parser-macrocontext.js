(function () {
  ...
  var __create, __isArray, __owns, __slice, __throw, __toArray, __typeof, _ref,
      ...
      NothingNode, ObjectNode, ParamNode, RootNode, Scope, SpreadNode,
      SuperNode, SwitchNode, SyntaxChoiceNode, SyntaxManyNode, SyntaxParamNode,
  ...
  MacroContext = (function () {
    ...
    _MacroContext_prototype.object = function (pairs) {
      var _this;
      _this = this;
      return this.parser.Object(this.index, (function () {
