(function () {
  ...
  var __create, __isArray, __owns, __slice, __throw, __toArray, __typeof, _ref,
      AccessNode, addParamToScope, AssignNode, BinaryNode, BlockNode, CallNode,
  ...
  MacroContext = (function () {
    ...
    _MacroContext_prototype.isComplex = function (node) {
      ...
      if (node == null) {
        ...
        return !(node instanceof IdentNode) && !(node instanceof TmpNode) && (!(node instanceof BlockNode) || node.nodes.length !== 0);
      }
    };
