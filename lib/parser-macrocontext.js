(function () {
  ...
  var __create, __isArray, __owns, __slice, __throw, __toArray, __typeof, _ref,
      addParamToScope, CallNode, FunctionNode, Ident, LispyNode,
      MacroAccessNode, MacroContext, Node, nodeToType, ParamNode, Scope, Tmp,
      Type, TypeFunctionNode, TypeGenericNode, TypeObjectNode, TypeUnionNode;
  ...
  MacroContext = (function () {
    ...
    _MacroContext_prototype.call = function (func, args) {
      ...
      return CallNode(func.index, this.scope(), this.doWrap(func), (function () {
    ...
    function constifyObject(position, obj, index, scope) {
      ...
      } else if (obj instanceof CallNode && obj.func instanceof Ident && obj.func.name === "$") {
