(function () {
  ...
  var __create, __isArray, __owns, __slice, __throw, __toArray, __typeof, _ref,
      addParamToScope, AssignNode, BinaryNode, CallNode, EmbedWriteNode,
      FunctionNode, IdentNode, LispyNode, MacroAccessNode, MacroConstNode,
      MacroContext, Node, nodeToType, NothingNode, ParamNode, RootNode, Scope,
  ...
  MacroContext = (function () {
    ...
    _MacroContext_prototype.op = function (node) {
      node = this.real(node);
      if (this.isAssign(node) || this.isBinary(node)) {
        return node.op;
