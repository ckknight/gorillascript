(function () {
  ...
  MacroContext = (function () {
    ...
    _MacroContext_prototype.isIdentOrTmp = function (node) {
      var _ref;
      return (_ref = this.real(node)) instanceof IdentNode || _ref instanceof Tmp;
    };
    ...
    _MacroContext_prototype.object = function (pairs, prototype) {
      ...
      arrayPairs = _arr;
      return LispyNode.InternalCall.apply(LispyNode, ["object", this.index, this.scope(), prototype || LispyNode.Symbol.nothing(this.index)].concat(__toArray(arrayPairs))).reduce(this.parser);
    };
