(function () {
  ...
  var __create, __isArray, __owns, __slice, __throw, __toArray, __typeof, _ref,
      addParamToScope, Ident, LispyNode, MacroAccessNode, MacroContext, Node,
      nodeToType, Scope, Tmp, Type;
  ...
  MacroContext = (function () {
    ...
    _MacroContext_prototype.node = function (typeId, fromPosition) {
      ...
      args = __slice.call(arguments, 2);
      if (typeId === 23) {
        return this.macro.apply(this, [fromPosition].concat(args));
      } else {
        if (fromPosition && typeof fromPosition.index === "number") {
          index = fromPosition.index;
        } else {
        ...
        return (_ref = Node.byTypeId)[typeId].apply(_ref, [index, this.scope()].concat(args)).reduce(this.parser);
      }
    };
