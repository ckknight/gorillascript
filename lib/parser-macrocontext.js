(function () {
  ...
  var __create, __isArray, __owns, __slice, __throw, __toArray, __typeof, _ref,
      ...
      SyntaxSequenceNode, TmpNode, TmpWrapperNode, TryCatchNode, Type,
  ...
  MacroContext = (function () {
    ...
    _MacroContext_prototype.isLabeledBlock = function (node) {
      node = this.real(node);
      if (node instanceof BlockNode || node instanceof IfNode || node instanceof SwitchNode || node instanceof ForNode || node instanceof ForInNode || node instanceof TryCatchNode) {
    ...
    _MacroContext_prototype.label = function (node) {
      ...
      } else if (node instanceof BlockNode || node instanceof IfNode || node instanceof SwitchNode || node instanceof ForNode || node instanceof ForInNode || node instanceof TryCatchNode) {
        return node.label;
      }
      return null;
    };
