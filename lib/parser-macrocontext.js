  ...
  MacroContext = (function () {
    ...
    _MacroContext_prototype.isComplex = function (node) {
      ...
      if (node == null) {
        ...
        return !(node instanceof IdentNode) && !(node instanceof TmpNode) && !(node instanceof ThisNode) && !(node instanceof ArgsNode) && (!(node instanceof BlockNode) || node.nodes.length !== 0);
      }
    };
