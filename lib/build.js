(function () {
  "use strict";
  var __async, __in, __isArray, __num, __once, __slice, __strnum, __toArray, __typeof, fs, gorilla, path, startTime;
  ...
  fs.readdir("./src", function (err, files) {
    ...
    files = (function () {
      ...
      for (_arr = [], _arr2 = __toArray(files.sort()), _i = 0, _len = _arr2.length; _i < _len; ++_i) {
        file = _arr2[_i];
        if ((__num(process.argv.length) < 3 || __in(file, __slice.call(process.argv, 2))) && file.match(/\.gs$/i) && file !== "prelude.gs") {
          _arr.push(file);
        }
      }
      return _arr;
