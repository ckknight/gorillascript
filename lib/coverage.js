(function () {
  ...
  module.exports = function (root, sources) {
    ...
    function walker(node, parent, position) {
      ...
      file = pos.file;
      line = pos.line;
      if (file && sources[file] && __num(line) > 1) {
        if ((_ref = doneLinesByFile[file]) != null) {
          doneLines = _ref;
        } else {
          doneLines = doneLinesByFile[file] = [];
        }
        if (!doneLines[line] && (!(node instanceof ast.Binary) || node.op !== "." || !(parent instanceof ast.Call) || parent.func !== node) && (!(parent instanceof ast.Func) || position !== "param") && (!(parent instanceof ast.TryCatch) || position !== "catchIdent") && (!(parent instanceof ast.ForIn) || position !== "key")) {
          doneLines[line] = true;
    ...
    return ast.Root(
      ...
      ast.Block(pos, [
        ...
        ast.If(
          ...
          ast.Binary(
            pos,
            ast.Unary(pos, "typeof", ast.Ident(pos, "_$jscoverage")),
            "!==",
            ast.Const(pos, "object")
          ),
          ast.Assign(
