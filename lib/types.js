(function () {
  ...
  module.exports = Type = (function () {
    var _Type_prototype, any, AnyType, ArrayType, ComplementType, FunctionType, none, NoneType, ObjectType, SimpleType, UnionType;
    function Type() {
      var _this;
    ...
    ObjectType = (function (Type) {
      ...
      function ObjectType(data) {
        ...
        if (typeof data !== "object" || data instanceof RegExp) {
          throw TypeError("Expected an object, got " + __typeof(pairs));
        }
        pairs = [];
        for (k in data) {
          if (__owns(data, k)) {
      ...
      _ObjectType_prototype.inspect = function (depth) {
        ...
        return "ObjectType(" + __strnum(inspect(obj, null, depth != null ? __num(depth) - 1 : null)) + ")";
      };
      return ObjectType;
    }(Type));
    ...
    FunctionType = (function (Type) {
      ...
      _FunctionType_prototype.inspect = function (depth) {
        return __strnum(inspect(this.subtype, null, depth)) + ".function()";
      };
      return FunctionType;
    }(Type));
