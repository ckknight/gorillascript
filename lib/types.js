...
module.exports = Type = (function () {
  ...
  _proto.array = function () {
    var _ref;
    return (_ref = this._array) != null ? _ref : (this._array = ArrayType(this));
  };
  ...
  ArrayType = (function (_super) {
    ...
    _proto2.toString = function () {
      var _ref;
      return (_ref = this._name) != null ? _ref : (this._name = "[" + __strnum(String(this.subtype)) + "]");
    };
    _proto2.equals = function (other) {
  ...
  ComplementType = (function (_super) {
    ...
    _proto2.toString = function () {
      ...
      return (_ref = this._name) != null ? _ref
        : (this._name = this.untypes.length === 1 ? "any \\ " + __strnum(String(this.untypes[0])) : "any \\ (" + __strnum(this.untypes.join("|")) + ")");
    };
    _proto2.equals = function (other) {
      if (this === other) {
        return true;
