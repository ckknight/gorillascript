(function () {
  "use strict";
  var __cmp, __create, __isArray, __lte, __num, __owns, __range, __slice, __str, __strnum, __toArray, __typeof, inspect, Type;
  ...
  module.exports = Type = (function () {
    ...
    UnionType = (function (Type) {
      ...
      fromJSONTypes.union = function (_p) {
        var _arr, _i, _len, current, type, types;
        types = _p.types;
        current = Type.fromJSON(types[0]);
        for (_arr = __toArray(__slice(types, 1)), _i = 0, _len = _arr.length; _i < _len; ++_i) {
          type = _arr[_i];
