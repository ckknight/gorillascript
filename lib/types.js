(function () {
  ...
  module.exports = Type = (function () {
    var _Type_prototype, any, AnyType, arrayBase, ComplementType, fromJSONTypes, FunctionType, GenericType, getId, none, NoneType, ObjectType, SimpleType, UnionType;
    function Type() {
      var _this;
    ...
    FunctionType = (function (Type) {
      ...
      _FunctionType_prototype.union = function (other) {
        ...
        } else if (other instanceof SimpleType || other instanceof GenericType || other instanceof ObjectType) {
          return makeUnionType(
            [this, other],
            true
          );
    ...
    UnionType = (function (Type) {
      ...
      _UnionType_prototype.union = function (other) {
        ...
        if (other instanceof SimpleType || other instanceof GenericType || other instanceof FunctionType) {
      ...
      _UnionType_prototype.intersect = function (other) {
        ...
        if (other instanceof SimpleType || other instanceof GenericType || other instanceof ObjectType || other instanceof FunctionType) {
      ...
      _UnionType_prototype.overlaps = function (other) {
        ...
        } else if (other instanceof GenericType || other instanceof ObjectType || other instanceof FunctionType) {
          return (function () {
            var _arr, _i, type;
