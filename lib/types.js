(function () {
  "use strict";
  var __cmp, __create, __isArray, __lt, __lte, __num, __slice, __strnum, __toArray, __typeof, inspect, Type;
  ...
  module.exports = Type = (function () {
    var _proto, any, AnyType, ArrayType, ComplementType, FunctionType, none, NoneType, SimpleType, UnionType;
    function Type() {
      var _this;
      _this = this instanceof Type ? this : __create(_proto);
    ...
    SimpleType = (function (_super) {
      ...
      function SimpleType(name) {
        ...
        _this = this instanceof SimpleType ? this : __create(_proto2);
        _this.name = name;
        _this.id = getId();
        return _this;
      }
    ...
    ArrayType = (function (_super) {
      ...
      function ArrayType(subtype) {
        ...
        _this = this instanceof ArrayType ? this : __create(_proto2);
    ...
    FunctionType = (function (_super) {
      ...
      function FunctionType(returnType) {
        ...
        _this = this instanceof FunctionType ? this : __create(_proto2);
        _this.returnType = returnType;
        return _this;
      }
      _superproto = _super.prototype;
      _proto2 = FunctionType.prototype = __create(_superproto);
      _proto2.constructor = FunctionType;
    ...
    UnionType = (function (_super) {
      ...
      function UnionType(types) {
        ...
        _this = this instanceof UnionType ? this : __create(_proto2);
        if (__num(types.length) <= 1) {
    ...
    ComplementType = (function (_super) {
      ...
      function ComplementType(untypes) {
        ...
        _this = this instanceof ComplementType ? this : __create(_proto2);
        if (untypes.length === 0) {
    ...
    any = Type.any = new (AnyType = (function (_super) {
      var _proto2, _superproto;
      function AnyType() {
        var _this;
        _this = this instanceof AnyType ? this : __create(_proto2);
        if (any) {
    ...
    none = Type.none = new (NoneType = (function (_super) {
      var _proto2, _superproto;
      function NoneType() {
        var _this;
        _this = this instanceof NoneType ? this : __create(_proto2);
        if (none) {
          throw Error("Cannot instantiate more than once");
        }
        return _this;
