(function () {
  "use strict";
  var __cmp, __create, __isArray, __lte, __num, __owns, __slice, __str, __strnum, __toArray, __typeof, inspect, Type, util;
  ...
  module.exports = Type = (function () {
    var _Type_prototype, any, AnyType, ArrayType, ComplementType, fromJSONTypes, FunctionType, GenericType, getId, none, NoneType, ObjectType, SimpleType, UnionType;
    function Type() {
      var _this;
    ...
    GenericType = (function (Type) {
      ...
      function GenericType(base, args) {
        ...
        if (!(base instanceof SimpleType)) {
          throw TypeError("Expected base to be a SimpleType, got " + __typeof(base));
        }
        _this.base = base;
        if (!__isArray(args)) {
          ...
          for (_i = 0, _len = args.length; _i < _len; ++_i) {
            if (!(args[_i] instanceof Type)) {
              throw TypeError("Expected args[" + _i + "] to be a Type, got " + __typeof(args[_i]));
            }
          }
        }
        if (args.length === 0) {
      ...
      fromJSONTypes.generic = function (_p) {
        ...
        base = _p.base;
        args = _p.args;
        return GenericType(Type.fromJSON(base), (function () {
    ...
    ObjectType = (function (Type) {
      ...
      _ObjectType_prototype.union = function (other) {
        ...
        } else if (other instanceof SimpleType || other instanceof ArrayType || other instanceof GenericType) {
          return makeUnionType(
            [this, other],
            true
          );
    ...
    FunctionType = (function (Type) {
      ...
      _FunctionType_prototype.union = function (other) {
        ...
        } else if (other instanceof SimpleType || other instanceof ArrayType || other instanceof GenericType || other instanceof ObjectType) {
          return makeUnionType(
            [this, other],
            true
          );
    ...
    UnionType = (function (Type) {
      ...
      _UnionType_prototype.union = function (other) {
        ...
        if (other instanceof SimpleType || other instanceof ArrayType || other instanceof GenericType || other instanceof FunctionType) {
      ...
      _UnionType_prototype.intersect = function (other) {
        ...
        if (other instanceof SimpleType || other instanceof ArrayType || other instanceof GenericType || other instanceof ObjectType || other instanceof FunctionType) {
      ...
      _UnionType_prototype.overlaps = function (other) {
        ...
        } else if (other instanceof ArrayType || other instanceof GenericType || other instanceof ObjectType || other instanceof FunctionType) {
          return (function () {
            var _arr, _i, type;
