...
module.exports = (function () {
  ...
  Type.prototype.array = function () {
    var _tmp;
    return (_tmp = this._array) != null ? _tmp : (this._array = new ArrayType(this));
  };
  function contains(alpha, bravo) {
    var _tmp, _tmp2, item;
    for (_tmp = 0, _tmp2 = __num(alpha.length); _tmp < _tmp2; ++_tmp) {
      item = alpha[_tmp];
  ...
  SimpleType = (function () {
    ...
    SimpleType.prototype.union = function (other) {
      if (!(other instanceof Type)) {
        throw TypeError("Expected other to be a Type, got " + __strnum(__typeof(other)));
      } else if (other instanceof SimpleType) {
        if (this === other) {
          return this;
        } else {
    ...
    SimpleType.prototype.isSubsetOf = function (other) {
      ...
      if (other instanceof SimpleType) {
        ...
        return (function () {
          var _tmp, _tmp2, _tmp3, type;
          for (_tmp = other.types, _tmp2 = 0, _tmp3 = __num(_tmp.length); _tmp2 < _tmp3; ++_tmp2) {
            type = _tmp[_tmp2];
            if (_this === type) {
              return true;
            }
        ...
        return (function () {
          var _tmp, _tmp2, _tmp3, type;
          for (_tmp = other.untypes, _tmp2 = 0, _tmp3 = __num(_tmp.length); _tmp2 < _tmp3; ++_tmp2) {
            type = _tmp[_tmp2];
            if (_this === type) {
              return false;
            }
  ...
  ArrayType = (function () {
    ...
    ArrayType.prototype.toString = function () {
      var _tmp;
      return (_tmp = this._name) != null ? _tmp : (this._name = "[" + __strnum(this.subtype.toString()) + "]");
    };
  ...
  UnionType = (function () {
    function UnionType(types) {
      ...
      if (!__isArray(types)) {
        ...
        for (_tmp = 0, _tmp2 = types.length; _tmp < _tmp2; ++_tmp) {
          if (!(types[_tmp] instanceof Type)) {
            throw TypeError("Expected types[" + _tmp + "] to be a Type, got " + __typeof(types[_tmp]));
          }
        }
      }
      this.types = types;
    ...
    UnionType.prototype.toString = function () {
      var _tmp;
      return (_tmp = this._name) != null ? _tmp : (this._name = "(" + __strnum(this.types.join("|")) + ")");
    };
  ...
  ComplementType = (function () {
    function ComplementType(untypes) {
      ...
      if (!__isArray(untypes)) {
        ...
        for (_tmp = 0, _tmp2 = untypes.length; _tmp < _tmp2; ++_tmp) {
          if (!(untypes[_tmp] instanceof Type)) {
            throw TypeError("Expected untypes[" + _tmp + "] to be a Type, got " + __typeof(untypes[_tmp]));
          }
        }
      }
    ...
    ComplementType.prototype.toString = function () {
      var _tmp;
      return (_tmp = this._name) != null ? _tmp : (this._name = this.untypes.length === 1 ? "any \\ " + __strnum(this.untypes[0].toString()) : "any \\ (" + __strnum(this.untypes.join("|")) + ")");
    };
    ...
    ComplementType.prototype.overlaps = function (other) {
      if (other instanceof SimpleType || other instanceof ArrayType) {
        ...
        return !__lte(relativeComplement(other.types, this.untypes).length, 0);
      } else if (other instanceof ComplementType) {
        return true;
      } else {
        return other.overlaps(this);
