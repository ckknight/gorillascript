(function () {
  "use strict";
  var __async, __in, __is, __isArray, __num, __owns, __slice, __strnum, __toArray, __typeof, assert, currentFile, fs, gorilla, k, noPrelude, numFailures, passedTests, path, totalTime, waiters;
        ...
        function (err) {
          ...
          return __async(
            ...
            function (i, next) {
              ...
              file = files[i];
              function doneInit() {
                var _ref, basename, code, failure, filename, start, startTime;
                ...
                return gorilla["eval"](
                  code.toString(),
                  { filename: filename, includeGlobals: true, noPrelude: noPrelude },
                  function (err, result) {
                    var endTime;
                    if (err != null) {
                      failure = true;
              ...
              if (i === 0 && !noPrelude) {
                return gorilla.init(function (_e) {
                  if (_e != null) {
                    return next(_e);
                  }
                  return doneInit();
