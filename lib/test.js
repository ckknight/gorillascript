(function () {
  "use strict";
  var __async, __in, __isArray, __num, __owns, __slice, __strnum, __toArray, __typeof, assert, currentFile, fs, gorilla, k, noPrelude, numFailures, passedTests, path, totalTime;
