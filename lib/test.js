(function () {
  "use strict";
  var __in, __isArray, __num, __owns, __slice, __strnum, __toArray, assert, currentFile, fs, gorilla, k, noPrelude, numFailures, passedTests, path, totalTime;
  __in = (function () {
    var indexOf;
  ...
  fs.realpath(__filename, function (err, filenamePath) {
    ...
    return fs.readdir(testsPath, function (err, files) {
      ...
      if (__num(process.argv.length) > 2) {
        files = (function () {
          var _arr, _i, _len2, file;
          for (_arr = [], _i = 0, _len2 = __num(files.length); _i < _len2; ++_i) {
            file = files[_i];
      ...
      function next() {
        ...
        return fs.readFile(filename, function (err, code) {
          ...
          endTime = void 0;
          try {
            result = gorilla["eval"](code.toString(), { includeGlobals: true, noPrelude: noPrelude });
          } catch (e) {
            failure = true;
