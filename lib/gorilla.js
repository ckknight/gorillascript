(function (GLOBAL) {
  "use strict";
  var __defer, __fromPromise, __generatorToPromise, __isArray, __lte, __num, __owns, __promise, __slice, __strnum, __toArray, __toPromise, __typeof, fetchAndParsePrelude, fs, init, os, parse, parser, path, setImmediate;
  __defer = (function () {
    function __defer() {
  ...
  exports.ast = __promise(function (source, options) {
    var _arr, _arr2, _e, _i, _len, _send, _state, _step, _tmp, _tmp2, array, item, parsed, startTime, sync, translated, translator;
    _state = 0;
    function _close() {
      _state = 15;
    }
      ...
      while (true) {
        ...
        case 5:
          ...
          return {
            ...
            value: __toPromise(parse, void 0, [item, options])
          };
        case 6:
          _tmp = _received;
          ++_state;
        ...
        case 12:
          ...
          return {
            ...
            value: __toPromise(parse, void 0, [source, options])
          };
        case 13:
          parsed = _received;
          ++_state;
