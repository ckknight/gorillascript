(function (GLOBAL) {
  "use strict";
  var __asyncResult, __isArray, __isObject, __lte, __num, __once, __owns, __slice, __strnum, __toArray, __typeof, compile, DEFAULT_TRANSLATOR, fetchAndParsePrelude, fs, init, os, parse, parser, path, translate;
  ...
  fetchAndParsePrelude = (function () {
    ...
    exports.withPrelude = function (lang, serializedPrelude) {
      ...
      if (!__isObject(serializedPrelude)) {
