(function () {
  "use strict";
  var __num, __owns, compile, fetchAndParsePrelude, fs, parse, parser, path, translate, translator;
  __num = function (num) {
  ...
  fetchAndParsePrelude = (function () {
    ...
    preludePath = path.join(path.dirname(fs.realpathSync(__filename)), "../src/prelude.gs");
    function f(cb) {
