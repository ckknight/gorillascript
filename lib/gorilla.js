(function () {
  "use strict";
  var __isArray, __lte, __num, __owns, __slice, __toArray, __typeof, compile, fetchAndParsePrelude, fs, os, parse, parser, path, translate, translator;
  ...
  exports["eval"] = function (source, options) {
    ...
    if (Script) {
      ...
      if (!sandbox.module && !sandbox.require) {
        ...
        for (_arr = __toArray(Object.getOwnPropertyNames(require)), _i = 0, _len = _arr.length; _i < _len; ++_i) {
          r = _arr[_i];
          try {
