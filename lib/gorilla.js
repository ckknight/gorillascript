(function (GLOBAL) {
  "use strict";
  var __async, __defer, __fromPromise, __generatorToPromise, __isArray, __lte, __num, __once, __owns, __promise, __slice, __strnum, __toArray, __toPromise, __typeof, compile, fetchAndParsePrelude, fs, init, os, parse, parser, path, setImmediate, translate;
      ...
      while (true) {
        ...
        case 3:
          ...
          return {
            ...
            value: __toPromise(exports["eval"], exports, [source, options])
          };
        case 4:
          _state = 12;
        ...
        case 8:
          ...
          return {
            ...
            value: __toPromise(compile, void 0, [source, options])
          };
        case 9:
          compiled = _received;
          ++_state;
