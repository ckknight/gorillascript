(function (GLOBAL) {
  "use strict";
  var __defer, __fromPromise, __generatorToPromise, __isArray, __lte, __num, __owns, __promise, __slice, __strnum, __toArray, __toPromise, __typeof, fetchAndParsePrelude, fs, init, os, parser, path, setImmediate;
  __defer = (function () {
    function __defer() {
  ...
  exports.parse = __promise(function (source, options) {
    var _e, _send, _state, _step, _tmp, macros, sync;
    _state = 0;
    function _close() {
      _state = 12;
    }
    function _step(_received) {
      while (true) {
        ...
        case 4:
          ...
          break;
        case 5:
          macros = fetchAndParsePrelude.sync(options.lang || "js").macros;
          _state = 8;
          break;
        case 6:
          ++_state;
